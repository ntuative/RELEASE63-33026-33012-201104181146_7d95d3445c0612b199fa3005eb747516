package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_13:String = "client.init.start";
      ...
      public static const const_16:String = "crash_time";
      
      public static const const_14:String = "error_ctx";
      
      public static const const_12:String = "flash_version";
      ...
      public static const const_10:String = "fileBarSprite";
      ...
      public static function reportCrash(param1:String, param2:int, param3:Error) : void
      {
         ...
         if(!Habbo._crashed)
         {
            ...
            _loc6_[const_16] = new Date().getTime().toString();
            _loc7_ = "";
            _loc6_[const_14] = _loc7_;
            _loc6_[const_12] = Capabilities.version;
            _loc6_[const_19] = 0;
      ...
      private function updateLoadingBar(param1:DisplayObjectContainer, param2:Number) : void
      {
         ...
         var _loc8_:Sprite = _loc7_.getChildByName(const_10) as Sprite;
