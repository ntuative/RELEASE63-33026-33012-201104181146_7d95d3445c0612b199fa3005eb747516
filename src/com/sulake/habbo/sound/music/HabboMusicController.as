package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1412:int = HabboMusicPrioritiesEnum.const_132;
      ...
      private var var_536:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_773.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_773.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_773)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_79.addEventListener(RoomEngineSoundMachineEvent.const_742,this.onJukeboxInit);
         this.var_79.addEventListener(RoomEngineSoundMachineEvent.const_235,this.onJukeboxDispose);
         this.var_79.addEventListener(RoomEngineSoundMachineEvent.const_731,this.onSoundMachineInit);
         this.var_79.addEventListener(RoomEngineSoundMachineEvent.const_787,this.onSoundMachineDispose);
         this.var_1207 = new Timer(1000);
         this.var_1207.start();
         this.var_1207.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         this._events.addEventListener(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.onSongFinishedPlayingEvent);
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_252)
         {
            this.var_537[_loc6_] = null;
            this.var_796[_loc6_] = 0;
            _loc6_++;
         }
      }
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_1864)
            {
               this.resetSongStartRequest(this._priorityPlaying);
            }
            _loc2_ = this._priorityPlaying;
            this.playSongWithHighestPriority();
            if(_loc2_ >= HabboMusicPrioritiesEnum.const_374)
            {
               this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_572,_loc2_,param1.id,-1));
            }
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            {
               _loc2_ = 0;
               while(_loc2_ < this.var_441.length)
               {
                  _loc3_ = this.var_441.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_79)
            {
               this.var_79.removeEventListener(RoomEngineSoundMachineEvent.const_742,this.onJukeboxInit);
               this.var_79.removeEventListener(RoomEngineSoundMachineEvent.const_235,this.onJukeboxDispose);
               this.var_79.removeEventListener(RoomEngineSoundMachineEvent.const_731,this.onSoundMachineInit);
               this.var_79.removeEventListener(RoomEngineSoundMachineEvent.const_787,this.onSoundMachineDispose);
            }
      ...
      {
         if(param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_252)
         {
            return false;
         }
         var _loc7_:SongStartRequestData = new SongStartRequestData(param2,param3,param4,param5,param6);
         this.var_537[param1] = _loc7_;
         this.var_796[param1] += 1;
         return true;
      }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         if(this.var_537[param1] == null)
         {
            return -1;
         }
         var _loc2_:SongStartRequestData = this.var_537[param1];
      ...
      {
         var _loc1_:int = this.var_537.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_537[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_441.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_252)
         {
      ...
      private function requestSong(param1:int, param2:Boolean) : void
      {
         ...
         {
            this.var_648.add(param1,param2);
      ...
      {
         return this.var_366.length;
      }
      
      public function getSongDiskInventoryDiskId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_366.length)
         {
            return this.var_366.getKey(param1);
         }
         return -1;
      }
      ...
      public function getSongDiskInventorySongId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_366.length)
         {
            return this.var_366.getWithIndex(param1);
         }
         return -1;
      }
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_795));
         Logger.log("Requested song info\'s : " + this.var_795);
         this.var_795 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            _loc8_ = this.method_8(_loc6_.id);
            if(_loc7_)
            {
               _loc9_ = null;
               if(_loc8_)
               ...
               this.var_441.add(_loc6_.id,_loc10_);
               ...
               while(this.var_797.indexOf(_loc6_.id) != -1)
               {
                  this.var_797.splice(this.var_797.indexOf(_loc6_.id),1);
                  if(this.var_797.length == 0)
                  {
                     this._events.dispatchEvent(new SongDiskInventoryReceivedEvent(SongDiskInventoryReceivedEvent.const_564));
                  }
               }
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_252)
         {
            return false;
         }
         ...
         this.var_1864 = this.getSongRequestCountAtPriority(param1);
         this.var_1863 = param2;
         if(this._priorityPlaying <= const_1412)
         {
            this.notifySongPlaying(_loc4_);
         }
         if(param1 > HabboMusicPrioritiesEnum.const_132)
         {
            this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_619,param1,_loc4_.id,-1));
         }
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2569 != param1.id || _loc3_ > this.var_2570 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2569 = param1.id;
            this.var_2570 = _loc3_;
         }
      }
      ...
      private function onSongDiskInventoryMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDiskCount)
         {
            ...
            this.var_366.add(_loc5_,_loc6_);
            if(this.var_441.getValue(_loc6_) == null)
            {
               this.var_797.push(_loc6_);
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_536 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_79,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_536 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;
