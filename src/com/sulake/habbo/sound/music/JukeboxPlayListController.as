package com.sulake.habbo.sound.music
{
   ...
   public class JukeboxPlayListController implements IPlayListController
   {
      ...
      {
         this.var_72.stop(this.priority);
         this.var_470 = -1;
         this.var_1776 = -1;
         this.var_694 = false;
      }
      ...
      private function onNowPlayingMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_694 = _loc3_.currentSongId != -1;
         if(_loc3_.currentSongId >= 0)
         {
            this.var_72.playSong(_loc3_.currentSongId,HabboMusicPrioritiesEnum.const_132,_loc3_.syncCount / 1000,0,1,1);
            this.var_470 = _loc3_.currentSongId;
         }
         else
         {
            this.stopPlaying();
         ...
         {
            this.var_72.addSongInfoRequest(_loc3_.nextSongId);
         }
         this.var_1776 = _loc3_.currentPosition;
         this._soundManager.events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_345,HabboMusicPrioritiesEnum.const_132,_loc3_.currentSongId,_loc3_.currentPosition));
      }
      ...
      private function onJukeboxSongDisksMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDisks.length)
         {
            ...
            _loc7_ = this.var_72.getSongInfo(_loc5_) as SongDataEntry;
            if(_loc7_ == null)
            {
               ...
               if(this.var_772.indexOf(_loc5_) < 0)
               {
                  ...
                  this.var_72.requestSongInfoWithoutSamples(_loc5_);
               }
            }
            _loc7_.diskId = _loc6_;
            this.var_518.push(_loc7_);
            _loc4_++;
         }
      ...
      private function onJukeboxPlayListFullMessage(param1:IMessageEvent) : void
      {
         ...
         this._events.dispatchEvent(new PlayListStatusEvent(PlayListStatusEvent.const_694));
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         {
            _loc4_ = this.var_518[_loc2_];
            if(_loc4_.id == param1.id)
            {
               _loc5_ = _loc4_.diskId;
               _loc6_ = this.var_72.getSongInfo(param1.id) as SongDataEntry;
               if(_loc6_ != null)
               {
                  _loc6_.diskId = _loc5_;
                  this.var_518[_loc2_] = _loc6_;
               }
               break;
            }
            _loc2_++;
