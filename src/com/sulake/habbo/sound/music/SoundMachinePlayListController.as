package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      private var var_72:HabboMusicController;
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_72 = param2;
         this.var_773 = [];
         this.var_773.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_773.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_773)
         {
         ...
         this._events.addEventListener(SongInfoReceivedEvent.const_94,this.onSongInfoReceivedEvent);
         this.var_79.addEventListener(RoomEngineSoundMachineEvent.const_850,this.onSoundMachinePlayEvent);
         this.var_79.addEventListener(RoomEngineSoundMachineEvent.const_902,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_79)
            {
               this.var_79.removeEventListener(RoomEngineSoundMachineEvent.const_850,this.onSoundMachinePlayEvent);
               this.var_79.removeEventListener(RoomEngineSoundMachineEvent.const_902,this.onSoundMachineStopEvent);
               this.var_79 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         {
            this.playCurrentSongAndNotify(this.var_470);
            _loc2_ = this.getNextEntry();
            if(_loc2_ != null)
            {
               this.var_72.addSongInfoRequest(_loc2_.id);
            }
         }
      }
      ...
      public function stopPlaying() : void
      {
         this.var_470 = -1;
         this.var_694 = false;
         this.var_72.stop(HabboMusicPrioritiesEnum.const_132);
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc3_ < this._playListEntries.length)
         {
            ...
            {
               _loc4_ = this.var_72.getSongInfo(param1.id) as SongDataEntry;
               if(_loc4_ != null)
               {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_72.playSong(param1,HabboMusicPrioritiesEnum.const_132,_loc3_,0,0,0))
         {
