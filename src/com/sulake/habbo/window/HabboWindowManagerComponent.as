package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_445:uint = 3;
      
      private static const const_1386:uint = 1;
      ...
      private var var_1467:IEventDispatcher;
      
      private var var_1185:Boolean = false;
      
      private var var_1828:ProfilerOutput;
      
      private var var_1468:ProfilerAgentTask;
      
      private var var_1469:ProfilerAgentTask;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _loc4_["null"] = param3.getAssetByName("habbo_window_layout_button_shiny_large_xml").content as XML;
         _loc4_["null"] = param3.getAssetByName("habbo_window_layout_button_shiny_thick_black_xml").content as XML;
         this.var_259.push(_loc4_);
         _loc4_ = new Dictionary();
         _loc4_["null"] = param3.getAssetByName("habbo_window_layout_button_shiny_black_xml").content as XML;
         _loc4_["null"] = param3.getAssetByName("habbo_window_layout_button_shiny_large_5_xml").content as XML;
         _loc4_["null"] = param3.getAssetByName("habbo_window_layout_button_shiny_thick_black_xml").content as XML;
         this.var_259.push(_loc4_);
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_205 = new Array(const_445);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_445)
         {
            this.var_205[_loc6_] = new WindowContext("layer_" + _loc6_,this._windowRenderer,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_255 = this.var_205[const_1386];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1828)
            {
               this.var_1828 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_1828.profiler = _loc3_;
            this.var_1468 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1468);
            this.var_1469 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1469);
            this.var_1185 = true;
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_205)
            {
               ...
               {
                  IDisposable(this.var_205.pop()).dispose();
               }
            }
            this.var_205 = null;
            if(this.var_259)
      ...
      {
         return this.var_255.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_255.getWindowParser().windowToXMLString(param1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = this.var_259[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_259[0][param1] as XML : _loc4_;
      }
      ...
      {
         return this.var_205[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = this.var_205[param2].getDesktopWindow();
      ...
      {
         return this.var_205[param2].getDesktopWindow().getChildByName(param1);
      }
      
      public function getActiveWindow(param1:uint = 1) : IWindow
      {
         return this.var_205[param1].getDesktopWindow().getChildAt(this.var_255.getDesktopWindow().numChildren - 1);
      }
      ...
      {
         var _loc2_:IWindowContext = this.var_205[param1];
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_397.length > 0)
         {
            this.var_1467.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_445 - 1;
            while(_loc2_ >= 0)
            {
               this.var_205[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(this.var_1185)
         ...
         this.var_1467.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_445)
         {
            this.var_205[_loc2_].render(param1);
            _loc2_++;
         }
         if(this.var_1185)
         {
         ...
         if(WindowContext.var_397.length > 0)
         {
            WindowContext.var_397.flush();
         }
         MouseCursorControl.change();
         this.var_1467.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1711,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1737,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1752,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1583,param2.name + ": " + param2.toString());
            }
         }
      }
      ...
      private function performTestCases() : void
      {
         ...
         _loc1_.begin(this);
         _loc1_.test({
            "type":WindowType.const_550,
            "style":WindowStyle.const_179,
            "caption":"Testing",
            "count":800,
            "properties":[_loc2_]
         });
