package com.sulake.habbo.widget.poll
{
   ...
   public class PollSession implements IDisposable
   {
      ...
      private var var_1165:PollWidget;
      ...
      {
         this.hideOffer();
         this.var_254 = new PollOfferDialog(this._id,param1,this.var_1165);
      }
      ...
      public function showContent(param1:String, param2:String, param3:Array) : void
      {
         this.hideOffer();
         this.hideContent();
         this.var_1642 = param2;
         this.var_254 = new PollContentDialog(this._id,param1,param3,this.var_1165);
      }
      ...
      {
         this.var_1165.windowManager.alert("${poll_thanks_title}",this.var_1642,0,function(param1:IAlertDialog, param2:WindowEvent):void
         {
            param1.dispose();
         });
      }
