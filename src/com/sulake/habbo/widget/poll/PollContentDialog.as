package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++this.var_1155;
         if(this.var_1155 < this.var_934.length)
         {
            _loc1_ = this.var_934[this.var_1155] as Dictionary;
            if(!_loc1_)
            {
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!this.var_422)
         {
            ...
            this.var_422 = this._widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            this.var_422.center();
            this.var_422.procedure = this.cancelConfirmEventProc;
         }
      }
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = this.var_934[this.var_1155] as Dictionary;
