package com.sulake.habbo.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_1481:int = 30000;
      ...
      public function VoteWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         {
            this.var_1481 = int(this._config.getKey("vote.time.limit","30000"));
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_157.reset();
            this.var_157.removeEventListener(TimerEvent.TIMER,this.updateEvent);
            this.var_157 = null;
         }
         this._config = null;
         super.dispose();
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_145,this.showVoteQuestion);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_145,this.showVoteQuestion);
      ...
      private function showVoteQuestion(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         {
            this.var_157 = new Timer(1000);
            this.var_157.addEventListener(TimerEvent.TIMER,this.updateEvent);
         }
         this.var_1854 = getTimer();
         this.var_157.reset();
         this.var_157.start();
      ...
      private function updateTimerView() : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc6_ = Math.max((this.var_1481 - _loc1_) / 1000,0);
      ...
      {
         var _loc2_:int = getTimer() - this.var_1854;
         if(_loc2_ > this.var_1481)
         {
            this.vote();
            return;
         }
