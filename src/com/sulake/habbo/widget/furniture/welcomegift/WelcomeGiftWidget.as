package com.sulake.habbo.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_662:String = "welcome_gift_email_unverified";
      
      private const const_1044:String = "welcome_gift_email_verified";
      
      private const const_1449:String = "welcome_gift_email_change";
      
      private const const_2103:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1273)
         {
            this.setViewState(this.const_1044);
         }
         else
         {
            this.setViewState(this.const_662);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_662:
               ...
               this._view.findChildByName("edit_text").visible = this.var_1039;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_31,this.var_1039);
               break;
            case this.const_1044:
            ...
            case this.const_1449:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_1039);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1551;
               _loc6_.focus();
      ...
      {
         this.setViewState(this.const_1449);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_707,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1273 ? this.const_1044 : this.const_662);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1552 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1552));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_579,this.updateEventHandler);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_951,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_579,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_951,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_579:
               this.var_1551 = param1.email;
               this.var_1273 = param1.isVerified;
               this.var_1039 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1551 = this.var_1552;
            this.setViewState(this.const_662);
         }
         else
         {
            if(param1.result == this.const_2103)
            {
               this.var_1039 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1552);
