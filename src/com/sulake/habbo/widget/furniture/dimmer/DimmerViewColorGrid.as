package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private var var_486:IItemGridWindow;
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= this.var_486.numGridItems)
         {
            return;
         }
         this.select(this.var_486.getGridItemAt(param1) as IWindowContainer);
      }
      
      private function populate(param1:IHabboWindowManager) : void
      {
         if(this._view == null || this.var_486 == null)
         {
            return;
         }
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         {
            _loc3_ = param1.buildFromXML(this.var_1663) as IWindowContainer;
            ...
            this.var_486.addGridItem(_loc3_);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(this.var_897.width,this.var_897.height,true,16777215);
               _loc6_.bitmap.copyPixels(this.var_897,this.var_897.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = this.var_486.getGridItemIndex(param1.target as IWindow);
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_1663 = XML(_loc2_.content);
         ...
         this.var_897 = BitmapData(_loc3_.content);
      }
