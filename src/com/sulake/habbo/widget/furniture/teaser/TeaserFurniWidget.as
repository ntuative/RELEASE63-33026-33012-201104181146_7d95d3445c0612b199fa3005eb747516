package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1809:int = 0;
      
      private const const_1804:int = 1;
      
      private const const_1806:int = 2;
      
      private const const_1807:int = 3;
      
      private const const_1810:int = 4;
      
      private const const_2073:int = 0;
      ...
      private const const_2074:int = 4;
      
      private const const_2080:int = 5;
      
      private const const_1805:String = "deco_img";
      
      private const const_1808:String = "dialog_bg";
      
      private const const_2075:String = "%campaign%_dialog_bg.png";
      
      private const const_360:String = "%campaign%_gift_package.png";
      
      private const const_2077:String = "%campaign%_gift_content.png";
      
      private const const_2081:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboInventory)
      {
         ...
         this.var_1442 = this.var_158.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1442 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1443.length)
         {
            _loc2_ = this.var_1443.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_158 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_517,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_701,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_682,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_517,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_517:
               _loc2_ = this.const_1809;
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_682:
               ...
               if(_loc5_)
               {
                  if(_loc4_ && _loc4_ != "")
                  {
                     _loc2_ = this.const_1807;
                     var_62.registerParameter("widget.furni.teaser.notify.unlocked.desc","username",_loc4_);
                  }
                  else
                  {
                     _loc2_ = this.const_1806;
                  }
               }
               else
               {
                  _loc2_ = this.const_1810;
               }
               this._shareId = null;
               this.var_1441 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_701:
               _loc2_ = this.const_1804;
               this.var_367 = param1.objectId;
               this._shareId = param1.data;
               this.var_402 = param1.status;
               this.var_1441 = param1.itemCategory;
         ...
         if(this._window && (this.var_1444 != _loc2_ || _loc3_ != this.var_178))
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_178 = _loc3_;
         this.var_1444 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
         ...
         if(!this._window)
         {
            switch(this.var_1444)
            {
               ...
               case this.const_1804:
                  ...
                  else if(this.var_402 == this.const_2078)
                  {
                     ...
                     _loc2_ = this.const_2077;
                  }
                  else if(this.var_402 == this.const_2079)
                  {
                  ...
                  else if(this.var_402 == this.const_2076)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_402 == this.const_2074)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_178,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_402 == this.const_2080)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2075.replace("%campaign%",this.var_178);
            this.setDecoImage(_loc5_,this.const_1808);
            _loc2_ = _loc2_.replace("%campaign%",this.var_178);
            this.setDecoImage(_loc2_,this.const_1805);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_899);
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this._inventory)
         {
            if(this.var_1441 != 0)
            {
               this._inventory.toggleInventoryPage(this.var_1441 == 1 ? "null" : InventoryCategory.const_143);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_862,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1443.push(new ImageDownloader(this,_assets,this.var_178,this.var_1442,param1,param2));
            return;
         }
         var _loc5_:BitmapData = (_loc4_.content as BitmapData).clone();
         switch(param2)
         {
            case this.const_1808:
            case this.const_1805:
