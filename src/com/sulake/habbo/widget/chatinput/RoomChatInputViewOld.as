package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputViewOld
   {
      ...
      private static const const_1364:int = 11;
      
      private static const const_645:int = 18;
      
      private static const const_1005:int = 16;
      
      private static const const_1365:int = 20;
      ...
      private var var_311:Number = 600;
      ...
      public function RoomChatInputViewOld(param1:RoomChatInputWidgetOld, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_1174 = this._localization.getKey("widgets.chatinput.mode.whisper",":tell");
         this._chatModeIdShout = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2466 = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
      ...
      private function createWindow() : void
      {
         ...
         _loc6_.addEventListener(WindowKeyboardEvent.const_172,this.windowKeyEventProcessor);
         _loc6_.addEventListener(WindowEvent.const_103,this.onInputChanged);
         this._window.addEventListener(WindowEvent.const_234,this.onWindowMoved);
         this.var_1569 = true;
         this.var_522 = "";
         this.refreshView();
      }
      ...
      private function refreshView() : void
      {
         ...
         this._window.width = _loc1_.width + const_645 + const_1005;
         _loc1_.x = const_645;
         _loc1_.y = const_1364;
      }
      ...
      {
         this.var_311 = param1 - (const_645 + const_1005);
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == this.var_1174 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  this.var_522 = "";
               }
      ...
      private function onWindowMoved(param1:WindowEvent) : void
      {
         ...
         this.setMaxWidth(this._window.context.getDesktopWindow().width - this._window.x - const_1365);
      }
