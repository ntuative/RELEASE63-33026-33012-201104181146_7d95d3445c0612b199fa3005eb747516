package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private var var_1570:IWindow;
      
      private var var_1571:IWindow;
      ...
      private const const_2108:int = 250;
      
      private const const_2107:int = 0;
      
      private const const_1824:String = "${widgets.chatinput.say}";
      
      private const const_2106:String = "${widgets.chatinput.shout}";
      
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1174 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this._chatModeIdShout = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2466 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_357 = new Timer(1000,1);
         this.var_357.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_426 = new Timer(10000,1);
         this.var_426.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_357.reset();
            this.var_357.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
            this.var_357 = null;
         }
         if(this.var_426 != null)
         {
            this.var_426.reset();
            this.var_426.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_426 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         var _loc2_:int = this._widget.config.getKey("friendbar.enabled") == "InfoStandSongDiskView" ? 55 : 5;
         ...
         this.var_2034 = this._window.findChildByName("input_border");
         this._button = this._window.findChildByName("send_button");
         this.var_1570 = this._window.findChildByName("send_button_text");
         this.var_1571 = this._window.findChildByName("block_text");
         this.setButtonText(this.const_1824);
         this.addEventListenerToChild(this.var_24);
         this.var_24.addEventListener(WindowKeyboardEvent.const_172,this.windowKeyEventProcessor);
         this.var_24.addEventListener(WindowKeyboardEvent.const_289,this.keyUpHandler);
         ...
         this.var_1569 = true;
         this.var_522 = "";
         this._window.addEventListener(WindowEvent.const_716,this.updatePosition);
         this._window.addEventListener(WindowEvent.const_466,this.updatePosition);
      }
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc4_:int = (this._window.desktop.width - this.var_2034.width) / 2 - _loc3_;
         var _loc5_:int = this._window.desktop.width - this._window.width - this.const_2108 - _loc3_;
         this._window.x = Math.max(Math.min(_loc4_,_loc5_),this.const_2107);
      }
      ...
      private function onSend(param1:WindowMouseEvent) : void
      {
         if(!this.var_1569)
         {
            this.sendChatFromInputField(this.var_1572);
         }
      }
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_)
         {
            this.var_1572 = RoomWidgetChatMessage.const_102;
            this.setButtonText(this.const_2106);
         }
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_24 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1174 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_24.text = "";
                  this.var_522 = "";
               }
      ...
      private function keyUpHandler(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            this.var_1572 = RoomWidgetChatMessage.const_112;
            this.setButtonText(this.const_1824);
         }
      }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_522.length + 1)
            {
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_627);
