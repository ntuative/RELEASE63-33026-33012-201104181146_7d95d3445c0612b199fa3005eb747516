package com.sulake.habbo.widget.avatarinfo
{
   ...
   public class AvatarMenuView extends AvatarInfoView
   {
      ...
      protected static const const_631:uint = 1;
      
      protected static const const_1279:uint = 2;
       
      
      protected var _data:AvatarInfoData;
      
      protected var var_570:uint = 0;
      ...
      public function AvatarMenuView(param1:AvatarInfoWidget, param2:int, param3:String, param4:int, param5:int, param6:AvatarInfoData)
      {
         ...
         this._data = param6;
         var_1328 = XmlAsset(_widget.assets.getAssetByName("avatar_menu_widget")).content as XML;
      }
      ...
      override protected function createWindow() : void
      {
         ...
         _window = _widget.windowManager.buildFromXML(var_1328,0) as IWindowContainer;
         if(!_window)
         {
            return;
         }
      ...
      protected function updateButtons() : void
      {
         ...
         if(this.var_570 == const_963 || this.var_570 == const_631)
         {
            ...
            else
            {
               ...
               this.var_570 = const_631;
            }
         }
         if(this.var_570 == const_631)
         {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "report":
                  ...
                  break;
               case "link_moderate":
                  this.var_570 = const_1279;
                  this.updateButtons();
                  break;
               case "link_show_actions":
                  this.var_570 = const_963;
                  this.updateButtons();
                  break;
