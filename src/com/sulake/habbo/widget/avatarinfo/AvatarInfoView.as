package com.sulake.habbo.widget.avatarinfo
{
   ...
   public class AvatarInfoView
   {
      ...
      protected var var_2442:Boolean;
      
      protected var var_2529:int;
      
      protected var var_2153:int;
      ...
      public function AvatarInfoView(param1:AvatarInfoWidget, param2:int, param3:String, param4:int, param5:int, param6:Boolean = false)
      {
         ...
         this.var_1328 = XmlAsset(this._widget.assets.getAssetByName("avatar_info_widget")).content as XML;
      }
      ...
      protected function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.buildFromXML(this.var_1328,0) as IWindowContainer;
         if(!this._window)
         {
            return;
         }
      ...
      {
         this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_859));
