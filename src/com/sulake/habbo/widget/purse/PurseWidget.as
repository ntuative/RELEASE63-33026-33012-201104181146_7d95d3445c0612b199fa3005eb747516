package com.sulake.habbo.widget.purse
{
   ...
   public class PurseWidget extends RoomWidgetBase
   {
      ...
      private const const_2099:uint = 4.291993382E9;
      
      private const const_2098:uint = 4.29080704E9;
      
      private const const_2096:uint = 4.285767869E9;
      
      private const const_2097:uint = 4.28366404E9;
      ...
      public function PurseWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager)
      {
         ...
         if(_loc4_)
         {
            ...
            this._view.x = _loc5_.width - this._view.width - this.const_1812;
            this._view.y = this.const_1812;
      ...
      private function onCreditBalance(param1:RoomWidgetPurseUpdateEvent) : void
      {
         ...
         if(this._view)
         {
            this._view.findChildByName("credits").caption = this.var_1842.toString();
            this._view.findChildByName("credits_shadow").caption = this.var_1842.toString();
         }
      }
      
      private function onPixelBalance(param1:RoomWidgetPurseUpdateEvent) : void
      {
         this.var_1841 = param1.balance;
         if(this._view)
         {
            this._view.findChildByName("pixels").caption = this.var_1841.toString();
            this._view.findChildByName("pixels_shadow").caption = this.var_1841.toString();
         }
      }
      
      private function onCreditsClick(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1194));
      }
