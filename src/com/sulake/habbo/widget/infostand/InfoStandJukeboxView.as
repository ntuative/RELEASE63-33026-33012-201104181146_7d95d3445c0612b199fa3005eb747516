package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandJukeboxView extends InfoStandFurniView
   {
      ...
      override protected function createWindow(param1:String) : void
      {
         ...
         if(var_47 != null)
         {
            var_54 = var_47.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         ...
         var_238 = var_47.findChildByTag("catalog");
         if(var_238 != null)
         {
            var_238.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onCatalogButtonClicked);
         }
      ...
      {
         var _loc2_:IWindowContainer = var_54.getListItemByName("trackname_container") as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:IWindowContainer = var_54.getListItemByName("creatorname_container") as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_370)
         {
            this.var_1798 = param1.songId;
         }
         if(param1.songId == this.var_1798)
         {
            this._songName = param1.songName;
            this.var_2461 = param1.songAuthor;
            this.updateNowPlaying(this.var_1798 >= 0);
         }
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:ITextWindow = var_54.getListItemByName("now_playing_text") as ITextWindow;
         if(_loc2_ != null)
         {
            if(param1)
            {
         ...
         if(param1)
         {
            ...
            this.nowPlayingAuthorName = this.var_2461;
         }
         else
         {
