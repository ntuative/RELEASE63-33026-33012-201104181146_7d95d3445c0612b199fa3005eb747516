package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1794:String = "infostand_furni_view";
      
      private const const_1797:String = "infostand_pet_view";
      
      private const const_1796:String = "infostand_bot_view";
      
      private const const_1799:String = "infostand_jukebox_view";
      
      private const const_1798:String = "infostand_songdisk_view";
      
      private var var_1121:InfoStandFurniView;
      
      private var var_176:InfoStandUserView;
      
      private var var_348:InfoStandPetView;
      
      private var var_417:InfoStandBotView;
      
      private var var_914:InfoStandJukeboxView;
      
      private var var_913:InfoStandSongDiskView;
      
      private var var_2285:Array;
      
      private var var_1386:InfostandUserData;
      
      private var var_668:InfostandFurniData;
      ...
      private const const_2063:int = 3000;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboCatalog)
      {
         ...
         this.var_1121 = new InfoStandFurniView(this,this.const_1794,this._catalog);
         this.var_176 = new InfoStandUserView(this,this.const_1795);
         this.var_348 = new InfoStandPetView(this,this.const_1797,this._catalog);
         this.var_417 = new InfoStandBotView(this,this.const_1796);
         this.var_914 = new InfoStandJukeboxView(this,this.const_1799,this._catalog);
         this.var_913 = new InfoStandSongDiskView(this,this.const_1798,this._catalog);
         this.var_1386 = new InfostandUserData();
         this.var_668 = new InfostandFurniData();
         this._petData = new InfoStandPetData();
         this.var_157 = new Timer(this.const_2063);
      ...
      public function get mainContainer() : IWindowContainer
      {
         ...
         {
            this._mainContainer = windowManager.createWindow("infostand_main_container","",HabboWindowType.const_66,HabboWindowStyle.const_45,HabboWindowParam.const_45,new Rectangle(0,0,50,100)) as IWindowContainer;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_170,this.onRoomObjectRemoved);
         ...
         param1.addEventListener(RoomWidgetUserBadgesUpdateEvent.const_154,this.onUserBadges);
         ...
         param1.addEventListener(RoomWidgetSongUpdateEvent.const_370,this.onSongUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_170,this.onRoomObjectRemoved);
         ...
         param1.removeEventListener(RoomWidgetUserBadgesUpdateEvent.const_154,this.onUserBadges);
         ...
         param1.removeEventListener(RoomWidgetSongUpdateEvent.const_370,this.onSongUpdate);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_407,this.var_348.getCurrentPetId()));
      }
      
      private function onUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         this.userData.setData(param1);
         this.var_176.update(param1);
      ...
      private function onFurniInfo(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_722)
         {
            this.var_914.update(param1);
            this.selectView(this.const_1799);
         }
         else if(param1.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_414) != -1)
         {
            this.var_913.update(param1);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         if(param1.isOwnUser)
         {
            this.var_176.setTags(param1.tags);
         }
         else
         {
            this.var_176.setTags(param1.tags,this.var_2285);
         }
      }
      ...
      private function onUserFigureUpdate(param1:RoomWidgetUserFigureUpdateEvent) : void
      {
         ...
         {
            this.var_176.image = param1.image;
            this.var_176.setMotto(param1.customInfo,param1.isOwnUser);
            this.var_176.achievementScore = param1.achievementScore;
         }
      }
      ...
      private function onBadgeImage(param1:RoomWidgetBadgeImageUpdateEvent) : void
      {
         ...
         if(_loc2_ >= 0)
         {
            ...
            {
               this.var_176.setBadgeImage(_loc2_,param1.badgeImage);
            }
            return;
         }
         if(param1.badgeID == this.userData.groupBadgeId)
         {
            this.var_176.setGroupBadgeImage(param1.badgeImage);
         }
      }
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectUpdateEvent.const_144:
               _loc2_ = param1.id == this.var_668.id;
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_170:
               if(this.var_176 != null && this.var_176.window != null && this.var_176.window.visible)
               {
                  _loc2_ = param1.id == this.var_1386.userRoomId;
                  break;
               }
      ...
      {
         this.var_914.updateSongInfo(param1);
         this.var_913.updateSongInfo(param1);
      }
