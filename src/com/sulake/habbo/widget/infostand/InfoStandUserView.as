package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      protected var var_54:IItemListWindow;
      
      protected var var_102:IWindowContainer;
      
      private var var_47:IBorderWindow;
      
      private var var_1178:TagListRenderer;
      
      private var var_131:IBorderWindow;
      
      private var var_2213:int;
      
      private const const_980:int = 5;
      
      private const const_1784:int = 7829367;
      
      private const const_1783:int = 16777215;
      
      private const const_2054:int = 2000;
      
      private const const_2053:int = 50;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1178 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      {
         if(this.var_54 == null || this.var_47 == null || this.var_102 == null)
         {
            return;
         }
         this.var_54.height = this.var_54.scrollableRegion.height;
         this.var_47.height = this.var_54.height + 20;
         this._window.width = Math.max(this.var_47.width,this.var_102.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_47.width < this.var_102.width)
         {
         ...
         {
            this.var_102.x = this._window.width - this.var_102.width;
            this.var_47.x = 0;
         }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         this.var_102 = this._window.getListItemByName("button_list") as IWindowContainer;
         var _loc3_:* = [];
         this.var_102.groupChildrenWithTag("CMD_BUTTON",_loc3_,true);
         ...
         if(this.var_47 != null)
         {
            this.var_54 = this.var_47.findChildByName("infostand_element_list") as IItemListWindow;
         }
         ...
         while(_loc9_ < 5)
         {
            _loc8_ = this.var_47.findChildByName("badge_" + _loc9_);
            if(_loc8_ != null)
            {
               _loc8_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.showBadgeInfo);
               _loc8_.addEventListener(WindowMouseEvent.const_25,this.hideBadgeInfo);
            }
            _loc9_++;
         }
         _loc8_ = this.var_47.findChildByName("badge_group");
      ...
      {
         var _loc2_:ITextWindow = this.var_54.getListItemByName("realname_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         _loc2_.height = _loc2_.textHeight + this.const_980;
         _loc2_.visible = param1.length > 0;
      }
      
      public function set image(param1:BitmapData) : void
      {
         var _loc2_:IWindowContainer = this.var_54.getListItemByName("image_and_badges_container") as IWindowContainer;
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc3_:ITextWindow = this.var_54.getListItemByName("motto_text") as ITextWindow;
         var _loc4_:IWindowContainer = this.var_54.getListItemByName("motto_spacer") as IWindowContainer;
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1784;
            }
            else
            {
               _loc3_.textColor = this.const_1783;
            }
            _loc3_.enable();
         }
         else
         ...
         _loc3_.text = param1;
         _loc3_.height = Math.min(_loc3_.textHeight + this.const_980,this.const_2053);
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_289,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_289,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      {
         var _loc2_:ITextWindow = this.var_54.getListItemByName("score_value") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:ITextWindow = this.var_54.getListItemByName("handitem_txt") as ITextWindow;
         var _loc3_:IWindowContainer = this.var_54.getListItemByName("handitem_spacer") as IWindowContainer;
      ...
      {
         var _loc2_:ITextWindow = this.var_54.getListItemByName("xp_text") as ITextWindow;
         var _loc3_:IWindowContainer = this.var_54.getListItemByName("xp_spacer") as IWindowContainer;
         if(_loc2_ == null || _loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc3_:IWindowContainer = this.var_54.getListItemByName("tags_container") as IWindowContainer;
         var _loc4_:IWindowContainer = this.var_54.getListItemByName("tags_spacer") as IWindowContainer;
         if(_loc3_ == null || _loc4_ == null)
         {
            return;
         }
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1178.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      {
         var _loc3_:IWindowContainer = this.var_54.getListItemByName("image_and_badges_container") as IWindowContainer;
      ...
      {
         var _loc3_:* = null;
         var _loc1_:IWindowContainer = this.var_54.getListItemByName("image_and_badges_container") as IWindowContainer;
         var _loc2_:int = 0;
         while(_loc2_ < 5)
         {
      ...
      protected function updateInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.setMotto(param1.motto,param1.type == RoomWidgetUserInfoUpdateEvent.const_130);
      ...
      private function enableButton(param1:String, param2:Boolean = true) : void
      {
         ...
         var _loc3_:IRegionWindow = this.var_102.getChildByName(param1) as IRegionWindow;
      ...
      protected function showButton(param1:String, param2:Boolean) : void
      {
         ...
         var _loc3_:IWindow = this.var_102.getChildByName(param1);
         if(_loc3_ != null)
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_740:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_807:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc2_:ITextWindow = this.var_54.getListItemByName("motto_text") as ITextWindow;
         var _loc3_:String = _loc2_.text;
         if(param1.keyCode == Keyboard.ENTER)
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2213 > this.const_2054 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2213 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1784;
         }
      }
      ...
      {
         var _loc5_:* = null;
         this.var_102.width = 250;
         var _loc2_:* = [];
         this.var_102.groupChildrenWithTag("CMD_BUTTON_REGION",_loc2_,true);
         var _loc3_:int = 250;
         var _loc4_:int = 0;
