package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2067:int = 5;
      
      private const const_2068:int = 5;
      ...
      private var var_1140:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1139 = 0;
         this.var_1140 = param2.rectangle.clone();
         this.var_1140.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1140.width)
         {
            return false;
         }
         if(this.var_1139 + param1.height > this.var_1140.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1140.width)
         {
            this._offsetX = 0;
            this.var_1139 += param1.height + this.const_2068;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1139);
         this._offsetX += param1.width + this.const_2067;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1408 != null && this.var_1408.indexOf(param1) != -1)
         {
