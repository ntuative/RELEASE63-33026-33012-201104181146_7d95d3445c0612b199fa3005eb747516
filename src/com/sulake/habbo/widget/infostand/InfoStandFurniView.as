package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         this.var_238 = this.var_47.findChildByTag("catalog");
         if(this.var_238 != null)
         {
            this.var_238.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      {
         var _loc2_:ITextWindow = this.var_54.getListItemByName("description_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function getAdFurnitureExtraParams() : Map
      {
         ...
         {
            _loc2_ = this._widget.furniData.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_1273.length);
            _loc3_ = _loc2_.split("\t");
            if(_loc3_ != null)
            {
      ...
      private function getVisibleAdFurnitureExtraParams() : Map
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc4_:* = null;
         ...
         if(this.var_47 != null)
         {
            ...
            if(_loc2_.length > 0)
            {
               for each(_loc3_ in _loc2_)
               {
                  ...
                  {
                     _loc6_ = _loc4_.caption;
                     _loc7_ = _loc5_.caption;
                     _loc1_.add(_loc6_,_loc7_);
                  }
               }
            }
      ...
      private function showAdFurnitureDetails(param1:Boolean) : void
      {
         ...
         if(_loc3_.length > 0)
         {
            ...
            {
               this.var_47.removeChild(_loc6_);
               _loc6_.dispose();
            }
         }
         var _loc4_:Boolean = false;
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_54.addListItem(this.var_238);
            }
            this.var_238.visible = param1;
         }
         else
         {
            this.var_54.removeListItem(this.var_238);
         }
      }
   }
}
