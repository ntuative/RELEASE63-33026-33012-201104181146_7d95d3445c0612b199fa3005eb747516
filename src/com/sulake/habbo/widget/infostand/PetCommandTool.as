package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_418:IFrameWindow;
      ...
      private const const_2066:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_350 = new Timer(this.const_2066);
         this.var_350.addEventListener(TimerEvent.TIMER,this.onButtonDisableTimeout);
      }
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1131.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
            this.disableAllButtons();
            this.requestEnabledCommands(this.var_502);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1131.getValue(this.var_502) as CommandConfiguration;
      ...
      {
         this.var_1131.remove(param1);
         this.var_1131.add(param1,param2);
         if(param1 != this.var_502)
         {
            return;
         }
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_752,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_41.setParamFlag(WindowParam.const_104,true);
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_418 == null)
         {
            ...
            this.var_418 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_418 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_418.x = 200;
            this.var_418.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_407,this.var_502));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_553,this.var_502,this.var_1715 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_553,this.var_502,this.var_1715 + " " + _loc5_);
