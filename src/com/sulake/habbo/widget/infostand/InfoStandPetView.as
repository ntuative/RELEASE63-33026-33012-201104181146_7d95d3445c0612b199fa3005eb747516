package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_2084:int = 152;
      
      private const const_2090:int = 16;
      
      private const const_1387:int = 4;
      
      private const const_2088:uint = 14342874;
      
      private const const_2083:uint = 3815994;
      
      private const const_2093:uint = 2085362;
      
      private const const_2089:uint = 39616;
      
      private const const_2087:uint = 10513106;
      
      private const const_2095:uint = 8734654;
      
      private const const_2092:uint = 9094430;
      
      private const const_2094:uint = 6200576;
      
      private const const_2086:String = "happiness";
      
      private const const_2091:String = "experience";
      
      private const const_2085:String = "energy";
      ...
      {
         if(this.var_54 == null || this.var_47 == null || this._buttons == null)
         {
            return;
         }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_2086,param1.nutrition,param1.nutritionMax,this.const_2089,this.const_2093);
         this.updateStateElement(this.const_2091,param1.experience,param1.experienceMax,this.const_2095,this.const_2087);
         this.updateStateElement(this.const_2085,param1.energy,param1.energyMax,this.const_2094,this.const_2092);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_2084,this.const_2090,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_2088);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_2083);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1387,_loc7_.width - 2,_loc7_.height - 2 - this.const_1387);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1387);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_502) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_47.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
         ...
         for each(_loc11_ in _loc10_)
         {
            ...
            _loc11_.addEventListener(WindowEvent.const_41,this.onButtonResized);
         }
      }
      ...
      private function set image(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_54.getListItemByName("image_container") as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function setLevelText(param1:int, param2:int) : void
      {
         ...
         var _loc3_:IWindowContainer = this.var_54.getListItemByName("level_container") as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function set raceText(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = this.var_54.getListItemByName("race_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function set ageText(param1:int) : void
      {
         ...
         var _loc2_:ITextWindow = this.var_54.getListItemByName("age_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function set petRespect(param1:int) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_54.getListItemByName("petrespect_container") as IWindowContainer;
      ...
      private function updateStateElement(param1:String, param2:int, param3:int, param4:uint, param5:uint) : void
      {
         ...
         var _loc6_:IWindowContainer = this.var_54.getListItemByName("status_container") as IWindowContainer;
         if(_loc6_ == null)
         {
            return;
         }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_206 && this.var_206.getPetId() == this.var_502)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1632,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_398,this._widget.petData.ownerId);
