package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class PlayListEditorItemListView
   {
      ...
      private var var_99:PlayListEditorItem;
      ...
      public function setItemIndexPlaying(param1:int) : void
      {
         ...
         if(param1 < 0)
         {
            ...
            {
               _loc3_.setIconState(PlayListEditorItem.const_460);
            }
            return;
         }
         ...
         if(this.var_1173 >= 0 && this.var_1173 < this._items.length)
         {
            _loc2_ = this._items[this.var_1173] as PlayListEditorItem;
            _loc2_.setIconState(PlayListEditorItem.const_460);
         }
         _loc2_ = this._items[param1] as PlayListEditorItem;
         _loc2_.setIconState(PlayListEditorItem.const_1252);
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            if(param2.name == "button_remove_from_playlist" || _loc3_)
            {
               ...
               this._widget.sendRemoveFromPlayListMessage(this.var_1172);
               this.var_99 = null;
               this.var_1172 = -1;
            }
            else
            {
               ...
               if(_loc4_ != -1)
               {
                  this.var_1172 = _loc4_;
                  this.var_99 = this._items[_loc4_];
                  this.var_99.select();
