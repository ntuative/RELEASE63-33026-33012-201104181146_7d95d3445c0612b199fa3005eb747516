package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_718:String = "PLSV_ADD_SONGS";
      
      public static const const_1077:String = "PLSV_START_PLAYBACK";
      
      public static const const_521:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_45 != const_521)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_410[this.var_45];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_410[const_718];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_410.add(const_521,_loc1_);
