package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class PlayListEditorWidget extends RoomWidgetBase
   {
      ...
      private static const const_1476:int = 130;
      
      private static const const_1472:int = 100;
      
      private static const const_1474:int = 130;
      
      private static const const_1475:int = 100;
      
      private static const const_1477:int = 130;
      ...
      {
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_860,this.onShowPlayListEditorEvent);
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_732,this.onHidePlayListEditorEvent);
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_866,this.onInventoryUpdatedEvent);
      }
      
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_860,this.onShowPlayListEditorEvent);
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_732,this.onHidePlayListEditorEvent);
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_866,this.onInventoryUpdatedEvent);
      }
      ...
      public function getDiskColorTransformFromSongData(param1:String) : ColorTransform
      {
         ...
         _loc2_ = uint(_loc2_ % const_1472 + const_1476);
         _loc3_ = uint(_loc3_ % const_1475 + const_1474);
         _loc4_ = uint(_loc4_ % const_1473 + const_1477);
      ...
      public function sendAddToPlayListMessage(param1:int) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc4_ = new RoomWidgetPlayListModificationMessage(RoomWidgetPlayListModificationMessage.const_769,_loc3_,param1);
      ...
      {
         var _loc2_:RoomWidgetPlayListModificationMessage = new RoomWidgetPlayListModificationMessage(RoomWidgetPlayListModificationMessage.const_835,param1);
         if(messageListener != null)
         {
      ...
      public function sendTogglePlayPauseStateMessage() : void
      {
         ...
         {
            _loc1_ = this.var_15.playListEditorView.selectedItemIndex;
         }
      ...
      public function playUserSong(param1:int) : void
      {
         ...
         this._soundManager.musicController.playSong(param1,HabboMusicPrioritiesEnum.const_374,0,0,0,0);
      }
      
      public function stopUserSong() : void
      {
         this._soundManager.musicController.stop(HabboMusicPrioritiesEnum.const_374);
      }
      ...
      {
         var _loc2_:String = this.var_188.getKey("image.library.playlist.url");
      ...
      {
         var _loc1_:RoomWidgetPlayListUserActionMessage = new RoomWidgetPlayListUserActionMessage(RoomWidgetPlayListUserActionMessage.const_810);
         if(messageListener != null)
         {
            messageListener.processWidgetMessage(_loc1_);
         }
         this._catalog.openCatalogPage(CatalogPageName.const_1637,true);
      }
