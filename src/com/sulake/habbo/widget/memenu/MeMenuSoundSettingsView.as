package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      {
         this.var_488 = param1.volume;
         if(this.var_975 != null)
         {
            this.var_975.setValue(this.var_488);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_688));
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_488 == 0)
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1856);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1857);
         }
      }
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_488 == 1)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1855);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1858);
         }
      }
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            ...
            case "sounds_on":
               ...
               break;
            case "back_btn":
               this._widget.changeView(MeMenuWidget.const_728);
               break;
            default:
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_892);
         }
         else
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_855);
         }
