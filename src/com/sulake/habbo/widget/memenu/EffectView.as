package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2102:int = 1000;
      ...
      private var var_1009:IWindow;
      
      public function EffectView()
      {
         super();
         this.var_209 = new Timer(this.const_2102);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            _loc2_ = this.var_189.secondsLeft / Number(this.var_189.duration);
            this.var_1010.width = _loc2_ * this.var_311;
         }
         else
         {
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_828 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_828 == null)
            {
               return;
            }
         ...
         if(!this.var_189.isActive)
         {
            this.var_828.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_828.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_828.text;
         var _loc2_:int = this.var_189.secondsLeft;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_1009 = this._window.findChildByName("effect_hilite");
         ...
         if(this.var_1010 != null)
         {
            this.var_311 = this.var_1010.width;
            this.var_209.start();
            this.onUpdate();
         }
