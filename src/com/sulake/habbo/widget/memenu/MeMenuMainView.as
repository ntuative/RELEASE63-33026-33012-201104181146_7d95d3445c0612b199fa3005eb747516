package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         for(_loc3_ in this.var_171)
         {
            _loc6_ = this.var_171[_loc3_];
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               this._widget.changeView(MeMenuWidget.const_1113);
               break;
            case "wave":
               if(this._widget.hasEffectOn)
               {
               ...
               if(this._widget.isDancing)
               {
                  this._widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_1229));
            ...
            case "effects":
               ...
               this._widget.changeView(MeMenuWidget.const_875);
               break;
            case "rooms":
            ...
            case "badges":
               ...
               break;
            case "clothes":
               this._widget.changeView(MeMenuWidget.const_340);
               break;
            case "hc":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1203));
               this._widget.hide();
               break;
            case "settings":
            ...
            case "news":
               ...
               break;
            case "credits":
               _loc4_ = this._widget.config.getKey("client.credits.embed.enabled","com.sulake.habbo.inventory.marketplace") == "InfoStandSongDiskView";
               if(false && _loc4_)
               {
