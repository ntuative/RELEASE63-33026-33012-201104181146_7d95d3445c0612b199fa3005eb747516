package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuClothesView implements IMeMenuView
   {
      ...
      private static const DEFAULT_LOCATION:Point = new Point(100,20);
      ...
      public function dispose() : void
      {
         ...
         {
            this._widget.messageListener.processWidgetMessage(new RoomWidgetAvatarEditorMessage(RoomWidgetAvatarEditorMessage.const_848));
         }
         this._widget = null;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(this._widget.config.getKey("client.toolbar.static.enabled","com.sulake.habbo.inventory.marketplace") == "InfoStandSongDiskView")
         {
            this._widget.mainContainer.position = DEFAULT_LOCATION;
         }
         this._window.addEventListener(WindowEvent.const_150,this.onChildResized);
         this._widget.messageListener.processWidgetMessage(new RoomWidgetAvatarEditorMessage(RoomWidgetAvatarEditorMessage.const_417,this._window));
      }
