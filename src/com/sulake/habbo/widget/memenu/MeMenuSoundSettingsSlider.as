package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsSlider
   {
      ...
      private var var_1115:MeMenuSoundSettingsView;
      ...
      public function set min(param1:Number) : void
      {
         ...
         this.setValue(this.var_1115.volume);
      }
      ...
      private function buttonProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1115.saveVolume(this.getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc3_ != null && this.var_739 != null)
         {
            _loc3_.bitmap = new BitmapData(this.var_739.width,this.var_739.height,true,16777215);
            _loc3_.bitmap.copyPixels(this.var_739,this.var_739.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null && this.var_738 != null)
               {
                  ...
                  this.var_1680 = _loc1_.width - _loc3_.width;
               }
            }
         }
      }
