package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_990:int = 150;
      
      private static const const_991:int = 250;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_42 = param3;
         this.var_2260 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1679 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2258 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1677 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1678 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2259 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2262 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_74 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_300,HabboWindowStyle.const_30,HabboWindowParam.const_62,new Rectangle(0,0,param3.width,param3.height - const_84),null,0,0) as IBitmapWrapperWindow;
         this.var_42.addChild(this.var_74);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_66,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,this.var_42.height - const_84,param3.width,const_84),null,0) as IWindowContainer;
         this.var_42.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_620,HabboWindowStyle.const_45,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_84),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_611:
               this.var_74.blend += param1 / const_991;
               this._window.blend += param1 / const_991;
               ...
               break;
            case const_1030:
               this.var_74.blend -= param1 / const_990;
               this._window.blend -= param1 / const_990;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(this._region != null)
         {
            ...
            this._region.width = this.var_42.width - this.var_2263;
         }
         if(this.var_74 != null)
         {
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2261 == this._window.width)
         {
            return;
         }
         this.var_2261 = this._window.width;
         ...
         {
            _loc5_.bitmap = this.var_2258;
            _loc5_.disposesBitmap = false;
            _loc2_.bitmap = this.var_1677;
            _loc2_.disposesBitmap = false;
            this.var_2263 = this._window.width - _loc2_.x;
         }
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_2260,_loc7_);
            ...
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1679,_loc8_);
            ...
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1679,_loc9_);
         ...
         this.var_74.bitmap = this.var_2262;
