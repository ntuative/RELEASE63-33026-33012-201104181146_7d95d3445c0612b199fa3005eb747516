package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1456:int = 18;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_192.state = RoomChatHistoryPulldown.const_243;
         ...
         this.var_50 = param2.createWindow("chatscroller","",HabboWindowType.const_1081,HabboWindowStyle.const_45,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_192.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_243);
      }
      ...
      {
         return !!this.var_467 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_192.state == RoomChatHistoryPulldown.const_403 || this.var_192.state == RoomChatHistoryPulldown.const_611;
      }
      ...
      {
         if(!this.var_467 && !this.var_1826)
         {
            this.var_467 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_192.state = RoomChatHistoryPulldown.const_403;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_50 != null)
         {
            ...
            if(param2)
            {
               this.var_50.scrollV = this.var_684;
            }
         }
         if(this.var_192 != null)
         {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_468 > 0 && param2)
         {
            if(this.var_2037)
            {
               if(Math.abs(param1 - this.var_468) <= const_1181)
               {
                  return;
               }
               this.var_2037 = false;
            ...
            if(this.var_467)
            {
               ...
               _loc5_ = (param1 - this.var_468) / this.var_50.height;
               _loc3_ = this.var_684 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_468;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_50.scrollV < 1 - const_1456 / this.var_50.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_2038)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_50 != null)
         {
            this.var_684 = this.var_50.scrollV;
         }
         if(this.var_50 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_684 - this.var_50.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
