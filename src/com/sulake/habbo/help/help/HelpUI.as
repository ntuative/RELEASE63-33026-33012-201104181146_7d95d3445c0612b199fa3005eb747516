package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      {
         this.var_375 = this._defaultViewId;
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201104181140));
         this._toolbar = param5;
         this.var_123 = new Map();
         this.var_123.add(HabboHelpViewEnum.const_1565,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_123.add(HabboHelpViewEnum.const_216,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_123.add(HabboHelpViewEnum.const_470,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_123.add(HabboHelpViewEnum.const_336,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_123.add(HabboHelpViewEnum.const_282,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_123.add(HabboHelpViewEnum.const_378,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_123.add(HabboHelpViewEnum.const_884,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_123.add(HabboHelpViewEnum.const_231,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_123.add(HabboHelpViewEnum.const_1111,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_123.add(HabboHelpViewEnum.const_1084,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_123.add(HabboHelpViewEnum.const_895,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function dispose() : void
      {
         ...
         var _loc1_:Array = this.var_123.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = this.var_123.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_542.length == 0 || param1 != this.var_375)
            {
               this.var_542.push(this.var_375);
            }
         }
         this.var_375 = param1;
         ...
         if(_loc3_ == null)
         {
            Logger.log("* No view controller found for " + this.var_375);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_231:
               ...
               break;
            case CallForHelpResultEnum.const_1070:
               this.showUI(HabboHelpViewEnum.const_1084);
               break;
            case CallForHelpResultEnum.const_1058:
               this.showUI(HabboHelpViewEnum.const_1111);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_123.getValue(HabboHelpViewEnum.const_216) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_492));
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_123.length)
         {
            _loc3_ = this.var_123.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      {
         return this.var_123.getValue(this.var_375);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2680 = this._window.width - _loc3_.width;
         this.var_2681 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2681;
         this._window.width = _loc1_.width + this.var_2680;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_542.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_375 == HabboHelpViewEnum.const_216)
         {
            return;
         }
         if(this.var_662.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_662.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_662.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_376.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_662[1],this.var_662[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_662[0],this.var_662[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_375 == HabboHelpViewEnum.const_216 || this.var_542.length == 0)
         {
            return;
         }
         if(this.var_376 == null)
         {
            ...
            this.var_376 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_376.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_376.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_376 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_376 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_376 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
