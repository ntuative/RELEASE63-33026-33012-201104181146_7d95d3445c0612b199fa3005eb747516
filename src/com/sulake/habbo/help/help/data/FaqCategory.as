package com.sulake.habbo.help.help.data
{
   ...
   public class FaqCategory
   {
      ...
      public function storeItem(param1:int, param2:String, param3:String = null) : void
      {
         ...
         if(_loc4_ == null)
         {
            _loc4_ = new FaqItem(param1,param2,this.var_153.length,this);
            this.var_153.add(param1,_loc4_);
         }
      }
      ...
      {
         if(param1 >= this.var_153.length)
         {
            return null;
         }
         return this.var_153.getWithIndex(param1);
      }
      ...
      {
         return this.var_153.getValue(param1) != null;
      }
      ...
      public function getQuestionTitleArray() : Array
      {
         ...
         var _loc3_:int = 0;
         while(_loc3_ < this.var_153.length)
         {
            _loc2_ = this.var_153.getWithIndex(_loc3_);
      ...
      {
         return this.var_153.length > 0 || this.hasUpdatedWithinHour();
      }
      
      public function setTimeStamp() : void
      {
         this.var_1628 = new Date();
      }
      ...
      public function getAgeSeconds() : Number
      {
         ...
         return (new Date().valueOf() - this.var_1628.valueOf()) / 1000;
      }
