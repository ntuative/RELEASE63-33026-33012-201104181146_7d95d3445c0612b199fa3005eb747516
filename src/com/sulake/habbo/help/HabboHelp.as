package com.sulake.habbo.help
{
   ...
   public class HabboHelp extends Component implements IHabboHelp
   {
      ...
      private var var_1480:CallForHelpData;
      
      private var var_2550:UserRegistry;
      
      private var var_2549:String = "";
      
      private var var_644:WelcomeScreenController;
      
      public function HabboHelp(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1480 = new CallForHelpData();
         this.var_2550 = new UserRegistry();
         super(param1,param2,param3);
         this._assetLibrary = param3;
         this.var_1197 = new FaqIndex();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_974)
         {
            this.var_974.release(new IIDHabboLocalizationManager());
            this.var_974 = null;
         }
         if(this.var_323)
         {
      ...
      {
         this.var_1480.reportedUserId = param1;
         this.var_1480.reportedUserName = param2;
      ...
      private function createHelpUI() : Boolean
      {
         ...
         {
            this.var_66 = new HelpUI(this,this._assetLibrary,this._windowManager,this.var_974,this._toolbar);
         }
      ...
      private function onCommunicationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1586 = new IncomingMessages(this,this.var_323);
      ...
      {
         this.var_974 = IHabboLocalizationManager(param2);
      ...
      private function showWelcomeScreen(param1:Boolean) : void
      {
         if(!this.var_644)
         {
            this.var_644 = new WelcomeScreenController(this,this._windowManager,this.var_790);
         }
         this.var_644.showWelcomeScreen(param1);
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_118,HabboToolbarIconEnum.HELP));
         }
      }
      ...
      public function setWelcomeNotifications(param1:Array) : void
      {
         ...
         this.var_644.notifications = param1;
      }
   }
}
