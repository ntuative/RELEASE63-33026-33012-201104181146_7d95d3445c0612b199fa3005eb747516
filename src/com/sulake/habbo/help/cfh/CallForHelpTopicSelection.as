package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1460:int = 0;
      ...
      override public function render() : void
      {
         ...
         _loc6_ = 0;
         while(_loc6_ < this.var_851.length)
         {
            _loc8_ = this.var_851[_loc6_];
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(this.var_851 == null || _loc3_ < 0 || _loc3_ >= this.var_851.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = this.var_851[_loc3_];
            main.showUI(HabboHelpViewEnum.const_884);
            main.tellUI(HabboHelpViewEnum.const_884,null);
         }
      }
   }
}
