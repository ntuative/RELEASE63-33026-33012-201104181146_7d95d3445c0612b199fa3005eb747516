package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1424:uint = 13232628;
      
      private static var var_1769:uint = 11129827;
      ...
      private var var_1162:NameSuggestionListRenderer;
      ...
      private function showView(param1:IWindowContainer) : void
      {
         ...
         if(this._window)
         {
            this._window.content.width = this.var_45.width;
            this._window.content.height = this.var_45.height;
         }
      }
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1770 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_770)
         {
            this.var_770 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_770)
            {
               return;
            }
            this._window.content.addChild(this.var_770);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_769)
         {
            this.var_769 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_769)
            {
               return;
            }
         ...
         var _loc1_:ITextWindow = this.var_769.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_516;
         }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_516);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            ...
            case ChangeUserNameResultMessageEvent.var_862:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_1068:
               _loc4_.text = this._controller.localization.getKey("help.tutorial.name.change_not_allowed");
               break;
            case ChangeUserNameResultMessageEvent.var_1069:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1069 || param1 == ChangeUserNameResultMessageEvent.var_1068)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1162 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1162.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1424;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(!this.var_1425)
         {
            if(param1.type == WindowEvent.const_103)
            {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_516 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_516);
               break;
            ...
            case "header_button_close":
               this._controller.showView(TutorialUI.const_96);
         }
      }
