package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_584:String = "TUI_GUIDEBOT_VIEW";
      ...
      private var var_389:NameChangeView;
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_492,this.onTaskDoneEvent);
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_527,this.onTaskDoneEvent);
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_560,this.onTaskDoneEvent);
      ...
      {
         return this.var_1289 && this.var_1290 && this.var_1576;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_35)
         {
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_492,this.onTaskDoneEvent);
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_527,this.onTaskDoneEvent);
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_560,this.onTaskDoneEvent);
            if(this.var_35.sessionDataManager != null)
            {
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         if(this.var_45 == null || this.var_45.id == const_96)
         {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_492:
               this.var_1576 = true;
               if(this.var_45 != null && this.var_45.id == const_584)
               {
                  this.showView(const_96);
               }
               break;
            case HabboHelpTutorialEvent.const_527:
               if(this.var_45 != null && this.var_45.id == const_401)
               {
                  this.var_2036 = true;
                  this.disposeWindow();
               }
               break;
            case HabboHelpTutorialEvent.const_560:
               if(this.var_2036)
               {
                  this.var_2036 = false;
                  this.showView(const_96);
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2680 = this._window.width - _loc2_.width;
         ...
         switch(param1)
         {
            ...
            case const_319:
               ...
               if(this.var_389 == null)
               {
                  this.var_389 = new NameChangeView(this);
               }
               this.var_389.showMainView();
               this.prepareForTutorial();
               break;
            case const_401:
         ...
         this._window.height = _loc2_.height + this.var_2681;
         this._window.width = _loc2_.width + this.var_2680;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function prepareForTutorial() : void
      {
         ...
         this.var_35.hideUI();
         this.var_35.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_126));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_45 != null && (this.var_45.id == const_319 || this.var_45.id == const_96))
         {
            this.showView(const_96);
         }
      }
      ...
      {
         this.var_1289 = true;
         if(this.var_45 != null && (this.var_45.id == const_401 || this.var_45.id == const_96))
         {
            this.showView(const_96);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         {
            this.var_389.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
         }
      }
      ...
      public function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_565)
         {
            this.var_389.checkedName = _loc2_.name;
         }
         else
         {
            this.var_389.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
