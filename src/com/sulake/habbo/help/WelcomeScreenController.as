package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      private var var_207:Point;
      
      private var var_846:Timer;
      ...
      {
         return this._notifications[this.var_1556];
      }
      ...
      public function dispose() : void
      {
         if(this.var_143)
         {
            this.var_143.removeUpdateReceiver(this);
            this.var_143.toolbar.events.removeEventListener(HabboToolbarEvent.const_36,this.onToolbarClicked);
            this.var_143.toolbar.events.removeEventListener(HabboToolbarEvent.const_717,this.onToolbarResized);
            this.var_143 = null;
         }
         ...
         {
            this.var_846.stop();
            this.var_846.removeEventListener(TimerEvent.TIMER,this.onReminderTimer);
            this.var_846 = null;
         }
      ...
      public function showWelcomeScreen(param1:Boolean) : void
      {
         ...
         this.var_143.toolbar.events.addEventListener(HabboToolbarEvent.const_36,this.onToolbarClicked);
         this.var_143.toolbar.events.addEventListener(HabboToolbarEvent.const_717,this.onToolbarResized);
         var _loc4_:int = parseInt(this._config.getKey("welcome.screen.delay","5000"));
         this.var_846 = new Timer(_loc4_);
         this.var_846.addEventListener(TimerEvent.TIMER,this.onReminderTimer);
         this.var_846.start();
      }
      ...
      public function onReminderTimer(param1:TimerEvent) : void
      {
         ...
         this.var_207.y = this.var_143.toolbar.getIconLocation(this.current.targetIconId) - this._window.height / 2;
         this._window.y = this.var_207.y;
      ...
      {
         var _loc1_:XmlAsset = this.var_143.assets.getAssetByName("welcome_screen_xml") as XmlAsset;
         ...
         var _loc3_:BitmapDataAsset = this.var_143.assets.getAssetByName("welcome_screen_arrow") as BitmapDataAsset;
      ...
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_99,this.current.targetIconId);
         _loc2_.iconState = !!param1 ? "highlight_blue" : "0";
         this.var_143.toolbar.events.dispatchEvent(_loc2_);
      }
      ...
      private function closeWindow() : void
      {
         ...
         if(this.var_1556 < this._notifications.length - 1)
         {
            ++this.var_1556;
         }
         else
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:Number = Point.distance(this._window.rectangle.topLeft,this.var_207);
         if(_loc2_ > 5)
         {
            _loc3_ = Point.interpolate(this._window.rectangle.topLeft,this.var_207,0.5);
            this._window.x = _loc3_.x;
            this._window.y = _loc3_.y;
         }
         else
         {
            this._window.x = this.var_207.x;
            this._window.y = this.var_207.y;
            this.var_143.removeUpdateReceiver(this);
         }
      }
      ...
      {
         this.var_143.removeUpdateReceiver(this);
         this.var_143.registerUpdateReceiver(this,10);
      }
   }
}
