      ...
      public function resetAnimationFrames(param1:Boolean = true) : void
      {
         ...
         while(_loc2_ < this.var_600)
         {
            ...
            else
            {
               ...
               {
                  _loc3_.recycle();
                  this._frames[_loc2_] = AnimationFrame.allocate(_loc3_.id,_loc3_.x,_loc3_.y,_loc3_.method_2,0,_loc3_.isLastFrame);
               }
            }
            this.var_916[_loc2_] = false;
            this.var_915[_loc2_] = false;
            _loc2_++;
         }
      }
