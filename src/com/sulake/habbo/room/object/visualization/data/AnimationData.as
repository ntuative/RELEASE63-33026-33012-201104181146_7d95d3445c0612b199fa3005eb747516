package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class AnimationData
   {
      ...
      public static const const_2006:int = 0;
      ...
      private var var_1510:Array = null;
      ...
      {
         if(this.var_1510 != null && this.var_1510.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function getStartFrame(param1:int) : int
      {
         ...
         return Math.random() * this.var_425;
      }
      ...
      private function addLayer(param1:int, param2:int, param3:int, param4:Boolean, param5:XML) : Boolean
      {
         ...
         if(_loc10_ > this.var_425)
         {
            this.var_425 = _loc10_;
         }
         return true;
      }
      ...
      {
         var _loc4_:AnimationLayerData = this.var_113.getValue(param2) as AnimationLayerData;
         if(_loc4_ != null)
         {
      ...
      {
         var _loc6_:AnimationLayerData = this.var_113.getValue(param2) as AnimationLayerData;
         if(_loc6_ != null)
         {
