package com.sulake.habbo.room.object.visualization.data
{
   public class AnimationFrameSequenceData
   {
      ...
      {
         return this.var_463.length * this._loopCount;
      }
      ...
      public function initialize() : void
      {
         var _loc1_:int = 1;
         var _loc2_:int = -1;
         var _loc3_:int = this.var_463.length - 1;
         while(_loc3_ >= 0)
         {
            if(this.var_463[_loc3_] == _loc2_)
            {
               _loc1_++;
            }
            else
            {
               _loc2_ = this.var_463[_loc3_];
               _loc1_ = 1;
            }
            this.var_901[_loc3_] = _loc1_;
            _loc3_--;
         }
      }
      ...
      public function addFrame(param1:int, param2:int, param3:int, param4:int, param5:int, param6:DirectionalOffsetData) : void
      {
         ...
         this.var_463.push(this._frames.length - 1);
         this.var_901.push(1);
      }
      ...
      public function getFrame(param1:int) : AnimationFrameData
      {
         ...
         param1 = this.var_463[param1 % this.var_463.length];
      ...
      public function getFrameIndex(param1:int) : int
      {
         ...
         if(this.var_1799)
         {
            param1 = Math.random() * this.var_463.length;
            if(param1 == this.var_463.length)
            {
               param1--;
            }
         }
      ...
      public function getRepeats(param1:int) : int
      {
         ...
         return this.var_901[param1 % this.var_901.length];
      }
   }
}
