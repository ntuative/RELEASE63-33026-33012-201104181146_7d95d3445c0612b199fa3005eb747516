package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1462:String = "head";
      
      private static const const_667:int = 1;
      
      private static const const_1049:int = 1000;
      
      private static const const_1464:String = "pet_experience_bubble_png";
      
      private static const const_1461:int = 0;
      
      private static const const_1463:int = 1;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1464) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_390 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2848)
            {
               this.var_2848 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_284);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_137);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_284);
            if(!isNaN(_loc6_))
            {
            ...
            this.var_1655 = _loc3_.getNumber(RoomObjectVariableEnum.const_385) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_197);
            if(!isNaN(_loc8_))
            {
               this.var_2047 = _loc8_;
            }
            else
            {
               this.var_2047 = direction;
            }
            this.var_1563 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2147 = _loc3_.getNumber(RoomObjectVariableEnum.const_917);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_781);
            if(_loc9_ != this.var_2048)
            {
               this.var_2048 = _loc9_;
               this.var_2847 = this.var_2048.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_390 != null)
         {
            ...
            if(this.var_1563 > 0)
            {
               _loc2_ = param1 - this.var_1563;
               if(_loc2_ < const_1049)
               {
                  this.var_390.alpha = int(Math.sin(_loc2_ / const_1049 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_390.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_390.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      {
         return super.getAdditionalSpriteCount() + const_667;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2847);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_667)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_667))
            {
               if(param2 >= FurnitureVisualizationData.const_511.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_511[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_2047);
         }
         return direction;
      }
      ...
      {
         if(this.var_1055[param1] == null)
         {
            if(this._animationData.getTag(var_88,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1462)
            {
               this.var_1055[param1] = true;
            }
            else
            {
               this.var_1055[param1] = false;
            }
         }
