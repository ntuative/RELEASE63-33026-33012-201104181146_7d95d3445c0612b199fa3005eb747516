package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_751:IGraphicAssetCollection;
      
      private var var_1840:XMLList;
      ...
      private var var_960:Boolean = true;
      ...
      private var var_1460:LayoutRasterizerData = null;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != this.var_961)
         {
            ...
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1460 = this.var_46.getValue(this.var_961);
         }
      }
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_46.getValue(this.var_961);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1824 = RoomObjectVariableEnum.const_1211;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1824 = RoomObjectVariableEnum.const_1112;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1181 + this._adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1181 + this._adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_46.getValue(this.var_961);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2501 && param3 == this.var_2500)
         {
            return;
         }
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(this.var_1181 + this._adBgIndex);
            _loc5_ = param1.getSprite(this.var_1181 + this._adImgIndex);
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1824);
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1460.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = this.var_751.getAsset(_loc8_.@asset);
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_432.indexOf(_loc10_) >= 0 && this.var_960)
            {
               param1 = this.var_432.indexOf(_loc10_);
               if(this.var_632[param1] != "")
               {
                  _loc9_ = this.var_751.getAsset(this.var_632[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(this.var_633[param1] != -1)
               {
                  param2.alpha = this.var_633[param1];
               }
               this.var_432.splice(param1,1);
               this.var_632.splice(param1,1);
               this.var_633.splice(param1,1);
      ...
      {
         this.var_960 = true;
         var _loc3_:int = this.var_432.indexOf(param1);
         if(_loc3_ < 0)
         {
            this.var_432.push(param1);
            this.var_632.push(param2);
            this.var_633.push(-1);
         }
         else
         {
            this.var_632[_loc3_] = param2;
         }
      }
      ...
      public function changeElementAlpha(param1:String, param2:Number) : void
      {
         ...
         if(_loc3_ < 0)
         {
            this.var_432.push(param1);
            this.var_632.push("");
            this.var_633.push(param2);
         }
         else
         {
            this.var_633[_loc3_] = param2;
         }
      }
   }
}
