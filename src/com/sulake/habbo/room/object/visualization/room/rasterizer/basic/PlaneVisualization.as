package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneVisualization
   {
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int = 0, param7:int = 0, param8:int = 0, param9:int = 0, param10:Number = 0.0, param11:Number = 0.0, param12:int = 0) : BitmapData
      {
         ...
         if(this.var_31 != null)
         {
            if(this.var_31.width == param2 && this.var_31.height == param3 && Vector3d.isEqual(this._cachedBitmapNormal,param4))
            {
               if(!this.hasAnimationLayers)
               {
                  if(param1 != null)
                  {
                     param1.copyPixels(this.var_31,this.var_31.rect,new Point(0,0),null,null,false);
                     return param1;
                  }
                  return this.var_31;
               }
         ...
         if(param1 != null && param1 != this.var_31)
         {
            this.var_31.copyPixels(param1,param1.rect,new Point(0,0),null,null,false);
            return param1;
         }
         return this.var_31;
      }
