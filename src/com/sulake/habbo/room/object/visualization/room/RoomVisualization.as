package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1728:int = 16777215;
      
      public static const const_1589:int = 13421772;
      
      private static const const_995:int = 16777215;
      
      private static const const_993:int = 13421772;
      
      private static const const_994:int = 10066329;
      
      private static const const_992:int = 10066329;
      
      public static const const_1754:int = 16777215;
      
      public static const const_1620:int = 13421772;
      
      public static const const_1681:int = 10066329;
      ...
      private var var_1377:String = null;
      
      private var var_2318:String = null;
      
      private var var_1130:uint = 16777215;
      
      private var var_2316:int = 255;
      
      private var var_2315:int = 255;
      
      private var var_2317:int = 255;
      
      private var var_1711:Boolean = true;
      
      private var var_1686:int = 0;
      
      private var var_1859:int = -1000;
      
      private const const_2065:int = 250;
      
      private var var_1675:int = -1;
      
      private var var_1373:Number = 0.0;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_297["null"] = false;
         this.var_297["null"] = true;
         this.var_297["null"] = true;
         this.var_297["null"] = true;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_137 != null)
         {
            ...
            {
               _loc4_ = this.var_137[_loc3_] as RoomPlane;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_137.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_137[_loc2_] as RoomPlane;
            _loc4_ = getSprite(_loc2_);
            if(_loc4_ != null && _loc3_ != null && _loc3_.leftSide != null && _loc3_.rightSide != null)
            {
               if(_loc3_.type == RoomPlane.const_120 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1078);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1129);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            _loc13_ = null;
            if(_loc12_ == RoomPlaneData.const_213)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_219,true,_loc11_,_loc6_);
               if(_loc14_.z != 0)
               {
                  _loc13_.color = const_1728;
               }
               else
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_165)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_120,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
               ...
               {
                  _loc13_.color = const_992;
               }
               else if(_loc14_.y > 0)
               {
                  _loc13_.color = const_995;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_993;
               }
               else
               {
                  _loc13_.color = const_994;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_351)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1754;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1620;
               }
               else
               {
                  _loc13_.color = const_1681;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1558)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_120,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_351)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_1859 + this.const_2065 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_349.length)
            {
               _loc11_ = this.var_605[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_349[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1711)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2317 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2315 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2316 / 255);
         ...
         var_172 = _loc7_.getUpdateID();
         this.var_1859 = _loc9_;
      }
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1675)
         {
            this.var_1675 = param1.updateId;
            this.var_750 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1373 || _loc3_.y != this.var_2267 || _loc3_.z != this.var_2268 || param1.scale != this.var_2266))
            {
               this.var_1373 = _loc3_.x;
               this.var_2267 = _loc3_.y;
               this.var_2268 = _loc3_.z;
               this.var_2266 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1142);
            if(_loc3_ != this.var_2318)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2318 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_957));
            if(_loc4_ != this.var_1130)
            {
               this.var_1130 = _loc4_;
               this.var_2317 = this.var_1130 & 255;
               this.var_2315 = this.var_1130 >> 8 & 255;
               this.var_2316 = this.var_1130 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1183));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_172 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_333);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_309);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_329);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_867));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_800));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_697));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         {
            _loc5_ = this.var_137[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_219 && param1 != null)
               {
                  _loc5_.id = param1;
               }
               else if(_loc5_.type == RoomPlane.const_120 && param2 != null)
               {
                  _loc5_.id = param2;
               }
      ...
      {
         if(param1 != this.var_297["null"] || param2 != this.var_297["null"] || param3 != this.var_297["null"])
         {
            this.var_297["null"] = param1;
            this.var_297["null"] = param2;
            this.var_297["null"] = param3;
            this.var_349 = [];
            this.var_605 = [];
         }
      }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_349;
         if(this.var_349.length == 0)
         {
            _loc6_ = this.var_137;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_349.length > 0;
         var _loc9_:int = 0;
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_219)
                        {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_297[_loc12_.type]))
                  {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_349.push(_loc12_);
                        this.var_605.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1686;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var _loc6_:Boolean = false;
         var _loc7_:int = 0;
         while(_loc7_ < this.var_137.length)
         {
            _loc3_ = this.var_137[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         while(_loc8_ < this.var_501.maskCount)
         {
            ...
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_137.length)
               {
                  _loc3_ = this.var_137[_loc13_] as RoomPlane;
                  if(_loc3_.type == RoomPlane.const_120 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_120 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_269)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_137[_loc18_] as RoomPlane;
