   ...
   public class PlaneMaterialCellColumn
   {
      ...
      public function render(param1:int, param2:IVector3d) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_31 != null)
            {
               if(this.var_31.height == param1 && Vector3d.isEqual(this._cachedBitmapNormal,param2))
               {
                  return this.var_31;
               }
               this.var_31.dispose();
         ...
         if(this.var_31 == null)
         {
            this.var_31 = new BitmapData(this.var_245,param1,true,16777215);
         }
      ...
      {
         if(param1 == null || param1.length == 0 || this.var_31 == null)
         {
            return param2;
         }
         var _loc5_:* = null;
         ...
         while(_loc7_ < param1.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  this.var_31.copyPixels(_loc6_,_loc6_.rect,new Point(0,param2),_loc6_,null,true);
                  if(param3)
                  {
                     param2 += _loc6_.height;
                  }
                  if(param3 && param2 >= this.var_31.height || !param3 && param2 <= 0)
                  {
                     return param2;
                  }
               }
      ...
      {
         if(this.var_34.length == 0 || this.var_31 == null)
         {
            return;
         }
      ...
      private function renderRepeatAll(param1:IVector3d) : void
      {
         ...
         var _loc3_:int = 0;
         if(_loc2_ > this.var_31.height)
         {
         }
         while(_loc3_ < this.var_31.height)
         {
      ...
      private function renderRepeatBorders(param1:IVector3d) : void
      {
         ...
         var _loc8_:* = this.var_31.height - _loc5_ >> 1;
         ...
         {
            _loc4_ = [_loc2_];
            while(_loc9_ < this.var_31.height)
            {
      ...
      private function renderRepeatCenter(param1:IVector3d) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:int = 0;
         var _loc12_:int = this.var_31.height;
         if(_loc6_ + _loc7_ > this.var_31.height)
         {
            _loc10_ = _loc6_ + _loc7_ - this.var_31.height;
            _loc11_ -= _loc10_ >> 1;
         ...
         if(_loc10_ == 0)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc8_ > 0)
               {
                  _loc13_ = this.var_31.height - (_loc6_ + _loc7_);
      ...
      private function renderRepeatFirst(param1:IVector3d) : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:int = this.var_31.height;
