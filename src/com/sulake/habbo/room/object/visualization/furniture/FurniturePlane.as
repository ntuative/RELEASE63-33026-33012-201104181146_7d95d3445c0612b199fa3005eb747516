package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      public function FurniturePlane(param1:IVector3d, param2:IVector3d, param3:IVector3d)
      {
         ...
         this.var_740.assign(param2);
         this.var_741 = new Vector3d();
         this.var_741.assign(param3);
      ...
      {
         if(param1 != this.var_2269)
         {
            if(!param1)
            {
               this.var_294.assign(this.var_740);
               this.var_295.assign(this.var_741);
            }
            else
            {
               this.var_294.assign(this.var_740);
               this.var_294.mul(this.var_741.length / this.var_740.length);
               this.var_295.assign(this.var_741);
               this.var_295.mul(this.var_740.length / this.var_741.length);
            }
            this.var_1675 = -1;
            this.var_1373 = this.var_1373 - 1;
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || this.var_93 == null && this.var_1116 != null || this.var_294 == null || this.var_295 == null || this.var_596 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != this.var_1675)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != this.var_1373 || _loc4_.y != this.var_2267 || _loc4_.z != this.var_2268 || param1.scale != this.var_2266))
            {
               this.var_1373 = _loc4_.x;
               this.var_2267 = _loc4_.y;
               ...
               _loc7_ = _loc6_.z;
               _loc8_ = Math.max(this.var_156.z - _loc7_,this.var_112.z - _loc7_,this.var_83.z - _loc7_,this.var_111.z - _loc7_);
               this.var_2270 = _loc8_;
