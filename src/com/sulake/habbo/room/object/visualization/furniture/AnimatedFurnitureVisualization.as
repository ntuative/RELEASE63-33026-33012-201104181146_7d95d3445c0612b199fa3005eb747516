   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            if(_loc4_ != this._state)
            {
               ...
               if(_loc5_ != null)
               {
                  _loc6_ = _loc5_.getNumber(RoomObjectVariableEnum.const_700);
         ...
         if(super.updateModel(param1))
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc3_.getNumber(RoomObjectVariableEnum.const_700);
                     if(_loc4_ > this.var_1843)
                     {
                        this.var_1843 = _loc4_;
      ...
      protected function setSubAnimation(param1:AnimationStateData, param2:int, param3:Boolean = true) : Boolean
      {
         ...
         if(param3)
         {
            ...
            if(param2 != _loc5_)
            {
               if(!this._animationData.isImmediateChange(this.var_643,param2,_loc5_))
               {
                  _loc6_ = AnimationData.getTransitionFromAnimationId(_loc5_);
                  if(this._animationData.hasAnimation(this.var_643,_loc6_))
                  {
      ...
      protected function resetAllAnimationFrames() : void
      {
         if(this.var_118 != null)
         {
            this.var_118.setLayerCount(this.var_600);
         }
      }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         {
            this.var_643 = param1;
            this.var_600 = this._animationData.getLayerCount(param1);
      ...
      {
         var _loc2_:int = 0;
         if(!this.var_118.animationOver || this.var_970)
         {
      ...
      protected function updateFramesForAnimation(param1:AnimationStateData, param2:Number) : int
      {
         ...
         var _loc11_:* = null;
         var _loc12_:int = 0;
         if(param1.animationOver && !this.var_970)
         {
            return 0;
         }
         ...
         var _loc7_:* = 1 << this.var_600 - 1;
         var _loc8_:int = this.var_600 - 1;
         while(_loc8_ >= 0)
         {
            _loc9_ = param1.getAnimationPlayed(_loc8_);
            if(!_loc9_ || this.var_970)
            {
               ...
               if(this.var_970 || _loc11_ == null || _loc11_.remainingFrameRepeats >= 0 && _loc13_ <= 0)
               {
                  _loc12_ = 0;
                  if(_loc11_ != null)
                  {
                  ...
                  if(_loc12_ == AnimationFrame.const_1231)
                  {
                     _loc11_ = this._animationData.getFrame(param2,_loc4_,direction,_loc8_,_loc3_);
                  }
                  else
                  {
                     _loc11_ = this._animationData.getFrameFromSequence(param2,_loc4_,direction,_loc8_,_loc12_,_loc11_.activeSequenceOffset + _loc11_.method_2,_loc3_);
                  }
                  param1.setFrame(_loc8_,_loc11_);
                  _loc6_ |= _loc7_;
               }
               if(_loc11_ == null || _loc11_.remainingFrameRepeats == AnimationFrame.const_477)
               {
                  _loc10_ = true;
                  _loc9_ = true;
               }
