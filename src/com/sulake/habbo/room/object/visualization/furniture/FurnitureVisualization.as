package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1781:Number = Math.sqrt(0.5);
       
      
      private var _direction:int;
      
      private var var_2672:Number = NaN;
      
      private var var_2675:int = -1;
      
      private var _alphaMultiplier:Number = 1.0;
      
      private var var_1227:String = null;
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(param4)
         {
            this.var_1511 |= this.updateAnimation(_loc6_);
         }
         else
         {
            _loc7_ = this.updateAnimation(_loc6_) | this.var_1511;
            this.var_1511 = 0;
         }
         if(_loc5_ || _loc7_ != 0)
         {
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:int) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(this.var_600 != spriteCount)
         {
            createSprites(this.var_600);
         }
         if(param2)
         {
      ...
      private function updateSprite(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               _loc4_.clickHandling = this.var_2624;
            }
            else
            {
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_422:
               break;
            case LayerData.const_1164:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_1150:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_473 != _loc3_.getUpdateID() || param1 != var_88 || param2 != this.var_2672)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2675 = _loc3_.getNumber(RoomObjectVariableEnum.const_276);
            ...
            this.var_1227 = this.getAdClickUrl(_loc3_);
            if(this.var_1227 == null || this.var_1227.indexOf("http") != 0)
            {
               this.var_1227 = null;
            }
            this.var_2624 = this.var_1227 != null;
      ...
      {
         if(this.var_2676 != param2 || this.var_2674 != param1)
         {
            this.var_1001 = [];
            this.var_1000 = [];
            this.var_819 = [];
            ...
            this.var_2673 = this.getSize(param1);
      ...
      {
         this.var_600 = param1;
         this.var_1923 = this.var_600 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         var _loc5_:int = 0;
         var _loc6_:* = null;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_511.length)
         {
            return "";
         }
         var _loc3_:String = this.var_1001[param2];
         var _loc4_:Boolean = this.var_1000[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2673;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1923)
            {
               _loc6_ = FurnitureVisualizationData.const_511[param2];
            }
            else
            {
               _loc6_ = "sd";
            ...
            this.var_1001[param2] = _loc3_;
            this.var_1000[param2] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_820[param3] != null && !this.var_1922)
         {
