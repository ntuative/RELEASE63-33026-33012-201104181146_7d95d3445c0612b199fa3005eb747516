package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureRoomDimmerLogic extends FurnitureLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectWidgetRequestEvent.const_135,RoomObjectWidgetRequestEvent.const_113,RoomObjectDimmerStateUpdateEvent.const_65];
         ...
         switch(param1.type)
         {
            case MouseEvent.DOUBLE_CLICK:
               if(eventDispatcher != null)
               {
                  ...
                  _loc5_ = new RoomObjectWidgetRequestEvent(RoomObjectWidgetRequestEvent.const_135,_loc3_,_loc4_);
      ...
      override public function update(param1:int) : void
      {
         ...
         {
            _loc2_ = object.getModelController().getString(RoomObjectVariableEnum.const_98);
            if(_loc2_ != null && _loc2_.length > 0)
            {
               object.getModelController().setString(RoomObjectVariableEnum.const_98,"");
