   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(!this.var_2177)
         {
            ...
            if(param1 is RoomObjectAvatarUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_197,_loc4_.dirHead);
               return;
            }
            if(param1 is RoomObjectAvatarChatUpdateMessage)
            {
               ...
               this.var_1350 = getTimer() + _loc5_.numberOfWords * 1000;
               return;
            }
            ...
            if(param1 is RoomObjectAvatarSleepUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_385,Number(_loc7_.isSleeping));
               return;
            }
         }
         ...
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_917,Number(_loc9_.gainedExperience));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            _loc10_ = param1 as RoomObjectAvatarFigureUpdateMessage;
            _loc11_ = _loc2_.getString(RoomObjectVariableEnum.const_187);
            _loc2_.setString(RoomObjectVariableEnum.const_187,_loc10_.figure);
            _loc2_.setString(RoomObjectVariableEnum.const_1520,_loc10_.race);
            _loc2_.setNumber(RoomObjectVariableEnum.const_781,this.getPaletteIndex(_loc10_.figure));
            return;
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(param1.type)
         {
            case MouseEvent.CLICK:
               ...
               if(eventDispatcher != null)
               {
                  _loc8_ = new RoomObjectMouseEvent(RoomObjectMouseEvent.const_157,param1.eventId,_loc6_,_loc7_,param1.altKey,param1.ctrlKey,param1.shiftKey,param1.buttonDown);
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_197,_loc3_ + this.var_889);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_1630;
            _loc2_.setNumber(RoomObjectVariableEnum.const_284,this.var_1630);
            _loc2_.setNumber(RoomObjectVariableEnum.const_137,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_1631;
            _loc2_.setNumber(RoomObjectVariableEnum.const_137,this.var_1631);
         }
         else
         {
            this.var_889 += 45;
