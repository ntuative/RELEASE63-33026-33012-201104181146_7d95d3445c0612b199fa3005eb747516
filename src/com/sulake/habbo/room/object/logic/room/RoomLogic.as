package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1774:int = 255;
      
      private var var_1495:uint = 16777215;
      
      private var var_1892:int = 255;
      
      private var var_1216:uint = 16777215;
      
      private var var_1891:int = 255;
      
      private var var_1215:int = 0;
      
      private var var_1890:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_513,RoomObjectMouseEvent.const_157];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1078,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_957,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_867,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_800,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_697,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1215)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1774;
            if(_loc2_ - this.var_1215 >= this.var_1890)
            {
               _loc3_ = this.var_1216;
               _loc4_ = this.var_1891;
               this.var_1215 = 0;
            }
            else
            {
               _loc7_ = this.var_1495 >> 16 & 255;
               _loc8_ = this.var_1495 >> 8 & 255;
               _loc9_ = this.var_1495 & 255;
               _loc10_ = this.var_1216 >> 16 & 255;
               _loc11_ = this.var_1216 >> 8 & 255;
               _loc12_ = this.var_1216 & 255;
               _loc13_ = (_loc2_ - this.var_1215) / this.var_1890;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1892 + (this.var_1891 - this.var_1892) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_957,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_706:
               param2.setString(RoomObjectVariableEnum.const_309,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_763:
               param2.setString(RoomObjectVariableEnum.const_333,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_857:
               param2.setString(RoomObjectVariableEnum.const_329,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_504:
               ...
               this.var_501.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_849:
               _loc4_ = this.var_501.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_501.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1142,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1215:
               param2.setNumber(RoomObjectVariableEnum.const_867,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1201:
               param2.setNumber(RoomObjectVariableEnum.const_800,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_697,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1183,int(param1.bgOnly));
         this.var_1495 = this._color;
         this.var_1892 = this.var_1774;
         this.var_1216 = _loc3_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:String = _loc3_.method_1;
         if(_loc6_.indexOf("@") >= 0)
         {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_505,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1508,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1749,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1758,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_505,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_165 || _loc12_ == RoomPlaneData.const_351)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
