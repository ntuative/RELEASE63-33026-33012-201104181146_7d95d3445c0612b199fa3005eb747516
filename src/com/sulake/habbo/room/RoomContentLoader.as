package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_920:String = "RCL_LOADER_READY";
      
      private static const const_362:String = "RCL_PUBLICROOM_";
      
      private static const const_1821:int = 0;
      
      private static const const_1046:int = 1;
      
      private static const name_4:int = 2;
      
      private static const const_451:String = "place_holder";
      
      private static const const_663:String = "wall_place_holder";
      
      private static const const_664:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_451;
      
      private static const const_665:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_1045:String = "selection_arrow";
      ...
      private var var_383:Dictionary;
      
      private var var_675:Map = null;
      
      private var _wallItems:Dictionary;
      
      private var var_1040:Map = null;
      
      private var var_462:Dictionary;
      
      private var var_1041:Map = null;
      
      private var var_213:PublicRoomData = null;
      
      private var var_1553:Map = null;
      
      private var var_674:Map = null;
      
      private var var_553:Map = null;
      
      private var var_551:Map = null;
      
      private var var_843:Map = null;
      ...
      {
         this.var_383 = new Dictionary();
         this._wallItems = new Dictionary();
         this.var_462 = new Dictionary();
         this.var_2789 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
      ...
      {
         if(this._state >= const_1046)
         {
            return;
         }
         this._stateEvents = param1;
         this.var_2787 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2786 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2790 = param2.getKey("public.room.dynamic.download.url","");
         this._publicRoomLoadNameTemplate = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         this._state = const_1046;
         this.initFurnitureData();
      }
      ...
      private function initPetData() : void
      {
         ...
         {
            this.var_462[_loc3_] = _loc2_;
            this.var_1040.add(_loc2_,_loc3_);
            _loc2_++;
         }
      ...
      private function initFurnitureData() : void
      {
         ...
         var _loc1_:Array = this.var_434.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_552.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_552.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         if(this.var_461 != null)
         {
            ...
            while(_loc3_ < _loc2_)
            {
               _loc5_ = this.var_461.getWithIndex(_loc3_) as IGraphicAssetCollection;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
         ...
         {
            for(_loc1_ in this.var_383)
            {
               delete this.var_383[_loc1_];
            }
            this.var_383 = null;
         }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               this.var_843.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_460.add(_loc3_,_loc4_);
               if(this.var_383[_loc7_] == null)
               {
                  this.var_383[_loc7_] = 1;
               }
            }
            else if(_loc2_.type == "i")
            {
               ...
               this.var_675.add(_loc3_,_loc4_);
               if(this._wallItems[_loc7_] == null)
               {
                  this._wallItems[_loc7_] = 1;
               }
            }
            _loc8_ = this.var_674.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_674.remove(_loc7_);
               this.var_674.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2788)
         {
            ...
            {
               this._stateEvents.dispatchEvent(new Event(const_920));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_553 != null)
         {
            this.var_553.remove(param1);
            this.var_553.add(param1,param2);
         }
         if(this.var_551 != null)
         {
            this.var_551.remove(param2);
            this.var_551.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(this.var_553 != null)
         {
            _loc2_ = this.var_553.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(this.var_213 != null && (this.var_213.type == param1 || this.var_213.hasWorldType(param1)))
         {
         ...
         {
            return RoomObjectCategoryEnum.const_296;
         }
         return RoomObjectCategoryEnum.const_175;
      }
      ...
      {
         return [const_451,const_663,const_664,const_665,TILE_CURSOR,const_1045];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_460.getValue(param1) as String;
         return this.getObjectType(_loc2_);
      }
      
      public function getWallItemType(param1:int, param2:String = null) : String
      {
         var _loc3_:String = this.var_675.getValue(param1) as String;
      ...
      {
         return this.var_1040.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_1041[param1];
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:String = this.var_675.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return this.var_843.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_213 != null && this.var_213.hasWorldType(const_362 + param1))
         {
            return this.var_213.type;
         }
         return param1;
      }
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_236 || param1 == RoomObjectVisualizationEnum.const_69 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_27 || _loc2_ == RoomObjectCategoryEnum.const_26)
         {
            ...
            return int(this.var_674.getValue(param1));
         }
         return 0;
      }
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               while(_loc9_ < _loc7_.length)
               {
                  ...
                  _loc8_.push(this.var_2790 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_27:
                     if(this.var_383[_loc4_] == null)
                     {
                        this.var_383[_loc4_] = 1;
                     }
                     break;
                  case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_429,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1553.getValue(param1) != null)
         {
            this.var_213 = this.var_1553.getValue(param1) as PublicRoomData;
         }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2789.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1494);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            ...
            else if(this.var_462[_loc5_] != null)
            {
               this.extractPetDataFromLoadedContent(_loc5_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_429,_loc5_);
         }
         else
         {
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc6_ = this.var_462[param1];
            this.var_1041.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1553.add(param1,_loc4_);
         this.var_213 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_844.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_844.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_552.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = this.var_844.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = this.getContentType(_loc4_);
               _loc3_ = this.var_552.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_552.add(_loc5_,_loc4_);
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_482.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            this.var_461.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_461.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_461[_loc2_] != null)
         {
            _loc3_ = this.var_461.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         {
            _loc6_ = _loc3_[_loc5_];
            _loc7_ = const_362 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(this.getObjectCategory(const_362 + param1) == RoomObjectCategoryEnum.const_79)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_213.getWorldHeightScale(const_362 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_213 != null)
         {
            return this.var_213.getWorldScale(const_362 + param1);
         }
         return 32;
      }
      ...
      {
         this.var_460.remove(param1);
         this.var_460.add(param1,param2);
      }
   }
}
