package com.sulake.habbo.room
{
   ...
   public class RoomObjectEventHandler implements IRoomRenderingCanvasMouseListener
   {
      ...
      public function setSelectedObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         switch(param4)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc5_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_877,param1,param2,param3,param4));
         }
      }
      ...
      public function processRoomCanvasMouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomObject, param3:IRoomGeometry) : void
      {
         ...
         if(_loc5_ != RoomObjectCategoryEnum.const_79)
         {
      ...
      public function handleRoomObjectEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectStateChangeEvent.const_91:
               this.handleObjectStateChange(param1 as RoomObjectStateChangeEvent,param2,param3);
               break;
            case RoomObjectStateChangeEvent.const_919:
            ...
            case RoomObjectDimmerStateUpdateEvent.const_65:
               ...
               break;
            case RoomObjectMoveEvent.const_430:
               this.handleSelectedObjectMove(param1,param2,param3);
               break;
            case RoomObjectMoveEvent.const_854:
            ...
            case RoomObjectWidgetRequestEvent.const_135:
            ...
            case RoomObjectWidgetRequestEvent.const_151:
               ...
               break;
            case RoomObjectFurnitureActionEvent.const_548:
            case RoomObjectFurnitureActionEvent.const_510:
            case RoomObjectFurnitureActionEvent.const_459:
            case RoomObjectFurnitureActionEvent.const_519:
            case RoomObjectFurnitureActionEvent.const_535:
            case RoomObjectFurnitureActionEvent.const_604:
            case RoomObjectFurnitureActionEvent.const_597:
               this.handleObjectActionEvent(param1,param2,param3);
               break;
            case RoomObjectFurnitureActionEvent.const_601:
            case RoomObjectFurnitureActionEvent.const_555:
            ...
            case RoomObjectFurnitureActionEvent.const_522:
               ...
               break;
            case RoomObjectFurnitureActionEvent.const_481:
            case RoomObjectFurnitureActionEvent.const_495:
            case RoomObjectFurnitureActionEvent.const_541:
            case RoomObjectFurnitureActionEvent.const_458:
               this.handleObjectJukeboxEvent(param1,param2,param3);
               break;
            case RoomObjectRoomAdEvent.const_190:
            case RoomObjectRoomAdEvent.const_456:
            case RoomObjectRoomAdEvent.const_305:
            case RoomObjectRoomAdEvent.const_342:
            case RoomObjectRoomAdEvent.const_180:
               this.handleObjectRoomAdEvent(param1,param2,param3);
               break;
            case RoomObjectRoomActionEvent.const_615:
            case RoomObjectRoomActionEvent.const_1662:
            case RoomObjectRoomActionEvent.const_497:
               this.handleRoomActionEvent(param1,param2,param3);
               break;
            case RoomObjectFurnitureActionEvent.const_568:
      ...
      private function handleRoomObjectMouseEvent(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         switch(param1.type)
         {
            case RoomObjectMouseEvent.const_157:
               this.handleRoomObjectMouseClick(param1,param2,param3);
               break;
            case RoomObjectMouseEvent.const_513:
      ...
      private function handleRoomObjectMouseClick(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         switch(_loc4_)
         {
            case RoomObjectOperationEnum.OBJECT_MOVE:
               if(_loc8_ == RoomObjectCategoryEnum.const_79)
               {
                  if(_loc5_ != null)
                  {
            ...
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               ...
               else
               {
                  ...
                  if(_loc10_ != null)
                  {
                     if(_loc12_)
                     {
                        this.setMouseEventId(RoomObjectCategoryEnum.const_79,MouseEvent.CLICK,_loc10_);
                     }
                     if(_loc13_)
                     {
                        this.setMouseEventId(RoomObjectCategoryEnum.const_175,MouseEvent.CLICK,_loc10_);
                     }
                  }
               }
         }
         if(_loc8_ == RoomObjectCategoryEnum.const_79)
         {
            _loc14_ = this.getMouseEventId(RoomObjectCategoryEnum.const_175,MouseEvent.CLICK);
            ...
            if(_loc14_ != _loc10_ && _loc15_ != _loc10_)
            {
               ...
               if(_loc16_ != null)
               {
                  _loc16_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_545,param2,param3,-1,RoomObjectCategoryEnum.const_175));
               }
      ...
      private function handleRoomObjectMouseMove(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(this._roomEngine != null)
         {
            ...
            if(_loc8_ != null && _loc8_.getEventHandler() != null)
            {
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc10_ = new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_530);
               }
               else
               {
                  _loc10_ = new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_623);
               }
               _loc8_.getEventHandler().processUpdateMessage(_loc10_);
            }
         }
         ...
         {
            case RoomObjectOperationEnum.OBJECT_MOVE:
               if(_loc7_ == RoomObjectCategoryEnum.const_79)
               {
            ...
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               if(_loc8_ == RoomObjectCategoryEnum.const_27 || _loc8_ == RoomObjectCategoryEnum.const_26)
               {
                  if(param1.altKey)
                  {
                     ...
                     if(_loc10_ != null)
                     {
                        _loc10_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_714,param2,param3,_loc6_,_loc8_));
                     }
                  }
               }
         }
      ...
      private function handleObjectPlace(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(_loc6_ == null)
         {
            ...
            else if(_loc5_.category == RoomObjectCategoryEnum.const_34 && _loc7_ != null)
            {
            ...
            if(_loc6_ != null)
            {
               if(_loc5_.category == RoomObjectCategoryEnum.const_27)
               {
                  ...
                  {
                     _loc9_ = _loc6_.getModel().getNumberArray(RoomObjectVariableEnum.const_947);
         ...
         if(_loc7_ != null)
         {
            switch(param1.type)
            {
               ...
               case RoomObjectWidgetRequestEvent.const_155:
                  ...
                  break;
               case RoomObjectWidgetRequestEvent.const_135:
                  _loc7_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_135,param2,param3,_loc4_,_loc6_));
                  break;
               case RoomObjectWidgetRequestEvent.const_113:
      ...
      private function handleObjectSoundMachineEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectFurnitureActionEvent.const_601:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_731,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_555:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_850,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_577:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_902,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_522:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_787,param2,param3,param1.objectId,_loc4_));
         }
      }
      ...
      private function handleObjectJukeboxEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectFurnitureActionEvent.const_481:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_742,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_495:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_1709,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_541:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_1745,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_458:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_235,param2,param3,param1.objectId,_loc4_));
         }
      }
      ...
      private function validateFurnitureDirection(param1:IRoomObject, param2:IVector3d, param3:TileHeightMap) : Boolean
      {
         ...
         var _loc6_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_299);
         var _loc7_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_431);
         if(_loc6_ < 1)
         {
            _loc6_ = 1;
         }
      ...
      private function validateFurnitureLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:TileHeightMap) : Vector3d
      {
         ...
         var _loc7_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_299);
         var _loc8_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_431);
         if(_loc7_ < 1)
         {
            _loc7_ = 1;
         }
      ...
      private function validateWallItemLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Number, param6:Number, param7:SelectedRoomObjectData) : Vector3d
      {
         ...
         var _loc8_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_299);
         var _loc9_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_710);
         var _loc10_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_1071);
      ...
      private function setObjectAlphaMultiplier(param1:IRoomObjectController, param2:Number) : void
      {
         ...
         {
            param1.getModelController().setNumber(RoomObjectVariableEnum.const_353,param2);
         }
      }
      ...
      public function setSelectedAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var category:int = 0;
         var object:IRoomObjectController = this._roomEngine.getRoomObject(roomId,roomCategory,this.var_1453,category) as IRoomObjectController;
         ...
         if(selectionArrow != null && selectionArrow.getEventHandler() != null)
         {
            ...
            {
               selectionArrow.getEventHandler().processUpdateMessage(new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_530));
            }
            else
            {
               selectionArrow.getEventHandler().processUpdateMessage(new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_623));
            }
         }
      }
      ...
      private function getValidFurnitureDirection(param1:IRoomObjectController, param2:Boolean) : int
      {
         ...
         {
            _loc3_ = param1.getModel().getNumberArray(RoomObjectVariableEnum.const_947);
         }
      ...
      private function placeObject(param1:int, param2:int) : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.connection != null)
         {
            ...
            if(_loc6_ != null)
            {
               ...
               if(_loc5_ == RoomObjectCategoryEnum.const_27 || _loc5_ == RoomObjectCategoryEnum.const_34)
               {
                  _loc8_ = Number(_loc13_.x);
                  _loc9_ = Number(_loc13_.y);
               }
               else if(_loc5_ == RoomObjectCategoryEnum.const_26)
               {
                  _loc8_ = Number(_loc13_.x);
                  _loc9_ = Number(_loc13_.y);
                  _loc10_ = Number(_loc13_.z);
               ...
               _loc11_ = (_loc11_ / 45 % 8 + 8) % 8;
               if(_loc5_ == RoomObjectCategoryEnum.const_34 && _loc3_.typeId == RoomObjectTypeEnum.const_191)
               {
         ...
         if(this._roomEngine && this._roomEngine.events)
         {
            ...
            this._roomEngine.events.dispatchEvent(new RoomEngineObjectPlacedEvent(RoomEngineObjectEvent.const_166,param1,param2,_loc4_,_loc5_,_loc7_,_loc8_,_loc9_,_loc10_,_loc11_,_loc15_));
         }
      }
      ...
      private function changeObjectState(param1:int, param2:int, param3:int, param4:String, param5:int, param6:Boolean) : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.connection != null)
         {
            ...
            if(_loc7_ == RoomObjectCategoryEnum.const_27)
            {
               if(!param6)
               {
