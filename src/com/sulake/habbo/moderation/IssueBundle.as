package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_839:IssueMessageData = null;
      
      private var var_840:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2750 = param2.pickerUserId;
         this.var_2769 = param2.pickerUserName;
         this.var_1579 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1271 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1272;
         }
         if(this.var_839 == null || param1.timeStamp < this.var_839.timeStamp)
         {
            this.var_839 = param1;
         }
         if(this.var_840 == null || param1.priority > this.var_840.timeStamp)
         {
            this.var_840 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1271 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1272;
            }
            if(this.var_839 == _loc2_)
            {
               this.var_839 = null;
            }
            if(this.var_840 == _loc2_)
            {
               this.var_840 = null;
            }
         }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_840;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_839;
         if(_loc2_ == null)
         {
