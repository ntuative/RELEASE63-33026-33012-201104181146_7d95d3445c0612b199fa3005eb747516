package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1177:String = "issue_bundle_open";
      
      public static const const_921:String = "issue_bundle_my";
      
      public static const const_1067:String = "issue_bundle_picked";
      
      public static const const_1726:int = 15000;
       
      
      private var var_67:ModerationManager;
      
      private var var_615:IssueBrowser;
      
      private var _issues:Map;
      
      private var var_105:Map;
      
      private var var_931:Map;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_931 = new Map();
         this.var_615 = new IssueBrowser(this,this.var_67.windowManager,this.var_67.assets);
         this.var_1151 = [];
         this.var_1150 = [];
         this.var_932 = new Map();
         this.var_2393 = parseInt(this.var_67.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1741 = new Timer(const_1726,0);
         this.var_1741.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1741.start();
      }
      ...
      public function pickBundle(param1:int, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_1151 = this.var_1151.concat(_loc4_.getIssueIds());
      }
      ...
      public function autoPick(param1:Boolean = false, param2:int = 0) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_164 && (_loc4_ == null || _loc5_.prioritySum > _loc4_.prioritySum))
            {
               _loc4_ = _loc5_;
            }
         }
      ...
      public function releaseAll() : void
      {
         ...
         var _loc1_:int = this.var_67.sessionDataManager.userId;
         var _loc2_:* = [];
         for each(_loc3_ in this.var_105)
         {
            if(_loc3_.state == IssueMessageData.const_404 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      {
         if(param1 == null || param1.length == 0 || this.var_67 == null || this.var_67.connection == null)
         {
            return;
         }
         this.var_67.connection.send(new ReleaseIssuesMessageComposer(param1));
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_615 == null || !this.var_615.isOpen())
         {
            this.var_67.soundManager.playSound(HabboSoundTypesEnum.const_1263);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(this.var_931.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  this.var_931.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1763)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in this.var_105)
            {
               if(this.validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  this.var_931.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            _loc2_ = this.var_2394++;
            _loc3_ = new IssueBundle(_loc2_,param1);
            this.var_931.add(param1.issueId,_loc2_);
         ...
         if(this.var_1151.indexOf(param1.issueId) != -1)
         {
            this.handleBundle(_loc3_.id);
            _loc5_ = this.var_67.sessionDataManager.userId;
            if(_loc5_ != param1.pickerUserId)
            {
               if(param1.state == IssueMessageData.const_404)
               {
                  this.unhandleBundle(_loc3_.id);
               }
            }
         }
         if(param1.state == IssueMessageData.const_164)
         {
            _loc6_ = this.getBundles(const_921);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1150.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_67 == null || this.var_67.configuration == null)
         {
            return;
         }
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2393);
            }
         }
      ...
      {
         var _loc2_:IssueHandler = this.var_932.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_932.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = this.var_931.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_105.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function getBundles(param1:String) : Array
      {
         ...
         var _loc2_:* = [];
         var _loc3_:int = this.var_67.sessionDataManager.userId;
         for each(_loc4_ in this.var_105)
         {
            switch(param1)
            {
               case const_1177:
                  if(_loc4_.state == IssueMessageData.const_164)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
               case const_921:
                  if(_loc4_.state == IssueMessageData.const_404 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = new IssueHandler(this.var_67,_loc2_);
         this.removeHandler(param1);
         this.var_932.add(param1,_loc3_);
         this.var_67.windowTracker.show(_loc3_,null,false,false,false);
         this.var_1151 = [];
      }
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_932.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      {
         if(param1 == null || this.var_67 == null || this.var_67.connection == null)
         {
            return;
         }
         this.var_67.connection.send(new CloseIssuesMessageComposer(param1,param2));
      }
      ...
      private function sendPick(param1:Array, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_67.connection.send(new PickIssuesMessageComposer(param1,param2,param3));
      }
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         var _loc4_:int = this.var_67.sessionDataManager.userId;
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.state == IssueMessageData.const_404 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.prioritySum > _loc3_.prioritySum))
            {
               _loc3_ = _loc5_;
            }
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_932.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
