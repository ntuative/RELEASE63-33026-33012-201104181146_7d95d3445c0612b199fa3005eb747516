package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2071:String = "my_issues";
      
      private const const_2070:String = "open_issues";
      
      private const const_2069:String = "picked_issues";
      
      private const const_2112:String = "closed_issues";
      ...
      private var var_354:IIssueBrowserView;
      
      private var var_1734:IIssueBrowserView;
      
      private var var_1733:IIssueBrowserView;
      
      private var var_1735:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_250 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_250.numTabItems)
            {
               _loc5_ = this.var_250.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_57,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_250 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_250 == null || this.var_250.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_250.selector.getSelectableByName("open_issues");
         this.var_250.selector.setSelected(_loc1_);
      }
      
      private function selectView(param1:String) : void
      {
         var _loc2_:IIssueBrowserView = this.getView(param1);
         if(this.var_354 == _loc2_)
         {
            return;
         }
         if(this.var_354 != null)
         {
            this.var_354.visible = false;
         }
         this.var_354 = _loc2_;
         if(this.var_354 == null)
         {
         ...
         this.var_354.view.width = this.var_250.container.width;
         this.var_354.view.height = this.var_250.container.height;
         this.var_354.visible = true;
         this.var_354.update();
      }
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2071:
               if(this.var_1734 == null)
               {
                  this.var_1734 = new MyIssuesView(this.issueManager,this,this.var_250.container);
               }
               return this.var_1734;
            case this.const_2070:
               if(this.var_1733 == null)
               {
                  this.var_1733 = new OpenIssuesView(this.issueManager,this,this.var_250.container);
               }
               return this.var_1733;
            case this.const_2069:
               if(this.var_1735 == null)
               {
                  this.var_1735 = new PickedIssuesView(this.issueManager,this,this.var_250.container);
               }
