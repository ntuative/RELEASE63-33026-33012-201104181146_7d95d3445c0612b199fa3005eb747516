package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_755:int = 4;
      
      public static const const_1054:int = 5;
      
      public static const const_1527:int = 6;
      
      public static const const_1501:int = 7;
      ...
      private var var_1927:Dictionary;
      
      public function WindowTracker()
      {
         this.var_1927 = new Dictionary();
         super();
      }
      ...
      {
         var _loc2_:Dictionary = this.var_1927[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_1927[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
