package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1098:IDropMenuWindow;
      
      private var var_521:ITextFieldWindow;
      
      private var var_628:Boolean = true;
      
      private var var_919:ICheckBoxWindow;
      
      private var var_1390:ICheckBoxWindow;
      
      private var var_1391:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_35.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_392));
         Logger.log("BEGINNING TO SHOW: " + this.var_392);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1580;
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_392);
         if(param1.flatId != this.var_392)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_392);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_1098 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1098);
         this.var_1098.procedure = this.onSelectTemplate;
         this.var_919 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1390 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1391 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_35,WindowTracker.const_755,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_919.isSelected);
         this.var_35.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1540,_loc2_,this.var_521.text,"",""));
         if(this.var_1390.isSelected || this.var_1391.isSelected || this.var_919.isSelected)
         {
            this.var_35.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1390.isSelected,this.var_1391.isSelected,this.var_919.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1484);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1536);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_35.initMsg.roomMessageTemplates[this.var_1098.selection];
         if(_loc3_ != null)
         {
            this.var_628 = false;
