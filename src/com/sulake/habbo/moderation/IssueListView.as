package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      private static const const_641:int = 20;
      ...
      private var var_1693:IWindowContainer;
      
      private var var_2960:BitmapData;
      
      private var var_2959:BitmapData;
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         this.var_615 = param2;
         this.var_60 = param3;
         this.var_1779 = param4;
         this.var_1693 = this.var_615.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         if(_loc4_ < _loc5_)
         {
            ...
            {
               _loc3_ = this.var_1693.clone() as IWindowContainer;
         ...
         for each(_loc7_ in param1)
         {
            ...
            if(_loc7_ == null || this.var_1693 == null)
            {
               return;
            }
            ...
            if(_loc11_ != null)
            {
               ...
               _loc13_ = this.var_615.assets.getAssetByName(_loc12_) as BitmapDataAsset;
