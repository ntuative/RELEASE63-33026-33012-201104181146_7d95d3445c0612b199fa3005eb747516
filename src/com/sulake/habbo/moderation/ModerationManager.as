package com.sulake.habbo.moderation
{
   ...
   public class ModerationManager extends Component implements IHabboModeration
   {
      ...
      private var var_2430:ModerationMessageHandler;
      
      private var _issueManager:IssueManager;
      
      private var var_936:StartPanelCtrl;
      
      private var var_2432:WindowTracker;
      
      private var var_2431:ModeratorInitData;
      ...
      public function ModerationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_936 = new StartPanelCtrl(this);
         this.var_2432 = new WindowTracker();
      }
      ...
      public function userSelected(param1:int, param2:String) : void
      {
         ...
         this.var_936.userSelected(param1,param2);
      }
      ...
      public function get method_3() : StartPanelCtrl
      {
         return this.var_936;
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            this.var_2430 = new ModerationMessageHandler(this);
         }
      }
