package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1830:String = "noconvinfo";
      
      private static const const_1831:String = "messageinput";
      ...
      private var var_1595:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList, param2:IHabboConfigurationManager)
      {
         ...
         this.var_1595 = new FriendListTabsView(this._friendList);
         if(param2.getKey("client.toolbar.static.enabled","com.sulake.habbo.inventory.marketplace") == "InfoStandSongDiskView")
         {
            this.var_1023 = true;
         }
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_1595.prepare(this.var_1022);
         this.var_15.procedure = this.onWindow;
         this.var_15.content.setParamFlag(HabboWindowParam.const_1242,false);
         this.var_15.content.setParamFlag(HabboWindowParam.const_1206,true);
         this.var_15.header.setParamFlag(HabboWindowParam.const_757,false);
         this.var_15.header.setParamFlag(HabboWindowParam.const_789,true);
         this.var_15.content.setParamFlag(HabboWindowParam.const_757,false);
         this.var_15.content.setParamFlag(HabboWindowParam.const_789,true);
         this.var_15.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1596 = ITextWindow(this.var_15.findChildByName("info_text"));
         this.var_1596.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_2065 == -1 ? 0 : int(this.var_15.height - this.var_2065);
         var _loc4_:int = this.var_2063 == -1 ? 0 : int(this.var_15.width - this.var_2063);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_1192,this._friendList.tabs.findSelectedTab() != null);
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_757,false);
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_1242,false);
         ...
         this.var_2065 = this.var_15.height;
         this.var_2063 = this.var_15.width;
