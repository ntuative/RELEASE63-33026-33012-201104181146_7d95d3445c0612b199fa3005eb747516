package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      public static const const_169:String = "face";
      ...
      private var var_141:IHabboMessenger;
      ...
      private var var_2615:FriendListLookAndFeel;
      
      private var var_456:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1885:OpenedToWebPopup;
      
      private var var_2614:int;
      
      var var_103:FriendCategories;
      
      private var var_370:FriendRequests;
      
      private var var_1886:AvatarSearchResults;
      ...
      {
         this.var_2615 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_103 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1886 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_653.stop();
            this.var_653.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_653 = null;
         }
         ...
         if(this.var_141)
         {
            this.var_141.release(new IIDHabboMessenger());
            this.var_141 = null;
         }
         if(this.var_188)
         {
         ...
         if(this.var_1091)
         {
            this.var_1091.release(new IIDAvatarRenderManager());
            this.var_1091 = null;
         }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1885 = new OpenedToWebPopup(this);
         }
         this.var_1885.show(x,y);
      }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return this.var_103.findFriend(param1);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_101);
      }
      
      public function openFriendRequests() : void
      {
         this.openFriendListWithTab(FriendListTab.const_88);
      }
      
      public function openFriendSearch() : void
      {
         this.openFriendListWithTab(FriendListTab.const_322);
      }
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_103.getFriendCount(param1,param2);
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_370.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_300,HabboWindowStyle.const_45,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1091.createAvatarImage(param1,AvatarScaleType.const_93,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_188.getKey("client.minimail.embed.enabled");
         return _loc1_ == "InfoStandSongDiskView";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_188.getKey(param1,param1,param2);
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_141 = param2 as IHabboMessenger;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         this._view = new FriendListView(this,this.var_188);
         var _loc2_:MessengerInitMessageParser = (param1 as MessengerInitEvent).getParser();
         this.var_370 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_103.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_103.addCategory(new FriendCategory(FriendCategory.const_1255,this.getText("friendlist.friends")));
         this.var_103.addCategory(new FriendCategory(FriendCategory.const_365,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_103.addFriend(new Friend(_loc4_));
         }
         this.var_456 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_653)
         {
            this.var_653 = new Timer(120000);
            this.var_653.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_653.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_118,HabboToolbarIconEnum.FRIENDLIST));
         this._toolbar.events.addEventListener(HabboToolbarEvent.const_36,this.onHabboToolbarEvent);
         if(this.var_103.getFriendCount(true,false) == 0)
         {
            _loc5_ = this.var_103.findCategory(FriendCategory.const_365);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_456.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_405));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_370.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_370.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_456.findTab(FriendListTab.const_88).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_370.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_456.findTab(FriendListTab.const_88);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1886.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         this.var_103.onFriendListUpdate(param1);
      ...
      public function getFriendNames() : Array
      {
         ...
         return this.var_103.getFriendNames();
      }
      
      public function acceptFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = this.var_456.findTab(FriendListTab.const_88);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_801 || !this.var_370)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_801.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_47))
         {
            _loc2_ = this.var_370.vipLimit;
         }
         else if(this.var_801.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_44))
         {
            _loc2_ = this.var_370.clubLimit;
         }
         if(_loc2_ > this.var_370.limit)
         {
            this.var_370.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(disposed || this.var_103 == null)
         {
            return;
         }
         var _loc2_:Dictionary = this.var_103.getAllFriends();
         if(_loc2_ == null)
         {
            return;
         }
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_169) as IBitmapWrapperWindow;
