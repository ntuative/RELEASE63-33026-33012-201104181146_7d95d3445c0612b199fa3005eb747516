package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_409)
         {
            this.var_409.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_409.reset();
            this.var_409 = null;
         }
         if(this.var_339)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_56 == null)
         {
            this.var_56 = IWindowContainer(this._navigator.getXmlWindow(this.var_1080));
            this.var_56.visible = false;
            this.var_56.setParamFlag(HabboWindowParam.const_38,true);
         ...
         this.var_56.x = _loc2_.x + this.var_2225 + param1.width;
