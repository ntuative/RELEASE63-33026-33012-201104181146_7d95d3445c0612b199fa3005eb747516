package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_686:ICheckBoxWindow;
      ...
      private var var_2051:IWindowContainer;
      ...
      {
         this.var_392 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_392));
      ...
      {
         if(param1 != this.var_392 || this.var_1294 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1294 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1559)
         {
            this.var_853.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1493)
         {
            this.var_853.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1572)
         {
            this.var_1293.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1523)
         {
            this.setTagError(this.var_1007,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_1006,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1560)
         {
            this.setTagError(this.var_1007,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_1006,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         ...
         {
            this.var_853.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_355,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_547,this.onDoorModePasswordUnselect);
         ...
         this.var_853 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1293 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_1007 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_1006 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         ...
         this.var_1299 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1295 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1296 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_686 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this._thumbnailContainer = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1301 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1298 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_2051 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1583 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_279 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1300 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1582 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1582.mouseThreshold = 0;
         this.var_1582.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1300.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_2051.visible = this._inRoom;
         if(this.var_854)
         {
         ...
         {
            this.populateForm();
            this.var_1301.visible = true;
            this.var_1583.visible = true;
            this._thumbnailContainer.visible = this._inRoom;
            this.var_1301.height = Util.getLowestPoint(this.var_1301) + 4;
         }
         this.var_1582.text = !!this.var_854 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this._thumbnailContainer.name,this.var_1301.name,this.var_1298.name,this.var_1583.name,this.var_2051.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_853.setText(_loc1_.name);
         this.var_1293.setText(_loc1_.description);
         ...
         {
            case RoomSettingsData.const_189:
         ...
         this.setTag(this.var_1007,_loc1_.tags[0]);
         this.setTag(this.var_1006,_loc1_.tags[1]);
         if(this.var_1299)
         {
            if(_loc1_.allowPets)
            {
               this.var_1299.select();
            }
            else
            {
               this.var_1299.unselect();
            }
         }
         if(this.var_1295)
         {
         ...
         if(this.var_686)
         {
            ...
            {
               this.var_686.unselect();
            }
            _loc6_ = 1;
            _loc7_ = 16777215;
            if(!this.hideWallsAllowed())
            {
               this.var_686.disable();
               _loc6_ = 0.5;
               _loc7_ = 8421504;
            }
            else
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_853.getText();
         _loc2_.description = this.var_1293.getText();
         var _loc3_:ISelectorWindow = this._window.findChildByName("doormode") as ISelectorWindow;
         var _loc4_:IWindow = _loc3_.getSelected();
         switch(_loc4_.name)
         {
            case "doormode_doorbell":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_189;
               break;
         ...
         _loc2_.allowPets = this.var_1299.isSelected;
         _loc2_.allowFoodConsume = this.var_1295.isSelected;
         _loc2_.allowWalkThrough = this.var_1296.isSelected;
         _loc2_.hideWalls = this.var_686.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_1007,_loc2_.tags);
         this.addTag(this.var_1006,_loc2_.tags);
         this.clearErrors();
         this.var_1294 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_392);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_77.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_392]);
         _loc2_.show();
      }
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_178,HabboToolbarIconEnum.ROOMINFO));
      }
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_279.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(this.var_279.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(this.var_279.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = this.var_279.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = this.var_279.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = this.var_279.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(this.var_279.findChildByName("flat_controllers_footer"));
         Util.hideChildren(this.var_279);
         this.var_279.findChildByName("ruler").visible = true;
         ...
         if(this.var_77.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(this.var_279,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_66,HabboWindowStyle.const_30,HabboWindowParam.const_62,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_392));
      }
