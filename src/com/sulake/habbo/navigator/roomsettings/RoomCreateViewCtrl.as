package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1315:TextFieldManager;
      
      private var var_46:Array;
      
      private var var_1314:RoomLayout;
      
      private var var_692:Timer;
      
      private var var_2069:Boolean = true;
      
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         this._navigator = param1;
         this.var_692 = new Timer(100);
         this.var_692.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         ...
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_44,80,"g"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_44,74,"h"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_44,416,"o"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_44,352,"p"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_44,304,"q"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_44,336,"r"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_44,748,"u"));
         this.var_46.push(new RoomLayout(HabboClubLevelEnum.const_44,438,"v"));
      ...
      public function dispose() : void
      {
         if(this.var_692)
         {
            this.var_692.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_692.reset();
            this.var_692 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1314.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_2069 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_2069 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_193 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         this.var_60 = IItemListWindow(this.var_193.findChildByName("item_list"));
         ...
         var _loc3_:IWindow = this.var_193.findChildByTag("close");
         this.addMouseClickListener(_loc3_,this.onCancelButtonClick);
         this.var_1315 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_193.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc4_:Rectangle = Util.getLocationRelativeTo(this.var_193.desktop,this.var_193.width,this.var_193.height);
         this.var_193.x = _loc4_.x;
         this.var_193.y = _loc4_.y;
      }
      
      public function refresh() : void
      {
         this.var_1315.goBackToInitialState();
         this.var_1315.input.textBackgroundColor = 4294967295;
         this.var_1314 = this.var_46[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_66,HabboWindowStyle.const_30,HabboWindowParam.const_62,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1315.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      
      private function getCreateButton() : IButtonWindow
      {
         return IButtonWindow(this.var_193.findChildByName("create_button"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(this.var_193.findChildByName("back_button"));
      }
      ...
      {
         var _loc2_:String = this.var_1315.getText();
         var _loc3_:String = "model_" + this.var_1314.name;
