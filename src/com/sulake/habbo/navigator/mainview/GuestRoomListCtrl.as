package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_558:RoomPopupCtrl;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_558 = new RoomPopupCtrl(this._navigator,5,-5);
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_573 = IScrollbarWindow(this.var_193.findChildByName("scroller"));
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.var_573.scrollV = 0;
         }
         this.var_193.findChildByName("no_rooms_found").visible = _loc1_.length < 1;
      }
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1636,true);
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this._navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_189,null,0);
         this._navigator.refreshButton(param1,"doormode_password_small",param2.doorMode == RoomSettingsFlatInfo.const_121,null,0);
      ...
      private function onRow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_209)
         {
            this.checkFastHorizontalMove(param1);
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(this.var_558.visible && this.var_2834)
            {
               return;
            }
            ...
            this.var_558.room = _loc4_;
            this.var_558.showPopup(param2);
         }
      ...
      private function refreshFavouriteIcon(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this.method_5(param1,"make_favourite",!_loc3_ && !_loc4_,this.onAddFavouriteClick);
         this.method_5(param1,"favourite",_loc3_ && !_loc4_,this.onRemoveFavouriteClick);
      }
      ...
      private function method_5(param1:IWindowContainer, param2:String, param3:Boolean, param4:Function) : void
      {
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1575.tags[0];
            this.var_1575.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2835 - _loc2_.stageX);
         this.var_2835 = _loc2_.stageX;
         this.var_2834 = _loc3_ > 2;
      }
   }
}
