package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      private static const const_653:int = 2;
      
      private static const const_1038:int = 3;
      
      private static const const_1435:int = 4;
      ...
      private var var_1019:PopularTagsListCtrl;
      
      private var var_1018:GuestRoomListCtrl;
      
      private var var_1247:OfficialRoomListCtrl;
      ...
      private var var_1530:IWindow;
      
      private var var_1248:IRegionWindow;
      ...
      private const const_1040:Point = new Point(100,10);
      
      public function MainViewCtrl(param1:HabboNavigator)
      {
         super();
         this._navigator = param1;
         this.var_1019 = new PopularTagsListCtrl(this._navigator);
         this.var_1018 = new GuestRoomListCtrl(this._navigator);
         this.var_1247 = new OfficialRoomListCtrl(this._navigator);
      ...
      public function open() : void
      {
         ...
         {
            this.prepare();
            this.var_15.position = this.const_1040;
            _loc1_ = true;
         }
         this.refresh();
      ...
      private function prepare() : void
      {
         ...
         this.var_250 = ITabContextWindow(this.var_15.findChildByName("tab_context"));
         if(!this.var_250)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _tabContext is null!");
         }
         this.var_193 = IWindowContainer(this.var_15.findChildByName("tab_content"));
         ...
         this.var_1530 = this.var_15.findChildByName("loading_text");
         var _loc1_:IWindow = this.var_15.findChildByTag("close");
         _loc1_.procedure = this.onWindowClose;
         this.var_1248 = IRegionWindow(this.var_15.findChildByName("to_hotel_view"));
         if(!this.var_1248)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _toHotelView is null!");
         }
         this.var_1248.procedure = this.onHotelView;
         ...
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_725,false);
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_1674,true);
      }
      ...
      public function refresh() : void
      {
         ...
         Util.moveChildrenToColumn(this.var_193,["custom_content","list_content"],this.var_231.y,8);
         this.var_212.height = this.var_212.height + _loc1_ - this.var_212.y - this.var_270.height + this.var_2722;
         Util.moveChildrenToColumn(this.var_193,["list_content","custom_footer"],this.var_212.y,0);
         this.var_2722 = this.var_270.height;
      ...
      {
         this.refreshList(param1,param2,this.var_1018,"guest_rooms");
      }
      
      private function refreshPopularTags(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_1019,"popular_tags");
      }
      
      private function refreshOfficialRooms(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_1247,"official_rooms");
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_671 == const_1039)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_212.blend - _loc2_));
            this.var_212.blend = _loc3_;
            this.var_231.blend = !!this.var_1249 ? Number(_loc3_) : Number(1);
            this.var_270.blend = !!this.var_1249 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_671 = const_653;
            }
         }
         else if(this.var_671 == const_653)
         {
            if(this.var_1529 % 10 == 1)
            {
               this.var_1530.visible = !this.var_1530.visible;
            }
            ++this.var_1529;
            if(!this._navigator.data.isLoading())
            {
               this.var_671 = const_1038;
            }
         }
         else if(this.var_671 == const_1038)
         {
            this.refresh();
            this.var_671 = const_1435;
         }
         else
         {
            this.var_1530.visible = false;
            _loc3_ = Math.min(1,Math.max(0,this.var_212.blend + _loc2_));
            this.var_212.blend = _loc3_;
            this.var_231.blend = !!this.var_1249 ? Number(_loc3_) : Number(1);
            this.var_270.blend = !!this.var_1249 ? Number(_loc3_) : Number(1);
      ...
      {
         this.refreshScrollbar(this.var_1019);
         this.refreshScrollbar(this.var_1018);
      }
      ...
      {
         this._navigator.refreshButton(this.var_1248,"icon_hotelview",!param1,null,0);
         this._navigator.refreshButton(this.var_1248,"icon_hotelview_reactive",param1,null,0);
      }
