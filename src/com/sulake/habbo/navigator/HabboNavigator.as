package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_307:MainViewCtrl;
      
      private var var_442:RoomInfoViewCtrl;
      
      private var var_1209:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_456:Tabs;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_2969:Dictionary;
      
      private var var_1586:IncomingMessages;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_2574:Array;
      
      private var var_2575:RoomThumbnailRenderer;
      
      private var var_1057:GuestRoomPasswordInput;
      
      private var var_322:GuestRoomDoorbell;
      
      private var var_1208:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2574 = new Array();
         ...
         this.var_307 = new MainViewCtrl(this);
         this.var_442 = new RoomInfoViewCtrl(this);
         this.var_1209 = new RoomCreateViewCtrl(this);
         this.var_2575 = new RoomThumbnailRenderer(this);
         this.var_1057 = new GuestRoomPasswordInput(this);
         this.var_322 = new GuestRoomDoorbell(this);
         this.var_456 = new Tabs(this);
         this.var_1208 = new OfficialRoomEntryManager(this);
      }
      ...
      public function get method_11() : RoomCreateViewCtrl
      {
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_300,HabboWindowStyle.const_45,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_442.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_118,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_118,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         if(param1.type == HabboToolbarEvent.const_36)
         {
            ...
            {
               this.var_442.handleToolbarEvent(param1);
            }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_59,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_188.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      {
         var _loc1_:Boolean = this.var_307.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_307.startSearch(Tabs.const_254,Tabs.const_437,param1);
         this.var_307.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_307.startSearch(Tabs.const_331,Tabs.const_248);
         this.var_456.getTab(Tabs.const_331).tabPageDecorator.tabSelected();
      }
