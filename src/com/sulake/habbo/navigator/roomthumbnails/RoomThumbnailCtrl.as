package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_68:ThumbnailEditorModel;
      
      private var var_1844:IButtonWindow;
      
      private var var_1846:IButtonWindow;
      
      private var var_1845:IButtonWindow;
      ...
      public function RoomThumbnailCtrl(param1:HabboNavigator)
      {
         ...
         this.var_68 = new ThumbnailEditorModel();
      }
      ...
      public function set active(param1:Boolean) : void
      {
         ...
         if(this._active)
         {
            this.var_68.data = this._navigator.data.enteredGuestRoom.thumbnail.getCopy();
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1844 = IButtonWindow(this.find("bg_tab"));
         this.var_1846 = IButtonWindow(this.find("top_tab"));
         this.var_1845 = IButtonWindow(this.find("obj_tab"));
         ...
         Util.setProcDirectly(this.var_1844,this.onBgTabButton);
         Util.setProcDirectly(this.var_1846,this.onTopTabButton);
         Util.setProcDirectly(this.var_1845,this.onObjTabButton);
      }
      ...
      private function onSaveButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in this.var_68.data.objects)
         {
            if(_loc4_.imgId > 0)
            {
               _loc3_.push(_loc4_);
         ...
         _loc5_ = new UpdateRoomThumbnailMessageComposer(this._navigator.data.enteredGuestRoom.flatId,this.var_68.data.bgImgId,this.var_68.data.frontImgId,_loc3_.length);
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_68.mode = ThumbnailEditorModel.const_40;
         this.reload();
      }
      ...
      private function onTopTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_68.mode = ThumbnailEditorModel.const_63;
         this.reload();
      }
      ...
      private function onObjTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_68.mode = ThumbnailEditorModel.const_35;
         this.reload();
      }
      ...
      {
         this.setEnabled(this.var_1844,this.var_68.mode != ThumbnailEditorModel.const_40);
         this.setEnabled(this.var_1846,this.var_68.mode != ThumbnailEditorModel.const_63);
         this.setEnabled(this.var_1845,this.var_68.mode != ThumbnailEditorModel.const_35);
      }
      ...
      private function refreshEditArea() : void
      {
         ...
         this.refreshEditImg(_loc1_,"edit_bg",this.var_68.mode == ThumbnailEditorModel.const_40);
         this.refreshEditImg(_loc1_,"edit_top",this.var_68.mode == ThumbnailEditorModel.const_63);
         this.refreshEditImg(_loc1_,"edit_obj",this.var_68.mode == ThumbnailEditorModel.const_35,false);
         if(this.var_68.mode == ThumbnailEditorModel.const_35)
         {
      ...
      private function refreshPositionGrid() : void
      {
         ...
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_556)
            {
         ...
         if(this.var_68.selected == null)
         {
            _loc2_.visible = false;
            return;
         }
         _loc2_.visible = true;
         this.refreshTileLoc(_loc2_,this.var_68.selected.pos);
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Dictionary = this.var_68.getBlockedPositions();
         while(_loc3_ <= RoomThumbnailRenderer.const_556)
         {
      ...
      {
         this.refreshImgSelector(ThumbnailEditorModel.const_40);
      ...
      private function refreshImgSelector(param1:int) : void
      {
         ...
         var _loc5_:int = this.var_68.getImgId();
         var _loc6_:int = 0;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_66,HabboWindowStyle.const_30,HabboWindowParam.const_62,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_620,HabboWindowStyle.const_45,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
            _loc11_.mouseThreshold = 0;
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_300,HabboWindowStyle.const_45,HabboWindowParam.const_62,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));
      ...
      {
         this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this._window.findChildByName("picframe")),this.var_68.data,false);
      }
   }
}
