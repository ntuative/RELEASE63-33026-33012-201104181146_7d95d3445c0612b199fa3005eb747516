package com.sulake.habbo.quest
{
   ...
   public class PendingFurniImage implements IGetImageListener, IDisposable
   {
      ...
      private var var_2005:IBitmapWrapperWindow;
      ...
      {
         if(this.var_2821 == param1)
         {
            PendingImage.setElementImage(this.var_2005,param2,this.var_2005.height);
            this.dispose();
         }
      }
   }
