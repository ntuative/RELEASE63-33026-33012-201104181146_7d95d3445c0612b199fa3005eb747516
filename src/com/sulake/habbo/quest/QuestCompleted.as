package com.sulake.habbo.quest
{
   ...
   public class QuestCompleted implements IDisposable
   {
      ...
      public function show(param1:QuestMessageData) : void
      {
         ...
         this._window.findChildByName("catalog_link_txt").caption = this._questEngine.localization.getKey("quests.completed.cataloglink." + this.var_841.activityPointType);
         var _loc2_:String = "quests.completed.reward." + this.var_841.activityPointType;
         this._questEngine.localization.registerParameter(_loc2_,"amount",this.var_841.rewardCurrencyAmount.toString());
         this._window.findChildByName("reward_txt").caption = this._questEngine.localization.getKey(_loc2_,_loc2_);
         var _loc3_:* = this.var_841.getQuestLocalizationKey() + ".completed";
      ...
      public function onRewardInfo(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         var _loc3_:String = "catalog.page.quest." + this.var_841.campaignCode;
