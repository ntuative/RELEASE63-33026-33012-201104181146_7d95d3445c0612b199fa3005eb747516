package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_1022:int = 0;
      
      private static const const_446:int = 1;
      ...
      {
         return this.var_650 != const_1022;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1865 != RecyclerStatusMessageEvent.const_1233;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_650 == const_446;
      }
      ...
      {
         this.var_650 = const_1021;
         this.var_119 = new Array(const_206);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_206)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_650 = const_1022;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1496:
               this.var_650 = const_446;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1233:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1765:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1209:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1526:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_119.length > 0)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_206)
            {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_119.length < const_206)
         {
            return false;
         }
         var _loc1_:int = 0;
