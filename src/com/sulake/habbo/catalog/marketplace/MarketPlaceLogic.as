package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_2033:int = 1;
      
      public const const_1900:int = 2;
      
      public const const_2116:int = 3;
      ...
      private var var_230:MarketplaceConfirmationDialog;
      ...
      private var var_2376:MarketplaceItemStats;
      ...
      public function dispose() : void
      {
         ...
         {
            this.disposeOffers(this.var_303);
            this.var_303 = null;
         }
         this._disposed = true;
      }
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!this.var_230)
         {
            this.var_230 = new MarketplaceConfirmationDialog(this,this._catalog,this._roomEngine);
         }
         this.var_230.showConfirmation(param1,param2);
      }
      ...
      {
         this.requestOffers(this.var_2380,this.var_2381,this.var_2374,this.var_2373);
      }
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         this.showConfirmation(this.const_2033,_loc2_);
      }
      ...
      public function redeemSoldOffers() : void
      {
         ...
         var _loc1_:Array = this.var_303.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = this.var_303.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_585)
            {
               this.var_303.remove(_loc2_);
               _loc3_.dispose();
            }
         }
         if(this._catalog)
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2378 = _loc3_.creditsWaiting;
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            _loc5_.timeLeftMinutes = _loc4_.timeLeftMinutes;
            this.var_303.add(_loc4_.offerId,_loc5_);
         }
         if(this._visualization != null)
         {
            this._visualization.listUpdatedNotify();
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            this.showConfirmation(this.const_1900,updateItem);
            if(this._visualization != null)
            {
               this._visualization.listUpdatedNotify();
            }
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = this.var_303.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      {
         if(param1.furniCategoryId != this.var_2377 || param1.furniTypeId != this.var_2375)
         {
            return;
         }
      ...
      private function isPosterItem(param1:IMarketPlaceOfferData) : Boolean
      {
         ...
         if(param1.furniType == 2 && param1.stuffData != null)
         {
            ...
            {
               _loc4_ = _loc3_.name;
               if(_loc4_ != null && _loc4_ == const_1356)
               {
                  _loc2_ = true;
               }
            }
