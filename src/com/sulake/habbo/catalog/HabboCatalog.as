package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private static const const_650:uint = 1;
      ...
      private var var_1102:IRoomSession;
      ...
      private var var_187:CatalogViewer;
      ...
      private var var_2677:Boolean = true;
      
      private var var_2679:Boolean = true;
      
      private var var_1924:Boolean = false;
      
      private var var_2678:GiftWrappingConfiguration;
      
      private var var_1228:ClubGiftController;
      
      private var var_541:ClubBuyController;
      
      private var var_822:Map;
      
      private var var_1229:Boolean = false;
      
      private var var_1003:IPurchasableOffer;
      
      private var var_1512:IDragAndDropDoneReceiver;
      
      private var var_84:PlacedObjectPurchaseData;
      
      private const const_1040:Point = new Point(100,20);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_16 != null)
         {
            this.var_16.events.removeEventListener(RoomSessionEvent.const_86,this.onRoomSessionEvent);
            this.var_16.events.removeEventListener(RoomSessionEvent.const_90,this.onRoomSessionEvent);
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         {
            this.var_541.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_166,this.onObjectPlaced);
      }
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_188.getKey("client.credits.embed.enabled","com.sulake.habbo.inventory.marketplace") == "InfoStandSongDiskView";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_188.getKey("link.format.credits","/credits");
      ...
      {
         return this.var_434.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_434.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_64)
         {
            _loc3_ = this.var_434.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_822.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_108.getActivityPointsForType(Purse.const_192)));
         var _loc1_:int = 0;
      ...
      {
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_118,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_749)
         {
            if(!this.var_434.loadProductData(this))
            {
               return;
            }
            this.init();
         ...
         if(this.mainWindowVisible())
         {
            ...
            if(this.var_94 != null && this.getCurrentLayoutCode() == "recycler")
            {
               this.var_94.activate();
            }
         }
         else
         {
         ...
         this.setupInventoryForRecycler(this.var_94.active && this.mainWindowVisible());
      }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_187.getCurrentLayoutCode();
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_187 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_187.habboCatalog = this;
      }
      
      private function createMainWindow() : void
      {
         var _loc1_:XmlAsset = assets.getAssetByName("catalog") as XmlAsset;
         this._mainContainer = this._windowManager.buildFromXML(_loc1_.content as XML,const_650) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_1040;
         this.hideMainWindow();
         ...
         _loc3_.setParamFlag(WindowParam.const_281,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_86:
               this.var_1924 = param1.session.isPrivateRoom;
               this.var_1102 = param1.session;
               if(this.var_94 != null)
               {
                  this.var_94.setRoomSessionActive(true);
               }
               break;
            case RoomSessionEvent.const_90:
               ...
               if(this.var_94 != null)
               {
                  this.var_94.setRoomSessionActive(false);
               }
         }
      }
      ...
      {
         this.var_94 = new RecyclerLogic(this,this._windowManager);
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1228 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_541 == null)
         {
            this.var_541 = new ClubBuyController(this);
         }
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_187 != null)
         {
            this.var_187.catalogWindowClosed();
         }
         if(this.var_94 != null && this.getCurrentLayoutCode() == "recycler")
         {
            this.var_94.cancel();
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         if(this.var_823 && this.var_823 != "")
         {
            this.var_374.openPage(this.var_823);
            this.var_823 = "";
            this.var_1002 = -1;
         }
         else if(this.var_1002 > -1)
         {
            this.var_374.openPageById(this.var_1002,this.var_1925);
            this.var_1002 = -1;
            this.var_1925 = -1;
            this.var_823 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_187.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_187 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_187.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2677 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1131);
         }
         this.var_2677 = false;
         if(this.var_313 != null)
         {
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_73,this.var_108.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2679 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1249);
         }
         this.var_2679 = false;
         if(this.var_313 != null)
         {
         ...
         if(_loc2_.type == Purse.const_192)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1228.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRecyclerStatus(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_94 == null)
         {
            return;
         }
         this.var_94.setSystemStatus(_loc2_.recyclerStatus,_loc2_.recyclerTimeoutSeconds);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         this.var_94.setFinished(_loc2_.recyclerFinishedStatus,_loc2_.prizeId);
      }
      ...
      private function onRecyclerPrizes(param1:IMessageEvent) : void
      {
         ...
         this.var_94.storePrizeTable(_loc2_.prizeLevels);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_187.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2678 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_822.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_822.add(_loc2_.productCode,_loc3_.slice());
            this.var_187.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "InfoStandSongDiskView" == this.var_188.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_188.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         if(param2.type == WindowEvent.const_174)
         {
            _loc3_ = this.var_188.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(!this.var_188.keyExists("catalog.drag_and_drop") || this.var_188.getKey("catalog.drag_and_drop") != "InfoStandSongDiskView")
         {
            return false;
         }
         if(!this.var_1102 || !this.var_1102.isRoomOwner)
         {
            return false;
         }
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         if(this.var_1229 && param1.type == RoomEngineObjectEvent.const_166)
         {
            this.resetPlacedOfferData();
            if(this.var_1003 == null || !param1.placedInRoom)
            {
               this.resetObjectMover();
               return;
            }
            this.var_84 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_1003);
            _loc2_ = this.var_1512;
            this.resetObjectMover();
            if(_loc2_ != null)
            {
            ...
            _loc4_ = this.var_1003.productContainer.firstProduct;
            if(_loc3_ == RoomObjectCategoryEnum.const_27)
            {
            ...
            if(_loc5_)
            {
               _loc5_.getModelController().setNumber(RoomObjectVariableEnum.const_353,0.5);
            }
         }
      }
      ...
      public function resetPlacedOfferData() : void
      {
         if(this.var_84 != null)
         {
            if(this.var_84.category == RoomObjectCategoryEnum.const_27)
            {
               this._roomEngine.disposeObjectFurniture(this.var_84.roomId,this.var_84.roomCategory,this.var_84.objectId);
            }
            else if(this.var_84.category == RoomObjectCategoryEnum.const_26)
            {
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         if(this.var_84 && this.var_84.productClassId == param1.classId)
         {
            if(this.var_84.roomCategory == this._roomEngine.activeRoomCategory && this.var_84.roomId == this._roomEngine.activeRoomId)
            {
               ...
               if(param1.category == FurniCategory.const_349 || param1.category == FurniCategory.const_350 || param1.category == FurniCategory.const_294)
               {
      ...
      private function retrievePreviewAsset(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:String = this.var_188.getKey("image.library.catalogue.url");
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_650);
            if(_loc1_ != null)
            {
