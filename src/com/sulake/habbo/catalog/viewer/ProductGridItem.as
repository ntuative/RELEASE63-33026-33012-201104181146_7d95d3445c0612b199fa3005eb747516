package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1026:String = "bg";
      ...
      {
         this._view.getChildByName(const_1026).style = HabboWindowStyle.const_30;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1026).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         if(this._view)
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_95,MouseCursorType.const_1146);
         }
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_25 && this.var_583 != null && this.var_583 == param2)
         {
            _loc3_ = this.var_264.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_583 = null;
            }
         ...
         else if(param1.type == WindowMouseEvent.const_161)
         {
            this.var_583 = null;
         }
      }
