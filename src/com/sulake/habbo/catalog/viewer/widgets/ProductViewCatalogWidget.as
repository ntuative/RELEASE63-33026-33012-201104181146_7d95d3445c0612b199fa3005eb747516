package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1531:IScrollbarWindow;
      
      protected var var_1713:XML;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1020 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1250 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_85 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1969 = new Point(this.var_85.x,this.var_85.y);
         this.var_547 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1531 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(this.var_547 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         this.var_1713 = _loc1_.content as XML;
         var _loc2_:BitmapDataAsset = page.viewer.catalog.assets.getAssetByName("ctlg_dyndeal_background") as BitmapDataAsset;
         this.var_1968 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_547 != null)
         {
            ...
            this.var_547.destroyGridItems();
         }
         if(this.var_1531 != null)
         {
            this.var_1531.visible = false;
         }
         ...
         this.var_1020.text = _loc4_;
         this.var_1250.text = _loc5_;
         this.var_1020.height = this.var_1020.textHeight + 5;
         this.var_1250.y = this.var_1020.y + this.var_1020.height;
         this.var_1250.height = Math.max(130,this.var_1250.textHeight + 5);
         ...
         else
         {
            ...
            {
               case Offer.const_606:
                  _loc6_ = this.var_1968.clone();
                  if(this.var_547 != null)
                  {
                     this.var_547.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_547,this.var_1531,this.var_1713);
                     this.var_547.scrollV = 0;
                  }
                  break;
               ...
               case Offer.const_426:
                  ...
                  switch(_loc8_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_212:
                        ...
                        _loc6_ = new BitmapData(this.var_85.width,this.var_85.height,false,_loc13_);
                        _loc14_ = null;
                        _loc15_ = page.viewer.catalog as HabboCatalog;
                        if(_loc15_.avatarRenderManager != null)
                        {
                           _loc17_ = _loc15_.sessionDataManager.figure;
                           _loc16_ = _loc15_.avatarRenderManager.createAvatarImage(_loc17_,AvatarScaleType.const_53);
                           if(_loc16_ != null)
                           {
                              _loc16_.setDirection(AvatarSetType.const_51,3);
                              _loc16_.initActionAppends();
                              _loc16_.appendAction(AvatarAction.const_338,AvatarAction.const_609);
                              _loc16_.appendAction(AvatarAction.const_288,_loc8_.productClassId);
                              _loc16_.endActionAppends();
                              _loc16_.updateAnimationByFrames(1);
                              _loc16_.updateAnimationByFrames(1);
                              _loc14_ = _loc16_.getImage(AvatarSetType.const_37,true);
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(this.var_85);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2723)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2723 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_85 != null && true)
         {
            ...
            if(this.var_85.bitmap == null)
            {
               this.var_85.bitmap = new BitmapData(this.var_85.width,this.var_85.height,true,16777215);
            }
            this.var_85.bitmap.fillRect(this.var_85.bitmap.rect,16777215);
            _loc4_ = new Point((this.var_85.width - param1.width) / 2,(this.var_85.height - param1.height) / 2);
            this.var_85.bitmap.copyPixels(param1,param1.rect,_loc4_,null,null,true);
            this.var_85.invalidate();
            this.var_85.x = this.var_1969.x;
            this.var_85.y = this.var_1969.y;
            if(param3 != null)
            {
               this.var_85.x += param3.x;
               this.var_85.y += param3.y;
            }
         }
         if(param2)
         {
