package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:Offer = this.var_199[this.var_487][this.var_725];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_487 = var_566.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_487];
         var _loc3_:Array = this.var_199[this.var_487] as Array;
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_725 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_725] as Offer;
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_368 || _loc1_.pricingModel == Offer.const_426)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_64 || _loc3_.productType == ProductTypeEnum.const_80)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        (this.var_199[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
