package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IPetDataListener, IPetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_555 = this.getPetTypeIndexFromProduct(_loc3_.localizationId);
         if(this.var_555 >= 8)
         {
            return false;
         }
         this.updateAvailableBreeds(_loc3_.localizationId);
         this.var_2208 = _loc3_.localizationId;
         this.var_338 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc5_ = _loc4_.avatarRenderManager.petDataManager.getPetData(this.var_555,this);
               if(_loc5_)
               {
                  this.var_338 = _loc5_.colors;
         ...
         this._offers.add(this.var_555,_loc3_);
      ...
      public function onDropMenuEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowEvent.const_57)
         {
            ...
            if(this.var_198 == null || _loc3_ >= this.var_198.length)
            {
               return;
            }
            this.var_718 = _loc3_;
      ...
      private function updateBreedSelections() : void
      {
         ...
         {
            _loc5_ = this.var_198[_loc3_] as int;
            _loc2_.push(_loc1_.getKey(this.getRaceLocalizationKey(this.var_555,_loc5_),this.getRaceLocalizationKey(this.var_555,_loc5_)));
            _loc3_++;
         }
      ...
      private function updateImage() : void
      {
         ...
         if(this.var_198 == null || this.var_718 >= this.var_198.length)
         {
            return;
         }
         var _loc2_:* = 0;
         ...
         var _loc3_:int = this.var_198[this.var_718] as int;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImage(this.var_555,_loc3_,_loc2_,AvatarScaleType.const_53,this);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_338,AvatarAction.const_821);
         _loc4_.endActionAppends();
         _loc4_.setDirection(AvatarSetType.const_37,2);
         this.setPreviewImage(_loc4_.getCroppedImage(AvatarSetType.const_37),true);
         _loc4_.dispose();
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var breed:int = this.var_198[this.var_718] as int;
