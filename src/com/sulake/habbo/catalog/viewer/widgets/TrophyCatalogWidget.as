package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1469:int = 16763904;
      
      private static const const_1470:int = 13421772;
      
      private static const const_1468:int = 13395456;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_85 = window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         ...
         for each(_loc3_ in page.offers)
         {
            ...
            if(this.var_282.getValue(_loc5_) == null)
            {
               this.var_282.add(_loc5_,new Map());
            }
            _loc7_ = this.var_282.getValue(_loc5_) as Map;
            _loc7_.add(_loc6_,_loc3_);
         }
         _loc4_ = this.var_282.getWithIndex(this.var_326);
         if(_loc4_ != null)
         {
            _loc3_ = _loc4_.getValue(this.var_858);
            if(_loc3_ == null)
            {
      ...
      private function onWidgetsInitialized(param1:CatalogWidgetsInitializedEvent) : void
      {
         ...
         _loc2_.push(const_1469);
         _loc2_.push(const_1470);
         _loc2_.push(const_1468);
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc2_:Map = this.var_282.getWithIndex(this.var_326);
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getValue(this.var_858);
            if(_loc3_ == null)
            {
      ...
      private function onClickNext(param1:WindowMouseEvent) : void
      {
         var _loc3_:* = null;
         ++this.var_326;
         if(this.var_326 >= this.var_282.length)
         {
            this.var_326 = 0;
         }
         var _loc2_:Map = this.var_282.getWithIndex(this.var_326);
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_326 < 0)
         {
            this.var_326 = this.var_282.length - 1;
         }
         var _loc2_:Map = this.var_282.getWithIndex(this.var_326);
         if(_loc2_ != null)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean) : void
      {
         ...
         if(this.var_85 != null)
         {
            ...
            _loc3_ = new Point((this.var_85.width - param1.width) / 2,(this.var_85.height - param1.height) / 2);
            this.var_85.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
