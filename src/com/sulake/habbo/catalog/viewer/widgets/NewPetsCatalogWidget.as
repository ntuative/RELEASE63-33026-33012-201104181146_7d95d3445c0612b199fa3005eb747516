package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1454:int = 18;
      ...
      private var var_198:Array = null;
      ...
      override public function init() : Boolean
      {
         ...
         _loc1_.addEventListener(WindowEvent.const_103,this.onTextWindowEvent);
         ...
         this.var_555 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_555 < 8)
         {
            return false;
         }
         this.var_2208 = _loc2_.localizationId;
         this.updateAvailableBreeds(_loc2_.localizationId);
         if(this.var_198 != null && this.var_198.length > 0)
         {
            this.var_386 = this.var_198[0];
         }
         else
         {
            this.var_386 = -1;
         }
         this._offers.add(this.var_555,_loc2_);
         events.addEventListener(WidgetEvent.CWE_SELECT_PRODUCT,this.onSelectProduct);
         events.addEventListener(WidgetEvent.CWE_COLOUR_INDEX,this.onColourIndex);
         events.addEventListener(WidgetEvent.const_828,this.onApproveNameResult);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_198 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1454 && _loc2_ < this.var_198.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_555,this.var_198[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_198 != null && this.var_198.length > 0)
         {
            ...
            this.var_386 = this.var_198[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_555,this.var_386),this.getRaceLocalizationKey(this.var_555,this.var_386));
            }
         }
         return this.getRaceLocalizationKey(this.var_555,this.var_386);
      }
      ...
      {
         if(param1.productCode == this.var_2208)
         {
            this.var_198 = this.parseSellableBreeds(param1.sellableBreeds);
            this.initializeBreedSelection();
      ...
      private function parseSellableBreeds(param1:Array) : Array
      {
         ...
         {
            if(_loc3_.type == this.var_555 && _loc3_.sellable)
            {
      ...
      private function updateImage() : void
      {
         ...
         if(_loc1_ == null || this.var_386 < 0)
         {
            return;
         }
         var _loc2_:int = this.var_555;
         var _loc3_:int = this.var_386;
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var p:String = this._name + String.fromCharCode(10) + this.var_386 + String.fromCharCode(10) + this.addZeroPadding(color.toString(16).toUpperCase(),6);
         return p;
      }
      ...
      private function updateAvailableBreeds(param1:String) : void
      {
         ...
         if(this.var_198 == null)
         {
            ...
            this.var_198 = this.parseSellableBreeds(_loc2_);
         }
      }
