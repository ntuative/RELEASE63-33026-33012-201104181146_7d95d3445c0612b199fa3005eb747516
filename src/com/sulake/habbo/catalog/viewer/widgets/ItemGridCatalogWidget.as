package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      protected var var_394:IGridItem;
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_830,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_257,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_903,this.deActivateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_203,this.deActivateScrollbar);
         }
      }
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         while(_loc2_ < 3)
         {
            if(this.var_724 >= 0 && this.var_724 < page.offers.length)
            {
               _loc3_ = page.offers[this.var_724];
               this.loadGraphics(_loc3_);
               _loc3_.productContainer.grid = this;
            }
            ++this.var_724;
            if(this.var_724 >= page.offers.length)
            {
               this.resetTimer();
               break;
            }
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         if(param1.pricingModel == Offer.const_606)
         {
            ++this.var_1661;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1661);
         }
      }
