package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RoomPreviewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IDragAndDropDoneReceiver
   {
      ...
      private var var_336:BitmapData = null;
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_25 && this.var_583 != null && this.var_583 == param2)
         {
            if(this.var_90)
            {
               (page.viewer.catalog as HabboCatalog).requestSelectedItemToMover(this,this.var_90);
               this.var_583 = null;
            }
         }
      ...
      private function onUpdateRoomPreview(param1:CatalogWidgetUpdateRoomPreviewEvent) : void
      {
         ...
         {
            this.var_1635 = _loc3_.id;
            this.var_1634 = _loc4_.id;
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(this.var_336 != null && this._imageStoreWindow != null)
         {
            this.setRoomImage(this.var_336,this._imageStoreWindow);
         }
      }
   }
}
