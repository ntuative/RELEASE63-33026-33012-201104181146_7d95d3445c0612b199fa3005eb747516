package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1782:String = "ctlg_";
       
      
      protected var var_1328:XML;
      ...
      private var var_548:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1251:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_548 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1252);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1252);
      }
      ...
      {
         var _loc2_:String = const_1782 + param1;
         ...
         this.var_1328 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_1328) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1668:
               if(this.var_1251 == null)
               {
                  this.var_1251 = new ItemGridCatalogWidget(param1);
                  this.var_37.push(this.var_1251);
               }
               break;
            case CatalogWidgetEnum.const_1489:
               this.var_37.push(new ItemGroupCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1525:
               this.var_37.push(new ProductViewCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1511:
               this.var_37.push(new SongDiskProductViewCatalogWidget(param1,this._catalog.soundManager));
               break;
            case CatalogWidgetEnum.const_1708:
               this.var_37.push(new SingleViewCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1649:
               this.var_37.push(new PurchaseCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1676:
               this.var_37.push(new PurseCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1755:
               this.var_37.push(new ColourGridCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1679:
               this.var_37.push(new TraxPreviewCatalogWidget(param1,this._catalog.soundManager));
               break;
            case CatalogWidgetEnum.const_1736:
               this.var_37.push(new RedeemItemCodeCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1624:
               this.var_37.push(new SpacesCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1529:
               this.var_37.push(new SpacesNewCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1667:
               this.var_37.push(new RoomPreviewCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1514:
               this.var_37.push(new TrophyCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1753:
               this.var_37.push(new PetsCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1739:
               this.var_37.push(new NewPetsCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1720:
               this.var_37.push(new TextInputCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1490:
               this.var_37.push(new SpecialInfoWidget(param1));
               break;
            case CatalogWidgetEnum.const_1675:
               this.var_37.push(new RecyclerCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1617:
               this.var_37.push(new RecyclerPrizesCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1650:
               this.var_37.push(new BotCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1671:
               this.var_37.push(new MarketPlaceCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1651:
               this.var_37.push(new MarketPlaceOwnItemsCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1654:
               this.var_37.push(new ClubGiftWidget(param1,this._catalog.getClubGiftController()));
               break;
            case CatalogWidgetEnum.const_1479:
               this.var_37.push(new ClubBuyCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1660:
               this.var_37.push(new ActivityPointDisplayCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1666:
               this.var_37.push(new MadMoneyCatalogWidget(param1));
         }
      }
      ...
      private function removeWidgets(param1:Array) : void
      {
         ...
         for each(_loc3_ in param1)
         {
            ...
            _loc4_ = this.var_37.indexOf(_loc3_);
            if(_loc4_ >= 0)
            {
               this.var_37.splice(_loc4_,1);
            }
            _loc3_.dispose();
         }
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_548 != null)
         {
            return this.var_548.dispatchEvent(param1);
         }
         return false;
      }
