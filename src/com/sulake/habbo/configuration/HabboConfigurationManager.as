package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      public function HabboConfigurationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_604 = this.getKey("url_prefix");
         if(this.var_604 != null && this.var_604.length > 0)
         {
            this.setKey("client.fatal.error.url",this.var_604 + "/flash_client_error");
         }
         this.init();
      }
      ...
      private function init() : void
      {
         ...
         if(!this.var_749)
         {
            ...
            _loc3_.addEventListener(AssetLoaderEvent.const_48,this.onConfigurationError);
         }
      }
      ...
      private function onConfigurationError(param1:Event = null) : void
      {
         ...
         Core.error("Could not load external variables. URL " + this.getKey("external.variables.txt") + "HTTP status " + _loc3_ + ". Client startup failed!",true,Core.const_1578);
      }
      ...
      private function onInitConfiguration(param1:Event = null) : void
      {
         ...
         if(_loc4_ && _loc4_ != "")
         {
            ...
            _loc6_.addEventListener(AssetLoaderEvent.const_48,this.onConfigurationOverrideError);
         }
         else if(!this.var_749)
         {
            this.var_749 = true;
            if(locked)
            {
      ...
      private function parseConfiguration(param1:String) : void
      {
         ...
         for each(line in rows)
         {
            if(line.substr(0,1) != "#")
            {
               ...
               if(pair[0].length > 0 && pair[1].length > 0)
               {
                  ...
                  if(key == "configuration.readonly" && value == "InfoStandSongDiskView")
                  {
                     readOnly = true;
                  }
         ...
         if(this.getKey("local.environment") == "InfoStandSongDiskView")
         {
            this.setKey("url.prefix",this.getKey("url.prefix.local"));
         }
         this.var_604 = this.getKey("url.prefix");
         if(this.var_604.length > 0)
         {
            externalAccessDomain = this.var_604.replace("http://","");
      ...
      {
         var _loc2_:String = this.var_1128[param1] as String;
         return _loc2_ != null;
      }
      
      public function getKey(param1:String, param2:String = "", param3:Dictionary = null) : String
      {
         var _loc4_:String = this.var_1128[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",this.var_604);
      ...
      public function setKey(param1:String, param2:String, param3:Boolean = false, param4:Boolean = false) : void
      {
         if(param4)
         {
            if(this.var_1128[param1] == null)
            {
               Logger.log(param1 + "=" + param2);
            }
         }
         if(this.var_1709.indexOf(param1) < 0 || param3)
         {
            this.var_1128[param1] = param2;
         }
         if(param3)
         {
            this.var_1709.push(param1);
         }
      }
