package com.sulake.habbo.toolbar
{
   ...
   public class LogoutController
   {
      ...
      private const const_542:int = 44;
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_586;
         _loc3_.y = this.const_542;
         return _loc3_;
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_582)
         {
            this.var_582 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
