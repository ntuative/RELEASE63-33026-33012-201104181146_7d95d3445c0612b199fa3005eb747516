package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView implements IToolbarView
   {
      ...
      private var var_325:ToolbarBarMenuAnimator;
      ...
      private var var_556:String = "LEFT";
      
      private var var_169:Number = 50;
      
      private var var_1279:Boolean = true;
      
      private var var_1280:Number = 1;
      
      private var _toolbarMarginBottom:Number = 0;
      
      private var _toolbarMinGroupMargin:Number = 15;
      
      private var var_2024:Number = 5;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IEventDispatcher, param6:IHabboConfigurationManager)
      {
         ...
         this.var_169 = this._window.width;
         this.var_234 = param2.createWindow("extrabar_container_window","",HabboWindowType.const_66,HabboWindowStyle.const_1085,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         this._window.tags.push("habbo_extrabar");
         if(param6.getKey("friendbar.enabled") == "InfoStandSongDiskView")
         {
         ...
         this.var_1279 = String(_loc9_.relocate_by_drag.@state) == "InfoStandSongDiskView";
         if(this.var_1279)
         {
         ...
         this.var_1280 = _loc9_.toolbar.@margin_top;
         this._toolbarMarginBottom = _loc9_.toolbar.@margin_bottom;
         this._toolbarMinGroupMargin = _loc9_.toolbar.@min_group_margin;
         this.var_2024 = _loc9_.toolbar.@margin_to_extrabar;
         this.var_325 = new ToolbarBarMenuAnimator(param2,this);
         var _loc10_:XMLList = XMLList(_loc9_.toolbar).children();
         var _loc11_:XMLList = XMLList(_loc9_.extras).children();
         this.createGroupsFromXmlList(_loc10_,this.var_276,param2,param3,param4,this._window,this.var_325);
         this.createGroupsFromXmlList(_loc11_,this.var_679,param2,param3,param4,this.var_234,this.var_325);
         this.alignWindows();
      }
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IConnection, param6:IWindowContainer, param7:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc11_ < param1.length())
         {
            ...
            _loc10_ = new ToolbarIconGroup(param3,param4,param5,_loc11_,this._events,param6,param7,this.var_169,this._config);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_276.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         while(this.var_679.length > 0)
         {
            _loc1_ = this.var_679.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         if(this._window != null)
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_169,this.var_556,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_556);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_169,this.var_556);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_169,this.var_556);
         }
      }
      ...
      {
         this.alignWindows();
         var _loc2_:HabboToolbarEvent = new HabboToolbarEvent(HabboToolbarEvent.const_717);
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         var _loc3_:int = 0;
         _loc3_ = 0;
         while(_loc3_ < this.var_276.length)
         {
            _loc2_ = this.var_276[_loc3_];
         ...
         _loc3_ = 0;
         while(_loc3_ < this.var_679.length)
         {
            _loc2_ = this.var_679[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      private function alignWindows() : void
      {
         ...
         if(this._window == null || this.var_234 == null)
         {
            return;
         }
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_234.x = this.var_169 + this.var_2024;
               this.var_234.y = 0;
               _loc4_ = this._window.height;
               break;
            case "RIGHT":
               this._window.width = this.var_169;
               this._window.height = _loc1_.height;
               this._window.x = _loc1_.width - this.var_169;
               this._window.y = 0;
               this.var_234.x = 0;
               this.var_234.y = 0;
               _loc4_ = this._window.height;
            ...
            case "TOP":
               ...
               this._window.height = this.var_169;
               this._window.x = 0;
               this._window.y = 0;
               this.var_234.x = 0;
               this.var_234.y = this.var_169 + this.var_2024;
            ...
            case "BOTTOM":
               ...
               this._window.height = this.var_169;
               this._window.x = 0;
               this._window.y = _loc1_.height - this.var_169;
               this.var_234.x = 0;
               this.var_234.y = 0;
               _loc4_ = this._window.width;
         }
         _loc4_ -= this._toolbarMarginBottom;
         _loc4_ -= this.var_1280;
         var _loc5_:* = 0;
         _loc2_ = 0;
         while(_loc2_ < this.var_276.length)
         {
            _loc3_ = this.var_276[_loc2_];
            _loc5_ += _loc3_.iconCount * _loc3_.defaultIconSize;
            _loc2_++;
         }
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1280;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_276.length > 1)
            {
               if(this.orientation == "LEFT" || this.orientation == "RIGHT")
               {
                  _loc6_ = Number(Math.max(this._toolbarMinGroupMargin,(this._window.height - _loc5_ * _loc8_ - this.var_1280 - this._toolbarMarginBottom) / (this.var_276.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this._toolbarMinGroupMargin,(this._window.width - _loc5_ * _loc8_ - this.var_1280 - this._toolbarMarginBottom) / (this.var_276.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_276.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_556;
         ...
         _loc2_ = 0;
         while(_loc2_ < this.var_679.length)
         {
            _loc3_ = this.var_679[_loc2_];
            if(_loc3_ != null)
            {
      ...
      private function onStageMouseMove(param1:MouseEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_1279 && this.var_1561)
         {
            _loc2_ = this.getTargetOrientationFromXY(param1.stageX,param1.stageY);
            if(_loc2_ != null && _loc2_ != this.var_556)
            {
               this.var_556 = _loc2_;
               this.alignWindows();
               if(this._events != null)
               {
                  _loc3_ = new HabboToolbarEvent(HabboToolbarEvent.const_469);
                  _loc3_.orientation = this.var_556;
      ...
      private function getTargetOrientationFromXY(param1:Number, param2:Number) : String
      {
         ...
         if(param1 <= this.var_169)
         {
            return "LEFT";
         }
         if(param1 >= _loc3_.width - this.var_169)
         {
            return "RIGHT";
         }
         ...
         if(param2 >= _loc3_.height - this.var_169)
         {
            return "BOTTOM";
         }
         return null;
