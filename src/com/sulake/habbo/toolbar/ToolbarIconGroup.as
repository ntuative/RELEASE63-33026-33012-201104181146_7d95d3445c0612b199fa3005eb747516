package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_2544:Number;
      
      private var var_1478:Number;
      
      private var var_2545:int = 5;
      
      private var var_2543:int;
      
      private var var_169:Number;
      
      private var var_2546:XML;
      ...
      {
         return this.var_1479.indexOf(param1) > -1;
      }
            ...
            if(_loc2_ != null)
            {
               if(!this.containsIcon(_loc2_))
               {
                  ...
                  if(_loc5_.length() > 0)
                  {
                     ...
                     {
                        _loc3_ = "null";
                        this.var_1479.push(_loc3_);
                        _loc6_.dockMenu(_loc3_,this.getMenuYieldList(_loc3_),_loc5_[_loc9_].@locktoicon == "InfoStandSongDiskView");
                        _loc9_++;
                     }
                  }
                  else
                  {
                     this.var_1479.push(_loc2_);
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = this.var_2546.elements("menu");
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = this.var_789.indexOf(param1);
         if(_loc2_ > -1)
         {
            _loc3_ = this.getIconById(param1);
            if(_loc3_ != null)
      ...
      {
         return this.var_789.indexOf(param1) > -1;
      }
      ...
      public function get size() : Number
      {
         ...
         {
            if(this.var_306[_loc2_].exists)
            {
               _loc1_ += this.var_1478;
            }
            _loc2_++;
         }
         return _loc1_;
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_1477.length)
         {
            _loc2_ = this.var_789.indexOf(this.var_1477[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_306[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(this.var_1224 + _loc3_);
                  _loc3_ += this.var_1478;
               }
            }
            _loc4_++;
         }
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_306[this.var_789.indexOf(param1)];
      }
