package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         this.var_1429 = param1.loop;
         if(param1.background != null)
         {
            this.var_771 = this.getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         if(_loc9_.length() > 0)
         {
            ...
            while(_loc10_ < _loc9_.length())
            {
               ...
               if(_loc8_ != null)
               {
                  this.var_941.push(_loc11_);
                  this.var_940.push(_loc8_);
               }
               _loc10_++;
            }
         }
         else
         {
            ...
            if(_loc8_ != null)
            {
               this.var_941.push(new XML());
               this.var_940.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            this.var_940[this._frame] = param6.clone();
         }
      ...
      {
         if(this.var_1429 == true || this.var_942 == 0)
         {
            if(this.var_941.length > 0)
            {
               ++this._frame;
               if(this._frame >= this.var_941.length)
               {
                  this._frame = 0;
                  ++this.var_942;
               }
      ...
      {
         return this.var_941.length;
      }
      
      public function hasNextState() : Boolean
      {
         return this.var_1429 == false && this.var_942 == 1 && this.var_1615 != this._state;
      }
      ...
      {
         var _loc2_:* = null;
         if(this._frame <= this.var_940.length)
         {
            _loc2_ = this.var_940[this._frame];
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         {
            _loc3_ = new BitmapData(Math.max(param2.width,this.var_771.width),Math.max(param2.height,this.var_771.height),true,0);
            _loc4_ = _loc3_.height - this.var_771.rect.height;
            _loc3_.copyPixels(this.var_771,this.var_771.rect,new Point(0,_loc4_),null,null,true);
