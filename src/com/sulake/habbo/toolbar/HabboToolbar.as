package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1597:LogoutController;
      ...
      private function onConfigurationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1312 = this._config.getKey("client.toolbar.static.enabled","com.sulake.habbo.inventory.marketplace") == "InfoStandSongDiskView";
         this.tryInitialize();
      }
      
      private function tryInitialize() : void
      {
         if(this.var_323 && this._windowManager && this._config)
         {
            this.var_323.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
         }
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         if(this.var_1312)
         {
            this._view = new ToolbarViewStatic(this,this._windowManager,this._assetLibrary,this.var_323.getHabboMainConnection(null),events,this._config);
         }
         else
         {
            this._view = new ToolbarView(this,this._windowManager,this._assetLibrary,this.var_323.getHabboMainConnection(null),events,this._config);
         }
         if(this._config && this._config.getKey("client.logout.enabled","com.sulake.habbo.inventory.marketplace") == "InfoStandSongDiskView")
         {
            this.var_1597 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this._view == null)
         {
            return;
         }
         events.addEventListener(HabboToolbarSetIconEvent.const_118,this.onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_1057,this.onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_178,this.onRemoveToolbarIconEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_523,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1238,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1143,this.onHideWindowEvent);
         this._state = true;
      ...
      {
         var _loc2_:String = this.getIconId(param1);
      ...
      private function getIconId(param1:String) : String
      {
         var _loc2_:String = "";
         switch(param1)
         {
      ...
      private function onAnimateWindowEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         ...
         else if(param1.type == HabboToolbarShowMenuEvent.const_59)
         {
