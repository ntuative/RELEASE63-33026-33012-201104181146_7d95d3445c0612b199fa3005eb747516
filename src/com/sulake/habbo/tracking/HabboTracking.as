package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1034:uint = 11;
      ...
      private var var_316:IAdManager;
      ...
      private var var_210:IHabboFriendList;
      
      private var var_1237:IHabboWindowManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_143:IHabboHelp;
      ...
      private var var_448:FramerateTracker = null;
      
      private var var_267:LatencyTracker = null;
      
      private var var_665:LagWarningLogger = null;
      
      private var var_664:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_448 = new FramerateTracker();
         this.var_267 = new LatencyTracker();
         this.var_665 = new LagWarningLogger();
         this.var_664 = new ToolbarClickTracker(this);
         this.var_1521 = new Array(const_1034);
         var _loc4_:int = 0;
         while(_loc4_ < const_1034)
         {
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1655,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1640,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1629,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_865,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1210,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1237)
            {
               this.var_1237.release(new IIDHabboWindowManager());
               this.var_1237 = null;
            }
            if(this.var_316)
            {
            ...
            if(this.var_210)
            {
               ...
               {
                  Component(this.var_210).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_210).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_210).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_210).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_210).events.removeEventListener(HabboFriendListTrackingEvent.const_405,this.onFriendlistTrackingEvent);
               }
               this.var_210.release(new IIDHabboFriendList());
               this.var_210 = null;
            }
            if(this.var_143)
            {
               if(!this.var_143.disposed)
               {
                  this.var_143.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_143.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_143.release(new IIDHabboHelp());
               this.var_143 = null;
            }
            if(this._toolbar)
            {
            ...
            if(this._roomEngine)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomObjectRoomAdEvent.const_190,this.onRoomAdClick);
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_328,this.onRoomAction);
            ...
            {
               this.var_314.stop();
               this.var_314.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_314 = null;
            }
      ...
      {
         this.var_1521[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_188 = IHabboConfigurationManager(param2);
         if(this.var_188)
         {
            if(this.var_267 != null)
            {
               this.var_267.configuration = this.var_188;
            }
            if(this.var_266 != null)
            {
               this.var_266.configuration = this.var_188;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1631);
            if(this.var_188)
            {
               if(this.var_665 != null)
               {
                  this.var_665.configure(this.var_188);
               }
               if(this.var_448 != null)
               {
                  this.var_448.configure(this.var_188);
               }
               if(this.var_664 != null)
               {
                  this.var_664.configure(this.var_188);
               }
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.trackLoginStep(HabboLoginTrackingStep.const_183);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_773,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_246,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_196,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_210,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_274,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_878,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_67,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_624,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_267 != null)
            {
               this.var_267.communication = this._communication;
               this.var_267.connection = param1;
            }
            if(this.var_665 != null)
            {
               this.var_665.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_878)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1642);
         }
         else if(param1.type == HabboHotelViewEvent.const_624)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1656);
         }
         else if(param1.type == HabboHotelViewEvent.const_67)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1569);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1743);
               break;
            case HabboCommunicationEvent.const_773:
               this.trackLoginStep(HabboLoginTrackingStep.const_1700,String(this._communication.port));
               break;
            ...
            case HabboCommunicationEvent.const_210:
               this.trackLoginStep(HabboLoginTrackingStep.const_210);
               break;
            case HabboCommunicationEvent.const_196:
               this.setErrorContextFlag(2,0);
               this.trackLoginStep(HabboLoginTrackingStep.const_196);
               break;
            case HabboCommunicationEvent.const_274:
               this.setErrorContextFlag(3,0);
               this.trackLoginStep(HabboLoginTrackingStep.const_274);
               if(this.var_267 != null)
               {
                  this.var_267.init();
               }
      ...
      {
         this.var_1237 = IHabboWindowManager(param2);
         if(this.var_1237)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_188)
            {
               if(this.var_188.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_188.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1521)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1248);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1248,this.onCoreRunning);
         }
      }
      ...
      {
         this.legacyTrack("catalogue","page",[param1.method_12]);
      }
      ...
      {
         this.var_210 = param2 as IHabboFriendList;
         Component(this.var_210).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_210).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_210).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_210).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_210).events.addEventListener(HabboFriendListTrackingEvent.const_405,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_405:
      ...
      {
         this.var_143 = param2 as IHabboHelp;
         this.var_143.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_143.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2704)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1547);
            this.var_2704 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.privateRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1210,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_865,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_190,this.onRoomAdClick);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_328,this.onRoomAction);
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_316.events.addEventListener(AdEvent.const_453,this.onRoomAdLoad);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_328)
         {
            if(this.var_1943 < 1)
            {
               if(!this.var_314)
               {
                  this.var_314 = new Timer(60000,1);
                  this.var_314.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_314.start();
               }
            }
         }
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_448)
               {
                  ...
                  this._connection.send(new ConversionPointMessageComposer("Performance","fps",String(this.var_448.frameRate),_loc2_));
                  ++this.var_1943;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_664)
         {
            this.var_664.track(param1.iconName);
         }
      }
      ...
      {
         if(this.var_188 != null && !Boolean(this.var_188.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      {
         this.var_665.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_544 > -1 && _loc2_ < this.var_544)
         {
            ++this.var_1944;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1944);
         }
         if(this.var_544 > -1 && _loc2_ - this.var_544 > 15000)
         {
            ++this.var_1945;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1945);
         }
         this.var_544 = _loc2_;
         if(this.var_266 != null)
         {
            this.var_266.update(param1,this.var_544);
         }
         if(this.var_267 != null)
         {
            this.var_267.update(param1,this.var_544);
         }
         if(this.var_448 != null)
         {
            this.var_448.trackUpdate(param1,this,this.var_544);
         }
         if(this.var_665 != null)
         {
            this.var_665.update(this.var_544);
         }
      }
   }
}
