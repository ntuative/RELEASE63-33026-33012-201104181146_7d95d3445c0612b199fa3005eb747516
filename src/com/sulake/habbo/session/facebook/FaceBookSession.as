package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1020:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1411:String = "sendAccessTokenToServer";
      
      private static const const_1410:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1411,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1410,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1020);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1020);
         }
      }
