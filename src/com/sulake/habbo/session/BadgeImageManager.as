package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1224:String = "group_badge";
      
      public static const const_1721:String = "normal_badge";
       
      
      private const const_1825:String = "badge_";
      ...
      public function getBadgeImage(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc3_:String = this.const_1825 + param1;
         ...
         switch(param2)
         {
            case const_1721:
               ...
               {
                  _loc5_ = this.var_188.getKey("image.library.url","http://images.habbo.com/c_images/");
            ...
            case const_1224:
               if(this.var_188 != null)
               {
                  if(this.var_188 != null)
                  {
                     _loc5_ = this.var_188.getKey("group.badge.url");
      ...
      private function onBadgeImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_.assetLoader != null && _loc2_.assetLoader.content != null)
            {
               ...
               _loc4_ = _loc2_.assetName.replace(this.const_1825,"");
