package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1380:String = "pixelbalance";
      
      private static const const_1384:String = "badges";
      
      private static const const_1379:String = "selectbadge";
      
      private static const const_1381:String = "inventory";
      
      private static const const_1378:String = "selectfurni";
      
      private static const const_1382:String = "credits";
      
      private static const const_1383:String = "friendlist";
      
      private static const const_1385:String = "pet_inventory";
      ...
      private var var_784:IHabboToolbar;
      ...
      private var var_226:HabboAlertDialogManager;
      
      private var var_783:ParkBusDialogManager;
      
      private var var_2504:Boolean;
      
      private var var_967:ClubGiftNotification;
      
      private var var_966:ClubEndingNotification;
      
      private var var_964:ClubPromoNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_965);
         }
         var _loc6_:Map = this.var_965["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_784)
         {
            this.var_784.release(new IIDHabboToolbar());
            this.var_784 = null;
         }
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_965["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
         ...
         this.var_1184.push(_loc8_);
         return this.var_1184.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1184.splice(0,1);
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_226 = new HabboAlertDialogManager(this._windowManager,this._localization);
      ...
      {
         this.var_784 = IHabboToolbar(param2);
         this.var_784.events.addEventListener(HabboToolbarEvent.const_74,this.onHabboToolbarEvent);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_74)
         {
            ...
            this.var_363 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_965["styles"],this.var_965["view"],this.var_784);
            ...
            registerUpdateReceiver(this.var_363,1);
            registerUpdateReceiver(this,2);
            this.var_434.events.addEventListener(BadgeImageReadyEvent.const_141,this.onBadgeImage);
            this.var_784.events.addEventListener(HabboToolbarEvent.const_469,this.onToolbarRepositionEvent);
         }
      }
      ...
      private function onQuests(param1:IMessageEvent) : void
      {
         ...
         if(this.var_809 != null && this.isCloseTracker(_loc2_.quests))
         {
            this.var_363.topMarginIncrease = 0;
            this.var_809 = null;
         }
      }
      ...
      private function onQuest(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_363.topMarginIncrease = 135;
         }
         this.var_809 = _loc2_.quest;
      }
      
      private function isCloseTracker(param1:Array) : Boolean
      {
         var _loc2_:* = null;
         for each(_loc2_ in param1)
         {
            if(_loc2_.id == this.var_809.id && _loc2_.accepted)
            {
               return false;
            }
         }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1464[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_434);
      }
      ...
      function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:AchievementNotification = this.var_1464[_loc2_.badgeID] as AchievementNotification;
         delete this.var_1464[_loc2_.badgeID];
         if(_loc3_)
         {
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            this.addItem(_loc4_.value,NotificationType.const_1716,null);
         }
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_434.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1235,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1235,null);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1500,null);
         }
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_520.createAvatarImage(param2,AvatarScaleType.const_53);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               if(_loc6_.productType == CatalogPageMessageProductData.const_80)
               {
                  _loc7_ = this.var_434.getFloorItemData(_loc6_.furniClassId);
               }
               else if(_loc6_.productType == CatalogPageMessageProductData.const_64)
               {
                  _loc7_ = this.var_434.getWallItemData(_loc6_.furniClassId);
               }
               ...
               {
                  _loc9_ = this.var_434.getProductData(_loc4_.localizationId);
                  if(_loc9_)
                  {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1704,_loc5_);
               }
            }
         }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1209)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1614,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1557)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_966 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_964 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_363.isSpaceAvailable() && this.var_1184.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_363.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1385:
               if(this._inventory != null && this._inventory.hasRoomSession)
               {
                  this._inventory.toggleInventoryPage(InventoryCategory.const_143);
               }
               break;
            case const_1378:
               break;
      ...
      private function onBadgeImage(param1:BadgeImageReadyEvent) : void
      {
         ...
         {
            this.var_363.replaceIcon(param1);
         }
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            if(param2 == 3001)
            {
               return FurniCategory.const_350;
            }
            if(param2 == 3002)
            {
               return FurniCategory.const_349;
            }
            if(param2 == 4057)
            {
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_226 == null)
         {
            return;
         }
         this.var_226.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_226.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         this.var_226.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_226.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_226.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_783 == null)
         {
            this.var_783 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_783 != null)
         {
            this.var_783.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1145,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1145,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_520.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_53);
            if(_loc6_ != null)
            {
               _loc6_.setDirection(AvatarSetType.const_37,3);
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2504)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_1137,null);
            this.var_2504 = true;
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_967 && this.var_967.visible)
         {
            return;
         }
         this.var_967 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_1137,_loc6_);
      }
   }
}
