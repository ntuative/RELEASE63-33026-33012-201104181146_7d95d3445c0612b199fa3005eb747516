package com.sulake.habbo.friendbar.view.utils
{
   ...
   public class FriendListIcon extends Icon
   {
      ...
      private static const const_1010:int = 500;
      ...
      override public function notify(param1:Boolean) : void
      {
         super.notify(param1);
         this.enable(param1);
         toggleTimer(param1 || var_875,!!var_875 ? int(const_1011) : int(const_1010));
         if(!var_876 && !var_875)
         {
      ...
      {
         super.hover(param1);
         toggleTimer(param1 || var_876,!!var_875 ? int(const_1011) : int(const_1010));
         if(!var_876 && !var_875)
         {
            image = this._assets.getAssetByName("icon_friendlist_png") as BitmapDataAsset;
         }
