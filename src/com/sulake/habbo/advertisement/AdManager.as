package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1277:BitmapData = null;
      
      private var var_1276:BitmapData = null;
      ...
      public function AdManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         events.addEventListener(AdImageEvent.const_180,this.onLoadAdImage);
      }
      ...
      {
         this.var_323 = param2 as IHabboCommunicationManager;
         if(this.var_323 == null)
         {
            return;
         }
         this._connection = this.var_323.getHabboMainConnection(this.onConnectionReady);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2801 = this._config.getKey("interstitial.enabled","com.sulake.habbo.inventory.marketplace") == "InfoStandSongDiskView";
         this.var_2802 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2804 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_2015 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_232 != null && this.var_232.running)
         {
            this.var_232.reset();
            return false;
         }
         if(this.var_1275 == 0)
         {
            this.var_1275 = getTimer();
            return false;
         }
         if(this.var_2015 > 0 && this.var_2016 >= this.var_2015)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1275;
         if(_loc1_ > this.var_2802)
         {
            ++this.var_2016;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1557 = _loc2_.imageUrl;
         this.var_2803 = _loc2_.clickUrl;
         this.var_1275 = getTimer();
         if(this.var_1557 != "")
         {
            _loc3_ = this.var_1557;
            ...
            {
               this.var_232 = new Timer(this.var_2804,1);
               this.var_232.addEventListener(TimerEvent.TIMER_COMPLETE,this.interstitialTimerComplete);
            }
            if(this.var_232.running)
            {
               this.var_232.reset();
            }
            this.var_232.start();
            _loc4_ = new URLRequest(this.var_1557);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_493,0,0,param1.bitmapData,this.var_2803));
            this.var_1275 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_463));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1558 = _loc2_.imageUrl;
         this.var_2017 = _loc2_.clickUrl;
         if(this.var_1558 != "" && this.var_2017 != "")
         {
            _loc3_ = this.var_1558;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            _loc4_ = new URLRequest(this.var_1558);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_453,0,0,_loc4_,_loc2_.assetName,this.var_2017,this.var_1277,this.var_1276));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1277 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1276 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function loadRoomAdImage(param1:int, param2:int, param3:String, param4:String) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdImageEvent(AdImageEvent.const_180,param3,param4,param1,param2));
         }
      }
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:AdImageEvent) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_932,param2.roomId,0,param1.clone(),param2.imageUrl,param2.clickUrl,null,null,param2.objectId));
         }
      }
      ...
      private function onBillboardImageLoadError(param1:AssetLoaderEvent) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_887,_loc4_.roomId,0,null,_loc4_.imageUrl,_loc4_.clickUrl,null,null,_loc4_.objectId));
         }
      }
   }
}
