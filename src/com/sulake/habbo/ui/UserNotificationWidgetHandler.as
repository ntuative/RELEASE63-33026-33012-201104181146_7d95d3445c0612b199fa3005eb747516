package com.sulake.habbo.ui
{
   ...
   public class UserNotificationWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserNotificationMessage.const_1104);
         return _loc1_;
      }
      
      public function getProcessedEvents() : Array
      {
         return [RoomSessionUserNotificationEvent.const_131];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserNotificationEvent.const_131:
               _loc2_ = param1 as RoomSessionUserNotificationEvent;
               _loc3_ = new RoomWidgetUserNotificationEvent(RoomWidgetUserNotificationEvent.const_626);
