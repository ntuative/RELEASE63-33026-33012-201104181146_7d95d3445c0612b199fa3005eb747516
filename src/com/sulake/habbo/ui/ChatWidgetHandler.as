package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_609:Map = null;
      
      private var var_1727:Map = null;
      ...
      private var var_757:Point = null;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_419.length)
            {
               _loc2_ = this.var_419.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_301 != null)
         {
            ...
            {
               _loc2_ = this.var_301.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_539,RoomWidgetChatSelectAvatarMessage.const_949];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_539:
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_44) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1062))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_44) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1062))
                              {
                     ...
                     switch(_loc3_.chatType)
                     {
                        case RoomWidgetChatMessage.const_112:
                           ...
                           break;
                        case RoomWidgetChatMessage.const_102:
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_949:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_301.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_419.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_609.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_191:
                                       ...
                                       break;
                                    default:
                                       _loc17_ = this._container.avatarRenderManager.createAvatarImage(_loc16_,AvatarScaleType.const_93,null,this);
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_609.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    if(_loc10_.type == RoomObjectTypeEnum.const_191)
                                    {
                                       this.var_301.add(this.getPetFigureString(_loc16_),_loc13_);
                                    }
                                    else
                                    {
                                       this.var_419.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1138 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1138);
            }
            if(this.var_757 == null)
            {
               ...
               this.var_506.y = 0;
               this.var_506.z = 0;
               this.var_757 = _loc4_.getScreenPoint(this.var_506);
               this.var_1138 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_506.x = 0;
            this.var_506.y = 0;
            this.var_506.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_506);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_757.x || _loc8_.y != this.var_757.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_757,_loc5_));
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         if(this.var_301)
         {
            _loc2_ = this.var_301.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_419)
         {
            _loc2_ = this.var_419.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1137.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            _loc5_ = this._container.avatarRenderManager.createPetImageFromFigure(param1,AvatarScaleType.const_93,this);
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_609.add(param1,_loc7_);
                  }
               }
            }
         }
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1727.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1727.remove(param1);
         if(_loc3_ != null)
         {
