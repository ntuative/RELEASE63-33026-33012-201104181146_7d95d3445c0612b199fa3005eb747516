package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1112:IRoomWidgetFactory;
      ...
      private var var_1958:IHabboAvatarEditor = null;
      ...
      private var var_1015:IHabboModeration;
      ...
      private var var_1245:IHabboUserDefinedRoomEvents;
      
      public function RoomUI(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1527 = RoomDesktop.const_462;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1112.release(new IIDHabboRoomWidget());
            this.var_1112 = null;
         }
         ...
         {
            this.var_1015.release(new IIDHabboModeration());
            this.var_1015 = null;
         }
         ...
         if(this.var_1245)
         {
            this.var_1245.release(new IIDHabboUserDefinedRoomEvents());
            this.var_1245 = null;
         }
         this.var_1958 = null;
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1112 = param2 as IRoomWidgetFactory;
      }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1958 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_316 != null && this.var_316.events != null)
         {
            this.var_316.events.addEventListener(AdEvent.const_463,this.adEventHandler);
            this.var_316.events.addEventListener(AdEvent.const_493,this.adEventHandler);
            this.var_316.events.addEventListener(AdEvent.const_453,this.adEventHandler);
         }
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1015 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_1015);
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_16)
         {
            this.var_16.events.addEventListener(RoomSessionEvent.const_277,this.roomSessionStateEventHandler);
            this.var_16.events.addEventListener(RoomSessionEvent.const_86,this.roomSessionStateEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionChatEvent.const_598,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionUserBadgesEvent.const_154,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionDoorbellEvent.const_124,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionDoorbellEvent.const_134,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionDoorbellEvent.const_61,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionPresentEvent.const_303,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionPetPackageEvent.const_499,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionPetPackageEvent.const_461,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionViralFurniStatusEvent.const_494,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionViralFurniStatusEvent.const_471,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_267,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_268,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_676,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_1121,this.roomSessionDialogEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_237,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_251,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_228,this.roomSessionDialogEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_686,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_194,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_933,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_693,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionQueueEvent.const_627,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionVoteEvent.const_145,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionVoteEvent.const_136,this.roomSessionEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionPollEvent.const_160,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionDimmerPresetsEvent.const_531,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionFriendRequestEvent.const_149,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionUserNotificationEvent.const_131,this.roomSessionEventHandler);
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_90:
               if(param1.session != null)
               {
                  ...
                  this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_178,HabboToolbarIconEnum.ZOOM));
                  this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_178,HabboToolbarIconEnum.MEMENU));
                  this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_178,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_686:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_933:
      ...
      {
         this.var_1245 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_946,this.roomEngineEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_948,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_877,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_812,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_166,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_714,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_501,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_526,this.roomObjectEventHandler);
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_946)
         {
            if(this.var_16 != null)
            {
               this.var_16.roomEngineReady = true;
         ...
         else if(param1.type == RoomEngineEvent.const_575 || param1.type == RoomEngineEvent.const_524)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_328:
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_317);
               if(this.var_1527 != RoomDesktop.const_462)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_317,this.var_1527);
               }
               if(this.var_316 != null)
               {
                  this.var_316.showRoomAd();
               }
            ...
            case RoomEngineEvent.const_323:
               ...
               break;
            case RoomEngineRoomColorEvent.const_948:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = this.var_1112;
         _loc3_.sessionDataManager = this.var_434;
         ...
         _loc3_.avatarEditor = this.var_1958;
         _loc3_.catalog = this._catalog;
         _loc3_.adManager = this.var_316;
         _loc3_.localization = this._localization;
         _loc3_.habboHelp = this.var_1244;
         _loc3_.moderation = this.var_1015;
         _loc3_.config = this._config;
         _loc3_.soundManager = this._soundManager;
         _loc3_.habboTracking = this._habboTracking;
         _loc3_.userDefinedRoomEvents = this.var_1245;
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_317);
            if(_loc3_ != RoomDesktop.const_462)
            {
