package com.sulake.habbo.ui
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1433:IMessageEvent;
      
      private var var_1786:IMessageEvent;
      
      private var var_1787:IMessageEvent;
      ...
      {
         this.var_1433 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_1786 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_1787 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1433);
         this._connection.addMessageEvent(this.var_1786);
         this._connection.addMessageEvent(this.var_1787);
      }
      ...
      public function dispose() : void
      {
         ...
         this._connection.removeMessageEvent(this.var_1433);
         this._connection.removeMessageEvent(this.var_1786);
         this._connection.removeMessageEvent(this.var_1787);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_918,RoomWidgetPlayListModificationMessage.const_769,RoomWidgetPlayListModificationMessage.const_835,RoomWidgetPlayListPlayStateMessage.const_702,RoomWidgetPlayListUserActionMessage.const_810];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_918:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc7_)
                  {
                     _loc8_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_860,_loc2_.id);
                     this._container.events.dispatchEvent(_loc8_);
                  }
               }
               break;
            case RoomWidgetPlayListModificationMessage.const_769:
            ...
            case RoomWidgetPlayListModificationMessage.const_835:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_702:
               ...
               break;
            case RoomWidgetPlayListUserActionMessage.const_810:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomEngineSoundMachineEvent.const_235);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_235:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_732,_loc2_.objectId);
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_866,-1));
            }
         }
      }
   }
