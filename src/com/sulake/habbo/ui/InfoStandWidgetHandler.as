   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         if(this.var_72 != null)
         {
            ...
            this.var_72.events.addEventListener(SongInfoReceivedEvent.const_94,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_182,this.onUserTags);
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_141,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_177,this.onFigureUpdate);
               this._container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_111,this.onPetInfo);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_182,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_141,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_177,this.onFigureUpdate);
            this._container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_111,this.onPetInfo);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_594.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_594.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_72 != null)
         {
            ...
            this.var_72.events.removeEventListener(SongInfoReceivedEvent.const_94,this.onSongInfoReceivedEvent);
            this.var_72 = null;
         }
         this.var_1076 = true;
         this.container = null;
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_534);
         _loc1_.push(RoomWidgetUserActionMessage.const_595);
         _loc1_.push(RoomWidgetUserActionMessage.const_580);
         _loc1_.push(RoomWidgetUserActionMessage.const_485);
         _loc1_.push(RoomWidgetUserActionMessage.const_599);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_713);
         _loc1_.push(RoomWidgetFurniActionMessage.const_283);
         _loc1_.push(RoomWidgetFurniActionMessage.const_791);
         _loc1_.push(RoomWidgetFurniActionMessage.const_937);
         _loc1_.push(RoomWidgetFurniActionMessage.const_786);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_671);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_873);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_699);
         ...
         _loc1_.push(RoomWidgetPetCommandMessage.const_752);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_498)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_407 || param1.type == RoomWidgetUserActionMessage.const_512 || param1.type == RoomWidgetUserActionMessage.const_525)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_534:
            ...
            case RoomWidgetUserActionMessage.const_512:
               ...
               break;
            case RoomWidgetUserActionMessage.const_580:
            ...
            case RoomWidgetUserActionMessage.const_485:
               ...
               break;
            case RoomWidgetUserActionMessage.const_599:
            ...
            case RoomWidgetUserActionMessage.const_503:
               ...
               break;
            case RoomWidgetUserActionMessage.const_713:
            ...
            case RoomWidgetUserActionMessage.const_525:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_791:
            ...
            case RoomWidgetFurniActionMessage.const_283:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_937:
               this._container.roomEngine.modifyRoomObject(_loc5_,_loc6_,RoomObjectOperationEnum.OBJECT_PICKUP);
               break;
            case RoomWidgetFurniActionMessage.const_786:
               _loc10_ = _loc7_.objectData;
               this._container.roomEngine.modifyRoomObjectDataWithMap(_loc5_,_loc6_,RoomObjectOperationEnum.OBJECT_SAVE_STUFF_DATA,_loc10_);
               break;
            case RoomWidgetUserActionMessage.const_407:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_671:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_873:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_699:
            ...
            case RoomWidgetUserActionMessage.const_596:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_752:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_344);
               _loc6_.id = param1.id;
               ...
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_421) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_421);
               }
               ...
               {
                  _loc25_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_311);
               ...
               _loc11_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1259);
               _loc12_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1182);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc29_ = "";
                  _loc30_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_722)
                  {
                     _loc31_ = this.var_72.getRoomItemPlaylist();
                     if(_loc31_ != null)
                     {
                  ...
                  {
                     _loc32_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_414.length);
                     _loc27_ = parseInt(_loc32_);
                     _loc30_ = "null";
                  }
                  if(_loc27_ != -1)
                  {
                     _loc33_ = this.var_72.getSongInfo(_loc27_);
                     if(_loc33_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_34:
               ...
               if(_loc13_.type == RoomObjectTypeEnum.const_191)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc13_.webID);
                  return null;
               }
               if(_loc13_.type == RoomObjectTypeEnum.const_208)
               {
                  _loc14_ = "null";
               ...
               {
                  if(_loc13_.type != RoomObjectTypeEnum.const_673)
                  {
                     return null;
                  }
                  _loc14_ = "null";
               ...
               if(_loc18_ != null)
               {
                  _loc15_.carryItem = _loc18_.getModel().getNumber(RoomObjectVariableEnum.const_483);
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_130)
               {
                  _loc15_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_108)
               {
                  ...
                  if(_loc18_ != null)
                  {
                     _loc39_ = _loc18_.getModel().getString(RoomObjectVariableEnum.const_827);
                  ...
                  if(!_loc35_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_740;
                  }
                  if(!_loc36_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_807;
                  }
               ...
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc16_.push(RoomWidgetUserInfoUpdateEvent.const_1556);
               }
               else
               {
      ...
      {
         return [RoomSessionUserBadgesEvent.const_154];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_154:
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_594.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_594.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_827);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_72 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_72.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_370,_loc2_,_loc3_,_loc4_));
         }
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_72 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_433,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
