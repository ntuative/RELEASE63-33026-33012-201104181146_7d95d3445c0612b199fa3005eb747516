package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1934:Number = 1.0;
      
      private var _alphaMultiplier:Number = 1.0;
      
      private var var_1274:Map;
      
      private var var_2793:Boolean = true;
      
      public function AvatarDataContainer(param1:XML)
      {
         super();
         this.var_2010 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2794 = parseInt(_loc2_,16);
         this.var_2795 = parseInt(_loc3_,16);
         this._rgb = parseInt(_loc2_,16);
         this.var_1789 = this._rgb >> 16 & 255;
         this.var_1788 = this._rgb >> 8 & 255;
         this._b = this._rgb >> 0 & 255;
         this.var_1933 = this.var_1789 / 255 * 1;
         this.var_1932 = this.var_1788 / 255 * 1;
         ...
         this.var_708 = new ColorTransform(this.var_1933,this.var_1932,this.var_1934,this._alphaMultiplier);
         this.var_1274 = this.generatePaletteMapForGrayscale(this.var_2795,this.var_2794);
      }
      ...
      {
         return this.var_1274.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1274.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1274.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1274.getValue("alphas") as Array;
      }
