package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_454:AvatarRenderManager;
      
      private var _geometry:AvatarModelGeometry;
      
      private var var_962:AvatarActionManager;
      
      private var var_361:FigureData;
      
      private var var_433:PartSetsData;
      
      private var _animationData:AnimationData;
      
      private var var_782:AnimationManager;
      
      private var var_993:ActionDefinition;
      
      private var var_524:String;
      
      private var var_1462:PartOffsetData;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:String, param3:PartOffsetData)
      {
         ...
         this.var_433 = new PartSetsData();
         this._animationData = new AnimationData();
         this.var_782 = new AnimationManager();
         this.var_524 = param2;
         this.var_634 = new Dictionary();
         this.var_1462 = param3;
      }
      ...
      {
         this.var_1462.loadOffsets(param1);
      }
      ...
      public function initGeometry(param1:XML) : void
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Geometry for structure: " + this.var_524);
            return;
         }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         if(!param2)
         {
            Logger.log("[AvatarStructure] Could not init Actions for structure: " + this.var_524);
            return;
         }
         this.var_962 = new AvatarActionManager(param1,this.var_524,param2);
         this.var_993 = this.var_962.getDefaultAction();
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Part Sets for structure: " + this.var_524);
            return false;
         }
         if(this.var_433.parse(param1))
         {
            if(this.var_524 == AvatarType.const_123)
            {
               this.var_433.getPartDefinition("ri").appendToFigure = true;
               this.var_433.getPartDefinition("li").appendToFigure = true;
            }
            return true;
         }
         return false;
      ...
      public function initAnimation(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Animations for structure: " + this.var_524);
            return false;
         }
      ...
      public function initFigureData(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Figure Data for structure: " + this.var_524);
            return false;
         }
      ...
      public function registerAnimations(param1:AssetLibraryCollection, param2:String = "fx", param3:int = 200) : void
      {
         ...
         while(_loc5_ < param3)
         {
            if(param1.hasAsset(param2 + _loc5_))
            {
               ...
               this.var_782.registerAnimation(this,_loc4_);
            }
            _loc5_++;
         }
      }
      ...
      {
         return this.var_782.getLayerData(param1,param2,param3) as AnimationLayerData;
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return this.var_782.getAnimation(param1) as Animation;
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return this.var_962.getActionDefinition(param1);
      }
      
      public function getActionDefinitionWithState(param1:String) : ActionDefinition
      {
         return this.var_962.getActionDefinitionWithState(param1);
      }
      ...
      {
         return this.var_962.sortActions(param1);
      }
      
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         if(!this.var_634[param1])
         {
            this.var_634[param1] = new Dictionary();
         }
         if(this.var_634[param1][param2])
         {
            return this.var_634[param1][param2];
         }
         this.var_634[param1][param2] = this.var_361.getMandatorySetTypeIds(param1,param2);
         return this.var_634[param1][param2];
      }
      ...
      {
         return this.var_962.getCanvasOffsets(param1,param2,param3);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = this.var_782.getAnimation(_loc6_) as Animation;
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  for each(_loc12_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc9_ = this.var_433.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = this.var_433.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1491[param3];
      ...
      public function getParts(param1:String, param2:IAvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:Array = this.var_433.getActiveParts(param3.definition);
         ...
         if(param3.definition.isAnimation)
         {
            ...
            _loc9_ = this.var_782.getAnimation(_loc23_) as Animation;
            if(_loc9_ != null)
            {
                  ...
                  if(_loc31_)
                  {
                     ...
                     for each(_loc32_ in _loc31_.parts)
                     {
                        if(_loc15_.indexOf(_loc32_.type) > -1)
                        {
                           ...
                           {
                              _loc33_ = this.var_993;
                           }
                           _loc12_ = this.var_433.getPartDefinition(_loc32_.type);
         ...
         for each(_loc11_ in _loc15_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc8_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc12_ = this.var_433.getPartDefinition(_loc11_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         return this.var_1462.getOffset(param1,param2,param3,param4,param5,param6);
      }
