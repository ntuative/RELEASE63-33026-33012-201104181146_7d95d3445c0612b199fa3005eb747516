package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryBaseView
   {
      ...
      protected var var_39:Dictionary;
      
      protected var var_146:String = "";
      
      protected var var_49:String = "";
      
      protected var var_68:IAvatarEditorCategoryModel;
      
      protected var var_194:Boolean;
      ...
      public function showPalettes(param1:String, param2:int) : void
      {
         ...
         var _loc3_:AvatarEditorGridView = this.var_39[param1] as AvatarEditorGridView;
         if(!_loc3_)
         {
            return;
         }
      ...
      protected function setElementImage(param1:IBitmapWrapperWindow, param2:Boolean) : void
      {
         ...
         if(result && result.length)
         {
            ...
            {
               bmpWindow.bitmap = new BitmapData(bmpWindow.width,bmpWindow.height,false,AvatarEditorView.var_2102);
      ...
      protected function updateGridView() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = this.var_39[this.var_146];
         if(_loc2_ == null)
         {
            return;
         }
