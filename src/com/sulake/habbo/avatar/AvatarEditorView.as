package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1322:IWindowContainer;
      
      public static var var_1601:IWindowContainer;
      
      public static var var_2102:int = 6710886;
      ...
      private var var_377:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_543:IFrameWindow;
      
      private var var_447:Timer;
      
      private var var_2693:Number = 0;
      
      private var var_2692:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1234 = [];
         this.var_1515 = [AvatarEditorFigureCategory.const_674,AvatarEditorFigureCategory.const_51,AvatarEditorFigureCategory.const_253,AvatarEditorFigureCategory.const_922,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_114];
         super();
         ...
         if(var_1322 == null)
         {
            ...
            var_1322 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1601 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1601 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_447 = new Timer(1000);
         this.var_447.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1515;
         }
         for each(_loc6_ in param4)
         {
            this.var_1234.push(_loc6_);
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2692 = this.canChangeOutfit();
            this.var_447.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_377 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_377.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_377.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1234.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_377.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_377.numSelectables)
               {
                  this.var_377.getSelectableAt(_loc6_).x = this.var_377.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
         }
         this.var_377.setSelected(this.var_377.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_44) && (this.var_1935 == AvatarEditorSideCategory.const_114 || this.var_2691))
         {
         ...
         this.setViewToCategory(this.var_375);
      }
      ...
      {
         if(this.var_1935 == AvatarEditorSideCategory.const_114)
         {
            this.var_2691 = false;
            this.setSideContent(AvatarEditorSideCategory.const_940);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_940:
               break;
            case AvatarEditorSideCategory.const_549:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_549);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_375 = param1;
         this.var_377.setSelected(this.var_377.getSelectableByName(param1));
      }
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2693 = new Date().valueOf();
                  this.var_2692 = false;
                  this.var_447.start();
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_543)
         {
            ...
            this.var_543 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_543.procedure = this.stripClubDialogEventProc;
            this.var_543.center();
         }
         else
         {
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2693 > 5000;
      }
   }
}
