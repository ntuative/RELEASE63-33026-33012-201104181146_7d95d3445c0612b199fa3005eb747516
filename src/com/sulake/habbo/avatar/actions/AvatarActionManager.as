package com.sulake.habbo.avatar.actions
{
   ...
   public class AvatarActionManager
   {
      ...
      private var var_330:Dictionary;
      ...
      public function getCanvasOffsets(param1:Array, param2:String, param3:int) : Array
      {
         ...
         while(_loc7_ < param1.length)
         {
            ...
            _loc6_ = this.var_330[_loc5_.actionType] as ActionDefinition;
      ...
      public function sortActions(param1:Array) : Array
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         param1 = this.method_7(param1);
         var _loc2_:Array = new Array();
         for each(_loc3_ in param1)
         {
            _loc4_ = this.var_330[_loc3_.actionType];
            if(_loc4_ != null)
            {
      ...
      private function method_7(param1:Array) : Array
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc6_:int = 0;
         ...
         while(_loc6_ < param1.length)
         {
            ...
            _loc5_ = this.var_330[_loc4_.actionType] as ActionDefinition;
            if(_loc5_ != null)
            {
