package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      private var var_1806:Dictionary;
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_1806 = new Dictionary();
         super();
         this._id = String(param1.@id);
         this._state = String(param1.@state);
         this.var_2690 = parseInt(param1.@precedence);
         this.var_2685 = String(param1.@activepartset);
         this.var_2687 = String(param1.@assetpartdefinition);
         this.var_2686 = String(param1.@lay);
         this.var_802 = String(param1.@geometrytype);
         this.var_2288 = Boolean(parseInt(param1.@main));
         this.var_2689 = Boolean(parseInt(param1.@method_11));
         this.var_2688 = Boolean(parseInt(param1.@animation));
         this._preventHeadTurn = Boolean(String(param1.@preventheadturn == "InfoStandSongDiskView"));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "default")
            {
               this.var_2684 = _loc6_;
            }
            else
            {
               this.var_1806[_loc5_] = _loc6_;
            }
         }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         if(this.var_824.getValue(param1) == null)
         {
            this.var_824.add(param1,new Map());
         }
         var _loc4_:Map = this.var_824.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_824.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1806[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2684;
         }
         return _loc2_;
      }
