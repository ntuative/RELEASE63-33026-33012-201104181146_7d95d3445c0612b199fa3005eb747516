package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1361:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1362:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_1166:AvatarEditorHandler;
      ...
      private var var_943:IFigureData;
      
      private var var_623:Dictionary;
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc2_ in this.var_519)
            {
               _loc2_.dispose();
               _loc2_ = null;
            }
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_194)
         {
            this.var_623 = new Dictionary();
            this.var_623["null"] = new FigureData(this);
            this.var_623["null"] = new FigureData(this);
            _loc2_ = this.var_623["null"];
            _loc3_ = this.var_623["null"];
            _loc2_.loadAvatarData(const_1361,FigureData.const_76);
            _loc3_.loadAvatarData(const_1362,FigureData.FEMALE);
            this.var_103 = new Map();
            this.var_519 = new Map();
            this.var_103.add(AvatarEditorFigureCategory.const_674,new BodyModel(this));
            this.var_103.add(AvatarEditorFigureCategory.const_51,new HeadModel(this));
            this.var_103.add(AvatarEditorFigureCategory.const_253,new TorsoModel(this));
            this.var_103.add(AvatarEditorFigureCategory.const_922,new LegsModel(this));
            if(param1 == null || param1.indexOf(AvatarEditorFigureCategory.HOTLOOKS) > -1)
            {
               this.var_103.add(AvatarEditorFigureCategory.HOTLOOKS,new HotLooksModel(this));
            }
            this.var_519.add(AvatarEditorSideCategory.const_114,new WardrobeModel(this));
            this.var_519.add(AvatarEditorSideCategory.const_549,new ClubPromoModel(this));
            this.var_194 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc4_:FigureData = this.var_623[param2];
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(this.var_103)
         {
            for each(_loc5_ in this.var_103)
            {
               _loc5_.reset();
            }
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_943.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_943.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_255 == null)
            {
               this.var_255 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_66,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_255.addChild(this._view.window);
               if(param5)
               {
                  this.var_255.center();
               }
            ...
            this.var_255.visible = !this.var_255.visible;
         }
         this._view.show();
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_674);
         }
         this.var_1430 = param2;
         return true;
      }
      ...
      {
         var _loc2_:IAvatarEditorCategoryModel = this.var_103.getValue(param1) as IAvatarEditorCategoryModel;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:ISideContentModel = this.var_519.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_520 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_943 = this.var_520.getFigureData(AvatarType.const_123);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1166 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_623[this.var_1048];
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1167 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1363)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1601.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_520.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_520.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1322.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1504)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1167 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1322.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function hasInvalidClubItems() : Boolean
      {
         ...
         for each(_loc2_ in this.var_103)
         {
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1167 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_519.getValue(AvatarEditorSideCategory.const_114);
      }
