package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2052:String = "hd-99999-99999";
      ...
      private var var_290:PetDataManager;
      
      private var var_715:PaletteManager;
      ...
      private var var_1636:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_570 = RenderMode.const_1687;
         this.var_291 = new Map();
         this.var_104 = new Map();
         _loc4_ = new AvatarStructure(this,AvatarType.const_123,PartOffsetData.getInstance(param1.assets));
         ...
         this.var_104.add(AvatarType.const_123,_loc4_);
         _loc4_ = new AvatarStructure(this,AvatarType.const_69,PartOffsetData.getInstance(param1.assets));
         ...
         this.var_104.add(AvatarType.const_69,_loc4_);
         this._aliasCollection = new AssetAliasCollection(this,param1.assets as AssetLibraryCollection);
         this.var_290 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         this.var_715 = new PaletteManager(param1.assets as AssetLibraryCollection);
         var _loc5_:XML = param3.getAssetByName("HabboAvatarPetFigure").content as XML;
         this.var_290.populateFigureData(_loc5_);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_290.init();
         this.var_715.init();
         _loc2_ = this.var_104.getValue(AvatarType.const_123) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_104.getValue(AvatarType.const_69) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_104.getValue(AvatarType.const_123) as AvatarStructure;
            if(_loc3_ != null)
            {
               _loc4_ = this.var_188.getKey("external.figurepartlist.txt","figure.xml");
               ...
               if(this.var_217 == null)
               {
                  ...
                  _loc6_ = this.var_188.getKey("flash.dynamic.avatar.download.configuration","figuremap.xml");
                  _loc7_ = this.var_188.getKey("flash.dynamic.avatar.download.url","");
      ...
      private function checkIfReady() : void
      {
         if(!this.var_1014)
         {
            if(this.var_2192 && this.var_2194 && this.var_2193)
            {
      ...
      {
         var _loc5_:AvatarStructure = this.var_104.getValue(AvatarType.const_123) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1636)
         {
            this.var_1636 = new AvatarFigureContainer(this.const_2052);
         }
         this.var_217.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1636,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         for each(_loc3_ in this.var_291.getKeys())
         {
            _loc4_ = this.var_291.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_290.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1685)
         {
            _loc6_ = !this.var_290.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_290.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_104.getValue(AvatarType.const_69) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_291.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_290.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_104.getValue(AvatarType.const_69);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_291.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_291.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc3_:AvatarStructure = this.var_104.getValue(AvatarType.const_123) as AvatarStructure;
      ...
      {
         return this.var_290 as IPetDataManager;
      }
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            case AvatarType.const_123:
               _loc3_ = this.var_104.getValue(AvatarType.const_123) as AvatarStructure;
               break;
            case AvatarType.const_69:
               _loc3_ = this.var_104.getValue(AvatarType.const_69) as AvatarStructure;
               break;
            default:
