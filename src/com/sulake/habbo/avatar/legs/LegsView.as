   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_39)
         {
            ...
            var_39["null"] = new AvatarEditorGridView(var_68,FigureData.TROUSERS,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_68,FigureData.const_273,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_68,FigureData.const_242,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_68 && var_146 == "")
         {
            var_68.switchCategory(FigureData.TROUSERS);
         }
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "tab_pants":
                  ...
                  break;
               case "tab_shoes":
                  this.switchCategory(FigureData.const_273);
                  break;
               case "tab_belts":
