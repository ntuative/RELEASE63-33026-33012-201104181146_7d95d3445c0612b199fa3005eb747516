package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements ISideContentView
   {
      ...
      private var var_925:IItemListWindow;
      
      private var var_1136:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel)
      {
         ...
         this.var_925 = this._window.findChildByName("hc_slots") as IItemListWindow;
         this.var_1136 = this._window.findChildByName("vip_slots") as IItemListWindow;
      ...
      public function update() : void
      {
         ...
         if(this.var_925)
         {
            this.var_925.removeListItems();
         }
         if(this.var_1136)
         {
            this.var_1136.removeListItems();
         }
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(_loc3_ < 5)
            {
               if(this.var_925)
               {
                  this.var_925.addListItem(_loc2_.view);
                  _loc2_.view.visible = true;
               }
            }
            else if(this.var_1136)
            {
               this.var_1136.addListItem(_loc2_.view);
               _loc2_.view.visible = true;
            }
            _loc3_++;
         }
