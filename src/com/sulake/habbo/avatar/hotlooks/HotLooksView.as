package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksView implements IAvatarEditorCategoryView
   {
      ...
      private var var_68:HotLooksModel;
      ...
      public function init() : void
      {
         ...
         this.var_680 = this._window.findChildByName("hotlooks") as IItemGridWindow;
      ...
      {
         while(this.var_680.numGridItems > 0)
         {
            this.var_680.removeGridItemAt(0);
         }
         this._window.dispose();
         this._window = null;
         this.var_68 = null;
      ...
      public function update() : void
      {
         ...
         var _loc2_:* = null;
         this.var_680.removeGridItems();
         for each(_loc2_ in this.var_68.hotLooks)
         {
            _loc1_ = _loc2_.view.window;
            this.var_680.addGridItem(_loc1_);
      ...
      private function hotLooksEventProc(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         {
            _loc3_ = this.var_680.getGridItemIndex(param2.parent);
            this.var_68.selectHotLook(_loc3_);
         }
      }
