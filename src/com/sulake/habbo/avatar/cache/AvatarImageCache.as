package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1813:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1427:IAvatarImage;
      ...
      private var var_2618:Point;
      
      private var var_802:String;
      
      private var var_186:BitmapData;
      ...
      private var var_2619:ImageData;
      
      private var var_1043:PaletteMap;
      
      private var var_985:Array;
      
      private var var_987:Point;
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_802 == GeometryType.const_1069 && param1 == GeometryType.const_1234 || this.var_802 == GeometryType.const_1234 && param1 == GeometryType.const_1069)
         {
            this.var_802 = param1;
            this.var_87 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
            ...
            if(this.var_371.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     if(_loc14_.type == AnimationLayerData.const_934)
                     {
                        if(_loc14_.action != null)
                        {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_612)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1427.getFigure(),_loc5_,this.var_802,_loc3_,_loc6_,_loc7_);
         ...
         if(this.var_449 == null)
         {
            ...
            this.var_449 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_371);
            if(this.var_449 == null)
            {
               return null;
            }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_87)
         {
            this.var_87 = this._structure.getCanvas(this._scale,this.var_802);
            if(!this.var_87)
            {
               return null;
            }
            this.var_2618 = new Point(0,this.var_87.height - int(this.var_87.width / 4));
         }
         ...
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_914 || _loc10_ == AvatarAction.const_396;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1494 = this.var_121.bodyPartId;
               this.var_185 = this.var_121.partType;
               this.var_1889 = this.var_121.partId;
               ...
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_121.flippedPartType != this.var_185)
                     {
                        this.var_185 = this.var_121.flippedPartType;
                     }
                  }
               }
               this.var_1493 = this._scale + "_" + this.var_121.action.assetPartDefinition + "_" + this.var_185 + "_" + this.var_1889 + "_" + _loc5_ + "_" + this._frame;
               this.var_443 = this._assets.getAssetByName(this.var_1493) as BitmapDataAsset;
               if(this.var_443 == null)
               {
                  this.var_1493 = this._scale + "_std_" + this.var_185 + "_" + this.var_1889 + "_" + _loc5_ + "_0";
                  this.var_443 = this._assets.getAssetByName(this.var_1493) as BitmapDataAsset;
               }
               if(!(!this.var_443 || !this.var_443.content))
               {
                  if(this.var_121.paletteMapId > -1)
                  {
                     this.var_1043 = this._structure.renderManager.paletteManager.getPalette(this.var_121.paletteMapId);
                     if(this.var_1043 != null)
                     {
                        this.var_986 = this.var_443.content as BitmapData;
                        this.var_186 = new BitmapData(this.var_986.width,this.var_986.height);
                        this.var_2617 = this.var_1043.colorize(this.var_986.getPixels(this.var_986.rect));
                        this.var_186.setPixels(this.var_186.rect,this.var_2617);
                     }
                     else
                     {
                        this.var_186 = (this.var_443.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1494 == AvatarBodyPartType.const_253 || this.var_1494 == AvatarBodyPartType.const_1506 || this.var_1494 == AvatarBodyPartType.const_1740) && this.var_121.color != null)
                  {
                     _loc16_ = 0.7;
                     ...
                     this.var_186.colorTransform(this.var_186.rect,_loc18_);
                  }
                  else if(this.var_121.isColorable && this.var_121.color != null)
                  {
                     this.var_186.colorTransform(this.var_186.rect,this.var_121.color.colorTransform);
                  }
                  if(this.var_121.isBlendable)
                  {
                     this.var_186.colorTransform(this.var_186.rect,this.var_121.blendTransform);
                  }
                  this.var_987 = this.var_443.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_53)
                     {
                  ...
                  this.var_2619 = new ImageData(this.var_186,this.var_987,_loc7_);
                  this.var_985.push(this.var_2619);
               }
            }
            _loc8_--;
         }
         ...
         var _loc13_:ImageData = this.createUnionImage(this.var_985,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2618.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_53)
            {
         ...
         _loc8_ = this.var_985.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_985.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
