package com.sulake.habbo.avatar
{
   ...
   public class PlaceholderPetImage extends PetImage
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_663)
         {
            for each(_loc1_ in this.var_663)
            {
            }
      ...
      private function getPlaceHolderImage(param1:int, param2:String) : BitmapData
      {
         ...
         _loc3_ += "_png";
         _loc6_;
         var _loc4_:BitmapData = this.var_663.getValue(_loc3_);
         if(!_loc4_)
         {
            ...
            _loc6_;
            this.var_663.add(_loc3_,_loc4_.clone());
            _loc4_ = this.var_663.getValue(_loc3_);
         }
         return _loc4_;
      }
