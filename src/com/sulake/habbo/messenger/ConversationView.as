package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1288:int = 10;
      
      private static const const_970:int = 100;
      
      private static const const_1289:int = 20;
       
      
      private var var_141:HabboMessenger;
      
      private var var_2144:IScrollbarWindow;
      
      private var var_1619:IContainerButtonWindow;
      
      private var var_60:IItemListWindow;
      
      private var var_480:Conversation;
      
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_141 = param1;
         this.var_1619 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_60 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2144 = IScrollbarWindow(param2.findChildByName("scroller"));
         this.var_141.refreshButton(param2,"close",true,this.onCloseButtonClick,0);
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_970 + const_1289)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function initButton(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
         ...
         _loc5_.bitmap = this.var_141.getButtonImage(param1);
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1288;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_480 == null || _loc1_.id != this.var_480.id)
         {
            this.var_480 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_480.followingAllowed)
         {
            this.var_1619.enable();
         }
         else
         {
            this.var_1619.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_60.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_480.messages.length - const_970);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_480.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_480.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         if(_loc4_ == null)
         {
            ...
            _loc4_ = ITextWindow(this.var_141.getXmlWindow("msg_entry"));
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_952 || param3.type == Message.const_759 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_480.id;
         _loc3_["random"] = "" + Math.round(Math.random() * 100000000);
         if(this.var_141.isEmbeddedMinimailEnabled())
         {
            if(false)
            {
         ...
         {
            this.var_141.openHabboWebPage("link.format.mail.compose",_loc3_,param1);
         }
      }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_141.send(new FollowFriendMessageComposer(this.var_480.id));
      }
      ...
      private function onCloseButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_141.conversations.closeConversation();
