package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_1044:ConversationsTabView;
      
      private var var_904:ITextFieldWindow;
      
      private var var_15:IFrameWindow;
      
      private var var_1560:ConversationView;
      ...
      public function openMessenger() : void
      {
         ...
         if(this.var_15 == null)
         {
            this.prepareContent();
            this.refresh();
            this.var_141.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_59,HabboToolbarIconEnum.MESSENGER,this.var_15));
         }
         else
         {
            this.refresh();
      ...
      public function refresh() : void
      {
         ...
         this.var_1044.refresh();
         this.var_1560.refresh();
         if(this.var_141.conversations.openConversations.length < 1)
         {
            this.var_15.visible = false;
      ...
      public function addMsgToView(param1:Conversation, param2:Message) : void
      {
         ...
         this.var_1560.addMessage(param2);
      }
      
      private function prepareContent() : void
      {
         this.var_15 = IFrameWindow(this.var_141.getXmlWindow("main_window"));
         ...
         this.var_1044 = new ConversationsTabView(this.var_141,this.var_15);
         this.var_1044.refresh();
         this.var_904 = ITextFieldWindow(this.var_15.findChildByName("message_input"));
         this.var_904.addEventListener(WindowKeyboardEvent.const_172,this.onMessageInput);
         this.var_1560 = new ConversationView(this.var_141,this.var_15);
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_725,false);
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_1192,true);
         this.var_15.center();
      }
      ...
      private function sendMsg() : void
      {
         ...
         this.var_904.text = "";
         this.var_141.conversations.addMessageAndUpdateView(new Message(Message.const_952,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
      
      public function getTabCount() : int
      {
         return this.var_1044 == null ? 7 : int(this.var_1044.getTabCount());
      }
   }
}
