package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      public static var var_329:int = 3;
      
      private static var var_1409:int = 2;
      ...
      private var var_1729:TriggerConfs;
      
      private var var_1730:ActionTypes;
      
      private var var_1728:ConditionTypes;
      
      private var var_249:Dictionary;
      
      private var var_36:Triggerable;
      
      private var var_758:RoomObjectHightLighter;
      
      private var var_143:UserDefinedRoomEventsHelp;
      
      private var var_1141:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1729 = new TriggerConfs();
         this.var_1730 = new ActionTypes();
         this.var_1728 = new ConditionTypes();
         this.var_249 = new Dictionary();
         super();
         this.var_79 = param1;
         this.var_758 = new RoomObjectHightLighter(param1);
         this.var_143 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         {
            delete this.var_249[param1];
            this.var_758.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_36.furniLimit)
         {
            this.var_249[param1] = param2;
            this.var_758.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1141 = new SliderWindowController(this.var_79,IWindowContainer(this.find(this.var_52,"delay_slider_container")),this.var_79.assets,0,20,1);
         this.var_1141.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1141.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_758.hideAll(this.var_249);
         }
      }
      ...
      private function prepareStuffSelectionForUpdate() : void
      {
         ...
         if(this.var_36.stuffTypeSelectionEnabled)
         {
            ...
            else if(_loc2_.requiresFurni == var_329)
            {
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1141.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_143.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = this.var_36.stuffTypeSelectionCode < 1 ? int(var_1409) : int(this.var_36.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = (this.var_36.stuffTypeSelectionCode + 1) % (var_1409 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function resolveStuffSelectionType() : int
      {
         ...
         if(_loc1_.requiresFurni == var_329)
         {
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1729);
         this.refreshConfigureElement(this.var_1730);
         this.refreshConfigureElement(this.var_1728);
