package com.sulake.habbo.roomevents.userdefinedroomevents.actiontypes
{
   ...
   public class JoinTeam implements ActionType
   {
      ...
      {
         return ActionTypeCodes.var_2101;
      }
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.getTeamSelector(param1).setSelected(this.method_9(param1,_loc3_));
      }
      ...
      private function method_9(param1:IWindowContainer, param2:int) : IRadioButtonWindow
      {
