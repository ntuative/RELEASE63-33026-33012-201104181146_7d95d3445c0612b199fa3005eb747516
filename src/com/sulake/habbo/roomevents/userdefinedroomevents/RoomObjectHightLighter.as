package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class RoomObjectHightLighter
   {
      ...
      {
         return this.var_79.roomEngine.getRoomObject(this.var_79.roomId,this.var_79.roomCategory,param1,RoomObjectCategoryEnum.const_27);
      }
