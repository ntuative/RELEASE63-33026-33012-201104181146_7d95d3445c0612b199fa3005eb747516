package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_499:IKeyExchange;
      
      private var var_921:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2306:PseudoRandom;
      ...
      private const const_1801:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_603 = param1;
            this.var_57.initConnection(HabboConnectionType.const_249);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionEvent.const_90,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      {
         if(this.var_57 && this.var_158 && this.var_16 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_221 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         ...
         {
            this.var_221.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_158.getKey("use.sso.ticket") == "1";
         this.var_603 = this.var_158.getKey("sso.ticket",null);
         this.var_1708 = this.var_158.getKey("flash.client.url","");
         this.var_2305 = this.var_158.getKey("external.variables.txt","");
         if(this.var_221 == null)
         {
            this.var_221 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_57.mode = HabboConnectionType.const_97;
            if(this.var_603)
            {
               this.var_57.initConnection(HabboConnectionType.const_249);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_605,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_57.mode = HabboConnectionType.const_1230;
            }
         }
         this.var_57.initConnection(HabboConnectionType.const_249);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_773);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2306 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_57.mode)
         {
            case HabboConnectionType.const_97:
               _loc6_ = "";
               ...
               this.var_1392 = _loc4_;
               this.var_221.loadBannerImage(_loc7_ + "?token=" + this.var_1392,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1230:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1552:
               this.var_921 = this.generateRandomHexString(30);
               this.var_499 = new DiffieHellman(new BigInteger(this.var_158.getKey("connection.development.prime"),16),new BigInteger(this.var_158.getKey("connection.development.generator"),16));
               this.var_499.init(this.var_921);
               _loc8_ = this.var_499.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_499.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_499.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2306);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         this.var_1393 = true;
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_246);
         connection.send(new VersionCheckMessageComposer(401,this.var_1708,this.var_2305));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1801,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_603 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_603);
            _loc2_.send(_loc4_);
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_196);
         }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_274);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(this.var_1393)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_210);
         }
         if(param1.type == Event.CLOSE && !this.var_2304)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1392);
         ...
         this.var_499 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_499.init(_loc14_);
            _loc15_ = this.var_499.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_921 = _loc14_;
            }
