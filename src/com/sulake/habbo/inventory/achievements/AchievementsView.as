package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsView implements IInventoryView
   {
      ...
      private var var_68:AchievementsModel;
      
      private var var_1143:Dictionary;
      ...
      public function AchievementsView(param1:AchievementsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:ISessionDataManager)
      {
         ...
         this.var_420 = new Timer(1000,1);
         this.var_420.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
         this.var_434.events.addEventListener(BadgeImageReadyEvent.const_141,this.onBadgeImageReady);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_420)
            {
               this.var_420.removeEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
               this.var_420.reset();
               this.var_420 = null;
            }
            this._disposed = true;
      ...
      public function updateList() : void
      {
         ...
         var _loc1_:Array = this.var_68.getAchievements();
      ...
      {
         Logger.log("Got badge: " + param1.badgeId + ", " + this.var_420.running);
         this.var_1143[param1.badgeId] = param1.badgeImage;
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc4_:BitmapData = this.var_1143[param2.badgeId];
         if(_loc4_ == null)
         {
            _loc4_ = this.var_434.getBadgeImage(param2.badgeId);
            this.var_1143[param2.badgeId] = _loc4_;
         }
