package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_50:String = "I";
      
      public static const const_373:String = "pets";
      ...
      private var var_1016:IWindowContainer;
      ...
      private var var_1963:Vector.<Array>;
      
      private var var_1962:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_669 = new Timer(const_1434,1);
         ...
         this.var_2721 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_166,this.onObjectPlaced);
               }
            ...
            {
               this.var_211.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_211.stop();
               this.var_211 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_46)
            {
               ...
               {
                  this.var_1963 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1963;
            }
            else
            {
               if(this.var_1962 == null)
               {
                  this.var_1962 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1962;
            }
         ...
         this._controller.setInventoryCategoryInit(InventoryCategory.const_78);
         ...
         if(this.getSelectedItemIndex(FurniModel.const_50) == -1)
         {
            this.toggleItemSelection(FurniModel.const_50,0);
         }
         this.initListImages();
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_350)
         {
         ...
         else if(param3 == FurniCategory.const_349)
         {
         ...
         else if(param3 == FurniCategory.const_294)
         {
         ...
         if(this.var_1016 == null)
         {
            this.var_1016 = this._windowManager.buildFromXML(this.var_2721) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_1016.clone() as IWindowContainer;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_46,const_50];
         var _loc5_:int = 0;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_211 = new Timer(param1,1);
            this.var_211.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_211.start();
         }
         else
         {
         ...
         if(param1 == InventoryCategory.const_78 && this._controller.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_50:
                  ...
                  break;
               case const_373:
                  this._controller.toggleInventoryPage(InventoryCategory.const_143);
            }
         }
      }
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_399);
      ...
      public function updateItemLocks() : void
      {
         ...
         var _loc7_:Array = [const_46,const_50];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_46,const_50];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_668.add(const_46,new Array());
         this.var_668.add(const_50,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1) : void
      {
         ...
         else
         {
            ...
            for(; _loc8_ < _loc6_.length; _loc8_++)
            {
               ...
               if(_loc7_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_198)
                  {
                     _loc5_ = _loc7_;
                  }
      ...
      public function updatePostItCount(param1:int, param2:int) : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc3_:Array = this.getCategoryContent(const_50);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_318;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_349 || _loc3_.category == FurniCategory.const_350 || _loc3_.category == FurniCategory.const_294)
         {
            if(param1)
            {
               return false;
      ...
      {
         return this.var_668.getValue(param1);
      }
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_668.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_927)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
