package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_2113:int = 0;
      
      private const const_1046:int = 1;
      
      private const const_1815:int = 2;
      
      private const const_1814:int = 3;
      
      private const const_1817:int = 42;
      
      private const const_1816:int = 120;
      ...
      private var var_709:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_445.add(FurniModel.const_46,new FurniGridView(this.var_68,FurniModel.const_46,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_445.add(FurniModel.const_50,new FurniGridView(this.var_68,FurniModel.const_50,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_445.getValue(this.var_444);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_68.getCategoryContent(this.var_444);
         if(!this.var_68.isListInited())
         {
            _loc2_ = this.const_1046;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1815;
         }
         else
         {
            _loc2_ = this.const_1814;
         }
         if(this.var_2156 == _loc2_)
         {
            return;
         }
         this.var_2156 = _loc2_;
         ...
         switch(_loc2_)
         {
            case this.const_1046:
               _loc3_.visible = true;
               _loc4_.visible = false;
               _loc5_.visible = false;
               break;
            case this.const_1815:
               _loc3_.visible = false;
               _loc4_.visible = true;
               _loc5_.visible = false;
               break;
            case this.const_1814:
               _loc3_.visible = false;
               _loc4_.visible = false;
               _loc5_.visible = true;
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_46,FurniModel.const_50];
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_.length)
         {
            _loc2_ = _loc1_[_loc4_];
            _loc3_ = this.var_445.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_445.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_445.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_68.getGroupItemInIndex(_loc3_,this.var_444);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            _loc16_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_333);
            _loc17_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_309);
            _loc18_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_329);
            ...
            if(_loc5_.category == FurniCategory.const_350)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_349)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_294)
            {
            ...
            {
               if(_loc5_.category == FurniCategory.const_198)
               {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_709 && this.var_709.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc5_ != null)
         {
            if(_loc5_.category == FurniCategory.const_1244)
            {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1816)
         {
            _loc3_ = this.const_1816;
         }
         else if(_loc3_ < this.const_1817)
         {
            _loc3_ = this.const_1817;
         }
         else
         {
         ...
         else if(param1.type == WindowEvent.const_57)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_373);
            }
         }
      }
