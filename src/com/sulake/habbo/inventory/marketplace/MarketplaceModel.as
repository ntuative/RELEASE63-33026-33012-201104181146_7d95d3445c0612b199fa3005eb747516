package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function getItemStats() : void
      {
         ...
         this.var_2377 = _loc2_;
         this.var_2375 = this.var_224.type;
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         {
            case 1:
               this._view.showMakeOffer(this.var_224);
               break;
            case 2:
            ...
            case 3:
               ...
               break;
            case 4:
               this._view.showBuyTokens(this.var_1869,this.var_1868);
         }
      }
      ...
      {
         if(param1 != this.var_2377 || param2 != this.var_2375)
         {
            return;
         }
         if(!this._view)
         ...
         this._view.updateAveragePrice(param3,this.var_2379);
      }
