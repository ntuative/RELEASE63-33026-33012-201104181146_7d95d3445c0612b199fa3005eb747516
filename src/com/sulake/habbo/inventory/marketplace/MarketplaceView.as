package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceView implements IGetImageListener
   {
      ...
      private var var_68:MarketplaceModel;
      ...
      {
         var _loc4_:* = null;
         if(!param1 || !this._localization || !this._roomEngine || !this.var_68)
         {
            return;
         }
         ...
         this.checkPrice();
         this._localization.registerParameter("inventory.marketplace.make_offer.expiration_info","time",this.var_68.expirationHours.toString());
         this._localization.registerParameter("inventory.marketplace.make_offer.min_price","minprice",this.var_68.offerMinPrice.toString());
         this._localization.registerParameter("inventory.marketplace.make_offer.max_price","maxprice",this.var_68.offerMaxPrice.toString());
         ...
         this.var_2839 = this._localization.getKey(_loc5_);
      ...
      {
         this._localization.registerParameter("inventory.marketplace.confirm_offer.info","furniname",this.var_2839);
         this._localization.registerParameter("inventory.marketplace.confirm_offer.info","price",this.var_2041.toString());
      ...
      private function confirmationCallback(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            this.var_68.makeOffer(this.var_2041);
         }
         this.var_68.releaseItem();
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "buy_tokens_button":
                  this.var_68.buyMarketplaceTokens();
                  this.disposeView();
                  break;
               ...
               case "make_offer_button":
                  ...
                  if(_loc3_ != null)
                  {
                     this.var_2041 = parseInt(_loc3_.text);
      ...
      {
         var _loc1_:* = null;
         if(false && "InfoStandSongDiskView" == this._config.getKey("client.credits.embed.enabled"))
         {
      ...
      private function checkPrice() : void
      {
         ...
         if(_loc2_ > this.var_68.offerMaxPrice)
         {
            _loc1_.text = this.var_68.offerMaxPrice.toString();
            _loc2_ = this.var_68.offerMaxPrice;
         }
         var _loc3_:int = Math.max(Math.ceil(this.var_68.commission * 0.01 * _loc2_),1);
         ...
         if(_loc2_ < this.var_68.offerMinPrice)
         {
      ...
      {
         if(!this._view || !this._localization || !this.var_68)
         {
            return;
         }
         ...
         var _loc4_:int = Math.floor(param1 / (1 + this.var_68.commission * 0.01));
