package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1025:uint = 4284532064;
      
      private static const const_1024:uint = 2577770;
      
      public static const const_1208:int = 0;
      ...
      private var var_652:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_652 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1875 = this.createMinimizedWindow();
         }
         if(!this.var_2592)
         {
            return this.var_70;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_70)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_18.ownUserAccepts ? uint(const_1025) : uint(const_1024);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_18.otherUserAccepts ? uint(const_1025) : uint(const_1024);
            }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1590)
            {
            ...
            this.var_652.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_457);
            this.var_652.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_652.hideDelayed();
         }
      }
      ...
      private function getTraxSongFurniName(param1:GroupItem, param2:String, param3:Boolean, param4:uint = 1.0, param5:Boolean = false) : String
      {
         ...
         else if(param3)
         {
            ...
            this.var_184.push(param4);
            this.var_184.push(param1);
            this.var_184.push(param5);
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_184.length > 0)
         {
            _loc2_ = this.var_184.pop();
            _loc3_ = this.var_184.pop();
            _loc4_ = uint(this.var_184.pop());
            _loc5_ = _loc3_.peek();
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_18.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_18.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_652.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_457);
               }
            }
            else
            {
               this.var_184.push(_loc4_);
               this.var_184.push(_loc3_);
