package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1641:uint = 9;
      
      public static const const_188:uint = 0;
      
      public static const const_204:uint = 1;
      
      public static const const_364:uint = 2;
      
      public static const const_315:uint = 3;
      
      public static const const_566:uint = 4;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_58.updateItemList(this.var_834);
         this.var_58.updateItemList(this.var_1536);
      ...
      public function close() : void
      {
         if(this.var_842)
         {
            if(this._state != const_188 && this._state != const_265)
            {
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_835 + " OTHER: " + this.var_1262);
         ...
         {
            case const_188:
               if(param1 == const_204 || param1 == const_265)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_58.alertPopup(TradingView.const_1176);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_834)
            {
               this.var_835 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1262 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_58.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_834)
            {
               this.var_58.alertPopup(TradingView.const_1267);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_271.length < const_1641)
         {
         ...
         else
         {
            ...
            if(param3 == FurniCategory.const_198)
            {
