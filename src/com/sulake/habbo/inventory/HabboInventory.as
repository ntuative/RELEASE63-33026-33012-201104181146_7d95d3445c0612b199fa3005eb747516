package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2110:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_16 != null)
         {
            ...
            this.var_16.events.removeEventListener(RoomSessionEvent.const_90,this.roomSessionEventHandler);
            this.var_16.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_589,this.roomSessionEventHandler);
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_53.getValue(InventorySubCategory.const_318));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_53.getValue(InventoryCategory.const_820));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_53.getValue(InventoryCategory.const_327));
      }
      ...
      public function get achievementsModel() : AchievementsModel
      {
         ...
         return AchievementsModel(this.var_53.getValue(InventoryCategory.const_395));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_53.getValue(InventoryCategory.const_143));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_53.getValue(InventoryCategory.const_399) as MarketplaceModel;
      }
      ...
      {
         this.var_434 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionEvent.const_90,this.roomSessionEventHandler);
         this.var_16.events.addEventListener(RoomSessionPropertyUpdateEvent.const_589,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_90:
               this.var_1102 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_589:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_434 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_16 || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_53.add(InventoryCategory.const_399,_loc1_);
         ...
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_434);
         this.var_53.add(InventoryCategory.const_327,_loc3_);
         ...
         this.var_53.add(InventoryCategory.const_820,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_434);
         this.var_53.add(InventoryCategory.const_395,_loc5_);
         ...
         this.var_53.add(InventorySubCategory.const_318,_loc6_);
         ...
         this.var_53.add(InventoryCategory.const_143,_loc8_);
         this.var_194 = true;
         if(this.var_2866)
         {
            this.requestData();
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_318:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_1058.indexOf(param1) == -1)
            {
               this.var_1058.push(param1);
            }
         }
         else
         {
            _loc3_ = this.var_1058.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_1058.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_1058.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2110);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_739));
      }
