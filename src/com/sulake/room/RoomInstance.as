   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_281 != null)
         {
            ...
            {
               _loc3_ = this.var_281.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         {
            for(_loc1_ in this.var_638)
            {
               delete this.var_638[_loc1_];
            }
            this.var_638 = null;
         }
      ...
      {
         if(this.var_1470.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         {
            this.var_1470.push(param1);
         }
         if(this.var_638[param1] != param2)
         {
            this.var_638[param1] = param2;
         }
      }
      ...
      {
         if(this.var_1471.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
      ...
      public function update() : void
      {
         ...
         var _loc2_:int = this.var_586.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = int(this.var_586[_loc2_]);
      ...
      {
         return this.var_281.getKeys();
      }
      
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         var _loc2_:String = String(param1);
         if(this.var_281.getValue(_loc2_) != null)
         {
            return this.var_281.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
      ...
      {
         return this.var_281.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_281.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_281.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
