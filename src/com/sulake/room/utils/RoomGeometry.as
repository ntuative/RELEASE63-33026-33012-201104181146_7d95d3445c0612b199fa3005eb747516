package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_1221:Number = 32;
      ...
      private var var_438:Number = 1.0;
      ...
      private var var_1848:Number = 1.0;
      
      private var var_93:Vector3d;
      
      private var var_439:Vector3d;
      
      private var var_2930:Number = -500.0;
      
      private var var_2931:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1194 = new Vector3d();
         this.var_440 = new Vector3d();
         this._direction = new Vector3d();
         this.var_1195 = new Vector3d();
         this.var_1849 = 1;
         this.var_1850 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1848 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_440.assign(this.var_93);
         this.var_440.x *= this.var_438;
         this.var_440.y *= this.var_436;
         this.var_440.z *= this.var_437;
         return this.var_440;
      }
      ...
      {
         if(this.var_438 != param1 * this.var_1849)
         {
            this.var_438 = param1 * this.var_1849;
            ++this.var_165;
         }
      }
      ...
      {
         if(this.var_436 != param1 * this.var_1850)
         {
            this.var_436 = param1 * this.var_1850;
            ++this.var_165;
         }
      }
      ...
      {
         if(this.var_437 != param1 * this.var_1848)
         {
            this.var_437 = param1 * this.var_1848;
            ++this.var_165;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_93.x;
         var _loc3_:Number = this.var_93.y;
         var _loc4_:Number = this.var_93.z;
         this.var_93.assign(param1);
         this.var_93.x /= this.var_438;
         this.var_93.y /= this.var_436;
         this.var_93.z /= this.var_437;
         if(this.var_93.x != _loc2_ || this.var_93.y != _loc3_ || this.var_93.z != _loc4_)
         {
            ++this.var_165;
         }
      }
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_439.x;
         var _loc3_:Number = this.var_439.y;
         var _loc4_:Number = this.var_439.z;
         this.var_439.assign(param1);
         this._direction.assign(param1);
         if(this.var_439.x != _loc2_ || this.var_439.y != _loc3_ || this.var_439.z != _loc4_)
         {
            ++this.var_165;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_151.assign(_loc24_);
            this.var_152.assign(_loc25_);
            this.var_1194.assign(this.var_152);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_151.assign(_loc19_);
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1195.assign(_loc22_);
         }
         else
         {
            this.var_1195.assign(_loc17_);
         }
         ++this.var_165;
      }
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(param1,this.var_151);
      ...
      {
         var _loc2_:Vector3d = Vector3d.dif(param1,this.var_93);
         _loc2_.x *= this.var_438;
         _loc2_.y *= this.var_436;
         _loc2_.z *= this.var_437;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1195);
         if(_loc3_ < this.var_2930 || _loc3_ > this.var_2931)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.scalarProjection(_loc2_,this._x);
         var _loc5_:Number = -Vector3d.scalarProjection(_loc2_,this.var_151);
         _loc4_ *= this._scale;
         _loc5_ *= this._scale;
         var _loc6_:IVector3d = this.getDisplacenent(param1);
         if(_loc6_ != null)
         {
            _loc2_ = Vector3d.dif(param1,this.var_93);
            _loc2_.add(_loc6_);
            _loc2_.x *= this.var_438;
            _loc2_.y *= this.var_436;
            _loc2_.z *= this.var_437;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1195);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         _loc7_.add(Vector3d.product(this.var_151,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_93.x * this.var_438,this.var_93.y * this.var_436,this.var_93.z * this.var_437);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_152;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_438,param2.y * this.var_436,param2.z * this.var_437);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_438,param3.y * this.var_436,param3.z * this.var_437);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_438,param4.y * this.var_436,param4.z * this.var_437);
