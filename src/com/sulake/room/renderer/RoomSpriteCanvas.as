package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_359:int = 50;
      
      private static const const_1357:int = 50;
      
      private static const const_1003:Number = 60;
      
      private static const const_1358:Number = 50;
      ...
      private var var_618:RoomObjectCache;
      ...
      private var var_2416:Number = -1.0E7;
      
      private var var_2420:Number = -1.0E7;
      ...
      private var var_708:ColorTransform;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_253.addChild(this.var_98);
         ...
         this.var_618 = new RoomObjectCache(_loc6_);
         this.var_708 = new ColorTransform();
      ...
      {
         this.var_514.x -= param1 - this.var_616;
         this.var_616 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_514.y -= param1 - this.var_620;
         this.var_620 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_959 = true;
            if(this.var_134 != null && !this.var_253.contains(this.var_134))
            {
               this.var_253.addChild(this.var_134);
               this.var_98.mask = this.var_134;
            }
         }
         else if(!param1 && this.var_959)
         {
            ...
            if(this.var_134 != null && this.var_253.contains(this.var_134))
            {
               this.var_253.removeChild(this.var_134);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_621.length)
            {
               this.cleanSprite(this.var_621[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_621 = [];
         }
      ...
      {
         this.var_618.removeObjectCache(param1);
      }
      
      public function render(param1:int) : void
      {
         this.var_1761 = !this.var_1761;
         if(this._container == null || this._geometry == null)
         {
            return;
         }
         if(param1 == this.var_1422)
         {
            return;
         }
         ...
         if(this.var_512 != this.var_2418 || this.var_515 != this.var_2415)
         {
            _loc8_ = true;
         }
         if(this.var_98.x != this.var_616 || this.var_98.y != this.var_620)
         {
            this.var_98.x = this.var_616;
            this.var_98.y = this.var_620;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_2418 = this.var_512;
         this.var_2415 = this.var_515;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1422 > 0)
         {
            _loc2_ = param1 - this.var_1422;
            if(_loc2_ > const_1003 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2414 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_766;
               if(this.var_766 == const_359 + 1)
               {
                  this.var_540 = _loc2_;
                  this.var_1759 = this.var_2417;
               }
               else if(this.var_766 > const_359 + 1)
               {
                  _loc3_ = Number(this.var_766 - const_359);
                  this.var_540 = this.var_540 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_1759 = this.var_1759 * (_loc3_ - 1) / _loc3_ + Number(this.var_2417) / _loc3_;
                  if(this.var_766 > const_359 + const_1357)
                  {
                     this.var_766 = const_359;
                     if(!this.var_1159 && this.var_540 > const_1003)
                     {
                        this.var_1159 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1159 && this.var_540 < const_1358)
                     {
                        this.var_1159 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_618.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_618.getObjectCache(param2);
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_1761 && this.var_1159);
         ...
         _loc13_ += int(this.var_512 / 2);
         _loc14_ += int(this.var_515 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
      ...
      {
         if(param1 < this.var_512 && param1 + param3 >= 0 && (param2 < this.var_515 && param2 + param4 >= 0))
         {
            if(!this.var_2926)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param1 + param3 >= this.var_512)
         {
            param3 -= this.var_512 + 1 - (param1 + param3);
         }
         if(param2 + param4 >= this.var_515)
         {
            param4 -= this.var_515 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2419)
         {
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(this.var_621.length > 0)
         {
            _loc3_ = this.var_621.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_767 || this.var_767 == 0)
         {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_708.redMultiplier = tR;
            this.var_708.greenMultiplier = tG;
            this.var_708.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_708);
            if(name.length > 0)
            {
               this.var_252.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         if(this.var_1158 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1758;
         }
         this.var_1758 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1158;
         return this.var_1758;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_512 / 2;
         var _loc12_:Number = param2 - this.var_515 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1760,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_619.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                        if(_loc13_.method_1 != _loc16_)
                        {
                           _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.method_1,param4,param5,param6,param7);
                           this.bufferMouseEvent(_loc11_,_loc9_);
                        }
                     }
                     if(param3 == MouseEvent.MOUSE_MOVE && (_loc13_ == null || _loc13_.method_1 != _loc16_))
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_619.add(_loc9_,_loc13_);
                     }
                     _loc13_.method_1 = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2416 || param2 != this.var_2420)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_619.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_619.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.method_1,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      {
         if(this.var_356 != null && param1 != null)
         {
            this.var_356.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_356 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         while(_loc1_ < this.var_356.length)
         {
            _loc2_ = this.var_356.getKey(_loc1_);
            _loc3_ = this.var_356.getWithIndex(_loc1_);
