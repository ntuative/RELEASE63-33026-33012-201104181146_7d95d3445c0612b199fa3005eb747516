package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1565:int = 128;
      
      private var var_1564:Boolean = false;
      
      private var var_2943:Point;
      ...
      {
         if(param1 != this.var_2029 || param2 != this.var_2030)
         {
            this.var_2029 = param1;
            this.var_2030 = param2;
            return true;
         }
      ...
      {
         if(this.var_1565 > 255 || bitmapData == null)
         {
            return false;
         }
