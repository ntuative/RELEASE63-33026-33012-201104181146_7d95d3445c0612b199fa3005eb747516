package com.sulake.room.object
{
   ...
   public class RoomObjectModel implements IRoomObjectModelController
   {
      ...
      public function dispose() : void
      {
         ...
         {
            for(_loc1_ in this.var_640)
            {
               delete this.var_640[_loc1_];
            }
            this.var_640 = null;
         }
         if(this.var_639 != null)
         {
            for(_loc1_ in this.var_639)
            {
               delete this.var_639[_loc1_];
            }
            this.var_639 = null;
         }
         this.var_1471 = [];
      ...
      {
         var _loc2_:Array = this.var_640[param1];
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.slice();
         }
      ...
      {
         var _loc2_:Array = this.var_639[param1];
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.slice();
         }
      ...
      public function setNumberArray(param1:String, param2:Array, param3:Boolean = false) : void
      {
         ...
         var _loc6_:Array = this.var_640[param1];
      ...
      public function setStringArray(param1:String, param2:Array, param3:Boolean = false) : void
      {
         ...
         var _loc6_:Array = this.var_639[param1];
         var _loc7_:Boolean = true;
         if(_loc6_ != null && _loc6_.length == _loc4_.length)
         {
            _loc5_ = _loc4_.length - 1;
