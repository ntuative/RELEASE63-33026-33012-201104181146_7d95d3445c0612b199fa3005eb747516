package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      protected var var_473:int = -1;
      
      protected var var_172:int = -1;
      
      protected var var_88:int = -1;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_202 != null)
         {
            ...
            {
               _loc1_ = this.var_202[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_751.removeReference();
         }
         this.var_751 = param1;
         if(this.var_751 != null)
         {
            this.var_751.addReference();
         }
      }
      ...
      {
         var _loc2_:* = null;
         while(this.var_202.length > param1)
         {
            _loc2_ = this.var_202[this.var_202.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         if(param1 >= 0 && param1 < this.var_202.length)
         {
