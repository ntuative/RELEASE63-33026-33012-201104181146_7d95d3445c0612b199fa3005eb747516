package com.sulake.core.utils
{
   ...
   public class LibraryLoaderQueue extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1487:int = 4;
      ...
      {
         return this.var_424.length + this.var_283.length;
      }
      ...
      private function next() : void
      {
         ...
         if(!disposed)
         {
            while(this.var_283.length < const_1487 && this.var_424.length > 0)
            {
               _loc1_ = this.var_424.shift();
      ...
      private function removeLoader(param1:LibraryLoader) : void
      {
         ...
         try
         {
            index = this.var_424.indexOf(loader);
            if(index > -1)
            {
               this.var_424.splice(index,1);
            }
