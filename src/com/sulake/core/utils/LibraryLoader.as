package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1774:uint = 1;
      
      protected static const const_1776:uint = 2;
      
      protected static const const_1773:uint = 4;
      
      protected static const const_1775:uint = 3;
      
      protected static const name_4:uint = 7;
      
      public static const const_1592:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_1277:Boolean = false;
      
      public static const const_1487:int = 2;
      
      private static var var_972:Array = new Array();
      
      private static var var_788:Array = new Array();
      ...
      protected var var_666:Class;
      
      protected var var_475:uint = 0;
      ...
      protected var var_1079:Boolean = false;
      
      protected var var_2901:String = "";
      
      protected var var_2902:String = "";
      ...
      protected var var_2979:uint = 0;
      
      protected var var_2900:Boolean = true;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1277)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_788[_loc2_] as LibraryLoader;
               if(_loc1_ && (_loc1_.ready || _loc1_.disposed))
               {
                  var_788.splice(_loc2_,1);
               }
               _loc2_--;
            }
            while(var_788.length < const_1487 && false)
            {
               _loc1_ = var_972.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1078 ? uint(this.var_1333 - this.var_2127) : uint(getTimer() - this.var_2127);
      }
      ...
      {
         if(this.var_1079 && !_disposed)
         {
            this.var_1079 = false;
            if(!this.var_1078 && this.var_239)
            {
               this.var_1333 = -1;
               this.var_2127 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_1078 && !_disposed && this.var_1334 > 0)
         {
            try
            {
               this.var_43.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_239,const_1592 - this.var_1334);
            if(this.var_2900)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_475 = LibraryLoader.name_4;
         ...
         if(this.var_475 == LibraryLoader.const_1775)
         {
         ...
         if(this.var_475 == LibraryLoader.name_4)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_666 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_666.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
