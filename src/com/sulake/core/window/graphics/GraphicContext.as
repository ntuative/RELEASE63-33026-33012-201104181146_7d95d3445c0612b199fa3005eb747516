package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1981:uint = 64;
      
      public static const const_1872:uint = 128;
      
      public static const GC_TYPE_DESKTOP:uint = 256;
      
      protected static var var_576:uint = 0;
      ...
      protected var var_874:Boolean;
      
      protected var _disposed:Boolean = false;
      
      protected var var_11:Rectangle;
      
      protected var var_195:Shape;
      ...
      public function setDrawRegion(param1:Rectangle, param2:Boolean, param3:Rectangle) : void
      {
         ...
         if(param3)
         {
            if(!this.var_195)
            {
               this.var_195 = new Shape();
               this.var_195.visible = false;
               this.var_195.cacheAsBitmap = true;
               super.addChild(this.var_195);
            }
            this.var_195.graphics.clear();
            this.var_195.graphics.beginFill(255);
            this.var_195.graphics.drawRect(param3.x,param3.y,param3.width,param3.height);
            this.var_195.graphics.endFill();
            this.getDisplayObject().mask = this.var_195;
         }
         else if(this.var_195)
         {
            super.removeChild(this.var_195);
            this.var_195.graphics.clear();
            this.var_195 = null;
         ...
         if(this.var_874)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2126,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2126,16777215);
                  }
                  var_333 += bitmap.width * bitmap.height * 4;
               }
