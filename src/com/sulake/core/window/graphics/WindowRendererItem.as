package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_647:uint = 0;
      
      private static const const_1013:uint = 1;
      ...
      private var var_1077:Matrix;
      
      private var var_708:ColorTransform;
      
      private var var_1463:uint;
      ...
      public function WindowRendererItem(param1:WindowRenderer, param2:DrawBufferAllocator, param3:ISkinContainer)
      {
         ...
         this.var_1463 = 4294967295;
         this.var_963 = 0;
         this.var_708 = new ColorTransform();
         this.var_1077 = new Matrix();
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc5_:uint = !!param1.background ? uint(const_1012) : uint(const_647);
         var _loc6_:Boolean = this.var_179.width > 0 && this.var_179.height > 0;
         var _loc7_:ISkinRenderer = this.resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_963))
            {
               _loc5_ = const_1013;
            }
         }
         ...
         if(_loc5_ != const_647)
         {
            this.var_1463 = this.var_963;
            _loc4_ = param1.fetchDrawBuffer() as BitmapData;
            if(_loc4_ != null)
            {
               _loc4_.lock();
               if(_loc5_ == const_1013)
               {
                  _loc6_ = true;
                  ...
                  if(this.var_635)
                  {
                     ...
                     _loc7_.draw(param1,this.var_117,this.var_117.rect,this.var_963,false);
                  }
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_33))
                  {
                     this.var_1077.tx = param2.x;
                     this.var_1077.ty = param2.y;
                     this.var_708.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_117,this.var_1077,this.var_708,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         return this._skinContainer.getTheActualState(param1.type,param1.style,param1.state) != this.var_1463;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.const_1165:
               ...
               break;
            case WindowRedrawFlag.const_793:
               this.var_963 = this._skinContainer.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_963 != this.var_1463)
               {
                  this.var_635 = true;
                  _loc4_ = true;
               }
