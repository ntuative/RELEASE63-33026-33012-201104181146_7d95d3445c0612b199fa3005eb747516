package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_401:Dictionary;
      
      protected var _templatesByState:Dictionary;
      
      protected var var_571:Dictionary;
      ...
      public function SkinRenderer(param1:String)
      {
         super();
         this._name = param1;
         this.var_401 = new Dictionary();
         this._templatesByState = new Dictionary();
         this.var_571 = new Dictionary();
         this.var_474 = new Dictionary();
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_571)
            {
               ISkinLayout(this.var_571[_loc1_]).dispose();
               delete this.var_571[_loc1_];
            }
            this.var_571 = null;
            this.var_474 = null;
            for(_loc1_ in this.var_401)
            {
               ISkinTemplate(this.var_401[_loc1_]).dispose();
      ...
      {
         var _loc3_:ISkinTemplate = this.var_401[param2];
         if(_loc3_ == null)
         {
      ...
      {
         this.var_571[param1.name] = param1;
         return param1;
      }
      ...
      public function removeLayout(param1:ISkinLayout) : ISkinLayout
      {
         var _loc2_:* = null;
         var _loc3_:* = 0;
         param1 = this.var_401[param1.name];
         if(param1 != null)
         {
            for(_loc2_ in this.var_474)
            {
               _loc3_ = uint(_loc2_ as uint);
               if(this.var_474[_loc3_] == param1)
               {
                  this.removeLayoutFromRenderState(_loc3_);
               }
            }
            delete this.var_571[param1.name];
         }
         return param1;
      }
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            ...
            delete this.var_401[param1.name];
         }
         return param1;
      }
   }
