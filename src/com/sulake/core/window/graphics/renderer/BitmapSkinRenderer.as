package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      private static var var_28:Rectangle = new Rectangle();
      
      private static const TOP_LEFT:Point = new Point();
       
      
      protected var var_869:Dictionary;
      
      protected var var_868:Dictionary;
      
      private var var_241:Matrix;
      ...
      {
         super(param1);
         this.var_869 = new Dictionary(false);
         this.var_868 = new Dictionary(false);
         this.var_241 = new Matrix();
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            this.var_241 = null;
            this.var_708 = null;
            for(_loc1_ in this.var_869)
            {
               _loc2_ = this.var_869[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_869[_loc1_];
            }
            this.var_869 = null;
            for(_loc1_ in this.var_868)
            {
               _loc2_ = this.var_868[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_868[_loc1_];
            }
            this.var_868 = null;
         }
      }
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         var _loc7_:ISkinLayout = var_474[param4];
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            if(_loc16_)
            {
               this.var_708.redMultiplier = ((param1.color & 16711680) >> 16) / 255;
               this.var_708.greenMultiplier = ((param1.color & 65280) >> 8) / 255;
               this.var_708.blueMultiplier = (param1.color & 255) / 255;
               this.var_708.alphaMultiplier = 1;
            }
            _loc17_ = 0;
            while(_loc17_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc16_ && _loc10_.colorize)
                  {
                     ...
                     _loc18_.colorTransform(_loc18_.rect,this.var_708);
                  }
                  _loc12_ = false;
                  _loc13_ = false;
                  var_28.x = _loc10_.region.x + param3.x;
                  var_28.y = _loc10_.region.y + param3.y;
                  var_28.width = _loc10_.region.width;
                  var_28.height = _loc10_.region.height;
                  if(_loc10_.var_399 == SkinLayoutEntity.const_335)
                  {
                     var_28.x += _loc14_;
                  }
                  else if(_loc10_.var_399 == SkinLayoutEntity.const_587)
                  {
                     _loc12_ = true;
                     var_28.right += _loc14_;
                     if(true)
                     {
                        break;
                     }
                  }
                  else if(_loc10_.var_399 == SkinLayoutEntity.const_347)
                  {
                     _loc12_ = true;
                     var_28.right += _loc14_;
                     if(true)
                  ...
                  if(_loc10_.var_398 == SkinLayoutEntity.const_335)
                  {
                     var_28.y += _loc15_;
                  }
                  else if(_loc10_.var_398 == SkinLayoutEntity.const_587)
                  {
                     _loc13_ = true;
                     var_28.bottom += _loc15_;
                     if(true)
                     {
                        break;
                     }
                  }
                  else if(_loc10_.var_398 == SkinLayoutEntity.const_347)
                  {
                     _loc13_ = true;
                     var_28.bottom += _loc15_;
                     if(true)
                  ...
                  if(!_loc12_ && !_loc13_)
                  {
                     _loc6_.copyPixels(_loc18_,_loc18_.rect,var_28.topLeft,_loc19_,TOP_LEFT,true);
                  }
                  else if(_loc10_.var_398 == SkinLayoutEntity.const_347 || _loc10_.var_399 == SkinLayoutEntity.const_347)
                  {
                     ...
                     _loc24_ = 0 % _loc20_;
                     _loc25_ = 0 % _loc21_;
                     _loc26_ = new Point(var_28.x,var_28.y);
                  ...
                  {
                     this.var_241.a = var_28.width;
                     this.var_241.d = var_28.height;
                     this.var_241.tx = var_28.x;
                     this.var_241.ty = var_28.y;
                     ALPHA.alphaMultiplier = (_loc19_.getPixel32(0,0) >>> 24) / 255;
                     _loc6_.draw(_loc18_,this.var_241,ALPHA);
                  }
                  else
                  {
                     this.var_241.a = 0 / _loc18_.width;
                     this.var_241.d = 0 / _loc18_.height;
                     this.var_241.tx = 0;
                     this.var_241.ty = 0;
                     _loc31_ = new BitmapData(var_28.width,var_28.height,_loc18_.transparent);
                     _loc31_.draw(_loc18_,this.var_241);
                     _loc32_ = new BitmapData(var_28.width,var_28.height,true,0);
                     _loc32_.draw(_loc19_,this.var_241,null);
                     _loc6_.copyPixels(_loc31_,_loc31_.rect,var_28.topLeft,_loc32_,TOP_LEFT,true);
                     _loc32_.dispose();
                     _loc31_.dispose();
                  }
                  if(_loc16_ && _loc10_.colorize)
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.var_399 == SkinLayoutEntity.const_335)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.var_398 == SkinLayoutEntity.const_335)
               {
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = this.var_869[_loc3_];
         if(_loc4_ == null)
         {
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = this.var_868[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
