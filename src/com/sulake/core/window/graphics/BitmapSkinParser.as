package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_100:String = "default";
      
      public static const const_107:String = "active";
      
      public static const const_83:String = "focused";
      
      public static const const_95:String = "hovering";
      
      public static const const_55:String = "selected";
      
      public static const const_92:String = "pressed";
      
      public static const const_85:String = "disabled";
      
      public static const const_71:String = "locked";
      ...
      protected static function parseLayout(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map) : void
      {
         ...
         var _loc6_:* = param2.attribute("transparent") == "InfoStandSongDiskView";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         _loc5_.colorize = _loc6_ == "" ? true : _loc6_ == "InfoStandSongDiskView";
         _loc6_ = null;
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_399 = SkinLayoutEntity.const_474;
                  break;
               case "move":
                  _loc5_.var_399 = SkinLayoutEntity.const_335;
                  break;
               case "strech":
                  _loc5_.var_399 = SkinLayoutEntity.const_587;
                  break;
               case "tiled":
                  _loc5_.var_399 = SkinLayoutEntity.const_347;
                  break;
               case "center":
                  _loc5_.var_399 = SkinLayoutEntity.const_1120;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_398 = SkinLayoutEntity.const_474;
                  break;
               case "move":
                  _loc5_.var_398 = SkinLayoutEntity.const_335;
                  break;
               case "strech":
                  _loc5_.var_398 = SkinLayoutEntity.const_587;
                  break;
               case "tiled":
                  _loc5_.var_398 = SkinLayoutEntity.const_347;
                  break;
               case "center":
                  _loc5_.var_398 = SkinLayoutEntity.const_1120;
            }
         }
      ...
      protected static function parseState(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map) : void
      {
         ...
         switch(_loc5_)
         {
            case BitmapSkinParser.const_107:
               _loc10_ = 0;
               break;
