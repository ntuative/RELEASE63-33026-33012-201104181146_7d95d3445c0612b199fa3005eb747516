package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1043:uint = 8;
      
      private static const const_1444:String = "skin";
      
      private static const const_1446:String = "bitmap";
      
      private static const const_1447:String = "fill";
      
      private static const const_1448:String = "text";
      
      private static const const_1445:String = "label";
      
      private static const const_1443:String = "shape";
      ...
      private var var_2767:Dictionary;
      
      private var var_2765:Dictionary;
      
      private var var_2766:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_1035 = new Dictionary();
         this.var_1034 = new Dictionary();
         this.var_1999 = new Dictionary();
         this.var_2767 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1999,this.var_2767);
         this.var_2765 = new Dictionary();
         this.var_2766 = new Dictionary();
         StateCodeTable.fillTables(this.var_2765,this.var_2766);
         this.var_458 = new Dictionary();
         this.var_458[const_1444] = BitmapSkinRenderer;
         this.var_458[const_1446] = BitmapDataRenderer;
         this.var_458[const_1447] = FillSkinRenderer;
         this.var_458[const_1448] = TextSkinRenderer;
         this.var_458[const_1445] = LabelRenderer;
         this.var_458[const_1443] = ShapeSkinRenderer;
         this.var_458[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_458[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_334 == null)
         {
            var_334 = new Array();
            var_334.push(WindowState.const_71);
            var_334.push(WindowState.const_85);
            var_334.push(WindowState.const_92);
            var_334.push(WindowState.const_55);
            var_334.push(WindowState.const_95);
            var_334.push(WindowState.const_83);
            var_334.push(WindowState.const_107);
            var_334.push(WindowState.const_100);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2888 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  _loc17_.background = !!_loc5_.@background[0] ? _loc5_.@background[0] == "InfoStandSongDiskView" : false;
                  ...
                  this.addSkinRenderer(this.var_1999[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_1035[param1] == null)
         {
            this.var_1035[param1] = new Array(const_1043);
         }
         this.var_1035[param1][param2] = param3;
         if(this.var_1034[param1] == null)
         {
            this.var_1034[param1] = new Array(const_1043);
         }
         this.var_1034[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1035[param1];
         if(_loc3_)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1034[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_179)
