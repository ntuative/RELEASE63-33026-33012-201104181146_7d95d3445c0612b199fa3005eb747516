package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1415:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1416:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_163:IProfiler;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_163 = this.profiler;
         this._windowManager = param2;
         this._windowRenderer = param3;
         var _loc4_:ByteArray = new var_1415() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_163)
         {
            this.var_163.removeStopEventListener(this.refresh);
            this.var_163 = null;
         }
         if(!this.var_163 && param1)
         {
            this.var_163 = param1;
            this.var_163.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_480)
            {
               this.var_1738 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_163.getProfilerAgentsInArray();
         ...
         if(this.var_1738)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_163.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_163.numBitmapAssetInstances + " / " + this.var_163.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this._windowRenderer.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_163.numTrackedBitmapDataInstances + " / " + this.var_163.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1416() as ByteArray;
