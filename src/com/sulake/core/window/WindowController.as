package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1182:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      protected static const const_1281:String = "_COLORIZE";
      
      protected static const const_1280:String = "_IGNORE_INHERITED_STYLE";
      
      private static const const_1014:Point = new Point();
      ...
      protected var var_701:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_362 = new Rectangle();
         if(_loc12_ != null)
         {
            var_403 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_63 = var_403.clone();
            var_11 = var_403.clone();
         ...
         if(_loc13_)
         {
            var_805 = _loc13_.blend;
            var_478 = _loc13_.var_2888;
      ...
      public static function resizeToAccommodateChildren(param1:WindowController, param2:Boolean = true) : void
      {
         ...
         if(_loc9_)
         {
            ...
            if(param2)
            {
               ...
               while(_loc3_ < _loc10_)
               {
                  _loc12_ = param1.testParamFlag(WindowParam.const_104);
                  if(_loc12_)
                  {
                     param1.setParamFlag(WindowParam.const_104,false);
                  }
                  param1.offset(-_loc4_,-_loc5_);
                  if(_loc12_)
                  {
                     param1.setParamFlag(WindowParam.const_104,true);
                  }
                  _loc3_++;
               }
            }
      ...
      {
         return this.var_701 != null ? this.var_701 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_479 = param1;
         var_240 = !!var_479 ? uint(var_240 | var_574) : uint(var_240 & 16777215);
         this.var_174 = this.var_174 || param1;
         _context.invalidate(this,var_11,WindowRedrawFlag.const_60);
      }
      
      public function set color(param1:uint) : void
      {
         var_574 = param1 & 4278190080;
      ...
      {
         var_574 = param1 << 24;
         var_240 = !!var_479 ? uint(var_574 | var_240) : uint(16777215 & var_240);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_60);
      }
      
      public function set blend(param1:Number) : void
      {
         var_805 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         _context.invalidate(this,var_11,WindowRedrawFlag.const_1151);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            _context.invalidate(this,var_11,WindowRedrawFlag.const_793);
         }
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         if(param1 != var_78)
         {
            ...
            while(--_loc3_ > -1)
            {
               ...
               if(_loc4_.tags.indexOf(const_1280) == -1)
               {
                  _loc4_.style = var_78;
               }
            }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_362 = this._parent.rectangle.clone();
               var_63.x = var_11.x;
               var_63.y = var_11.y;
               var_63.width = var_11.width;
               var_63.height = var_11.height;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_466,this,this._parent);
            ...
            else
            {
               this.var_362.x = 0;
               this.var_362.y = 0;
               this.var_362.width = 0;
               this.var_362.height = 0;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_1533,this,_loc2_);
               this.update(this,_loc4_);
            }
            _loc4_.recycle();
         }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_78,var_20,_context,var_11,null,this.var_701,this.properties,var_879.concat(),_id) as WindowController;
         _loc2_.var_478 = var_478;
         _loc2_.var_174 = this.var_174;
         _loc2_._debug = this._debug;
         _loc2_.var_362 = this.var_362.clone();
         _loc2_.var_11 = var_11.clone();
         _loc2_.var_403 = var_403.clone();
         ...
         _loc2_.var_574 = var_574;
         _loc2_.var_702 = var_702;
         _loc2_.var_300 = var_300;
         _loc2_.var_805 = var_805;
      ...
      override public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            if(true)
            {
               ...
               {
                  if(this.getStateFlag(WindowState.const_107))
                  {
                     this.deactivate();
                  }
               }
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2503 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_574)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_571)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            _loc7_ = uint(var_20 & 0);
            if(_loc7_ == WindowParam.const_464)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_590)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_1066,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_234,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
            if(_loc6_)
      ...
      public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = 0;
         if(!testParamFlag(WindowParam.const_669))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_42:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1175;
                  if(testParamFlag(WindowParam.const_434))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_281))
                        {
               ...
               case WindowMouseEvent.const_52:
                  ...
                  if(testParamFlag(WindowParam.const_281))
                  {
         ...
         else if(param2 is WindowEvent)
         {
            switch(param2.type)
            {
               case WindowEvent.const_41:
                  ...
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_716,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(testParamFlag(WindowParam.const_200,WindowParam.const_167))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_207,WindowParam.const_171))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        _loc6_ = uint(var_20);
                        var_20 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_570))
                        {
                        ...
                        var_20 = _loc6_;
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_150,this._parent,this);
               ...
               case WindowEvent.const_234:
                  _context.invalidate(this,var_11.union(var_63),WindowRedrawFlag.const_1165);
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1543,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_214,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
               ...
               case WindowEvent.const_528:
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1180,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_295,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
               ...
               case WindowEvent.const_466:
                  ...
                  _context.invalidate(this,var_11,WindowRedrawFlag.const_60);
                  break;
               case WindowEvent.const_716:
                  this._parent.getRegionProperties(null,this.var_362);
                  this.updateScaleRelativeToParent();
                  break;
               case WindowEvent.const_544:
         ...
         if(this.var_174 && var_478 > 0)
         {
            if(!testParamFlag(WindowParam.const_33))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(const_1014,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(const_1014,param3,param1)) : false;
            }
         }
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         var _loc7_:*;
         var_78 = !!param2 ? (_loc7_ = var_78 | param1, var_78 |= param1, uint(_loc7_)) : (_loc7_ = var_78 & ~param1, var_78 &= ~param1, uint(_loc7_));
         if(var_78 != _loc3_)
         {
            _loc4_ = new Array();
            ...
            while(--_loc5_ > -1)
            {
               ...
               if(_loc6_.tags.indexOf(const_1280) == -1)
               {
                  _loc6_.style = var_78;
               }
            }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_152,WindowParam.const_167);
         var _loc2_:* = !testParamFlag(WindowParam.const_158,WindowParam.const_171);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_362.width;
               _loc5_ = uint(var_20 & 0);
               if(_loc5_ == WindowParam.const_382)
               {
                  _loc3_.width += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_392)
               {
                  _loc3_.x += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_200)
               {
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_362.height;
               _loc5_ = uint(var_20 & 0);
               if(_loc5_ == WindowParam.const_324)
               {
                  _loc3_.height += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_227)
               {
                  _loc3_.y += _loc4_;
               }
      ...
      public function destroy() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1690,this,null);
         ...
         _loc1_.recycle();
         _loc1_ = WindowEvent.allocate(WindowEvent.const_301,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         this.dispose();
         return true;
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1602,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1492,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function maximize() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1696,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_71,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1550,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      {
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1521,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1485,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_107,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_528,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1634,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_107,false);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_455,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1762,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_71,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1575,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1480,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_71,false);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1585,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_830,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_903,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_203,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function focus() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1744,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_290,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unfocus() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1586,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1600,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1183 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc3_:WindowEvent = WindowEvent.allocate(WindowEvent.const_544,this,param1);
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1183 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_544,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
      ...
      public function method_4(param1:String) : IWindow
      {
         var _loc2_:* = null;
         for each(_loc2_ in this._children)
         {
      ...
      {
         if(var_879.indexOf(param1) > -1)
         {
            return this;
         }
         var _loc2_:WindowController = WindowController(this.method_4(param1));
         if(_loc2_ == null)
         {
            for each(_loc2_ in this._children)
            {
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_372,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
