package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1610:uint = 500;
      
      protected var var_1340:String = "";
      
      protected var var_1338:Boolean = false;
      
      protected var var_749:Boolean = false;
      ...
      {
         this.var_1340 = param1 == null ? "" : param1;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_749 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_172,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
         {
            _context.handleError(WindowContext.const_387,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_289,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      private function onChangeEvent(param1:Event) : void
      {
         ...
         {
            this.refreshAutoSize();
            windowEvent = WindowEvent.allocate(WindowEvent.const_103,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_784,false,PropertyStruct.const_39,true) : PropertyDefaults.const_1588);
         _loc1_.push(this.var_1338 != PropertyDefaults.const_1218 ? new PropertyStruct(PropertyDefaults.const_908,this.var_1338,PropertyStruct.const_39,true) : PropertyDefaults.const_1483);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1093 ? new PropertyStruct(PropertyDefaults.const_779,_field.selectable,PropertyStruct.const_39,true) : PropertyDefaults.const_1751);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1161 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_39,true) : PropertyDefaults.const_1512);
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_908:
                  this.var_1338 = _loc2_.value as Boolean;
                  if(this.var_1338)
                  {
               ...
               case PropertyDefaults.const_784:
                  ...
                  break;
               case PropertyDefaults.const_1186:
