package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1294:String = "_TITLE";
      
      private static const const_1390:String = "_HEADER";
      
      private static const const_1391:String = "_CONTENT";
      
      private static const const_1392:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1472:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1294) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1472 = findChildByTag(const_1390) as IHeaderWindow;
            if(!this.var_1472)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_193 = findChildByTag(const_1391) as IWindowContainer;
            if(!this.var_193)
            {
      ...
      {
         return findChildByTag(const_1392) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1281,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1078 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc3_:Boolean = testParamFlag(WindowParam.const_233);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_239);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_233,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_233,false);
            }
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_239,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_239,false);
            }
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_280,_loc3_.left,PropertyStruct.const_43,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_262,_loc3_.top,PropertyStruct.const_43,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_240,0 - _loc3_.right,PropertyStruct.const_43,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_241,0 - _loc3_.bottom,PropertyStruct.const_43,_loc2_));
         }
         else
         {
