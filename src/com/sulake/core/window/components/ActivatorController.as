package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      {
         if(param2.type == WindowEvent.const_295)
         {
            this.setActiveChild(param1 as IWindow);
         }
         else if(param2.type == WindowEvent.const_1180)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_873;
         if(this.var_873 != param1)
         {
            if(this.var_873 != null)
            {
               if(!this.var_873.disposed)
               {
                  this.var_873.deactivate();
               }
            }
            this.var_873 = param1;
