package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         this.var_1610 = PropertyDefaults.const_709;
         this.var_1340 = PropertyDefaults.const_408;
         param4 |= 0;
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_408)
         {
            if(param2.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
            {
               param1.context.getWindowServices().getToolTipAgentService().begin(param1);
            }
            else if(param2.type != WindowMouseEvent.const_209)
            {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_408)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_945,param1.toolTipCaption,PropertyStruct.const_56,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1702);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_709)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_794,param1.toolTipDelay,PropertyStruct.const_263,true));
         }
         else
         {
      ...
      {
         this.var_1340 = param1 == null ? "null" : param1;
      }
