package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_453:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_453)
         {
            this.var_453.removeEventListener(WindowEvent.const_257,this.scrollBarEventProc);
            this.var_453.removeEventListener(WindowEvent.const_203,this.scrollBarEventProc);
            this.var_453 = null;
         }
         if(this.var_1243)
         {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_453)
         {
            this.var_453 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_453)
            {
               this.var_453.addEventListener(WindowEvent.const_257,this.scrollBarEventProc);
               this.var_453.addEventListener(WindowEvent.const_203,this.scrollBarEventProc);
            }
         }
         return this.var_453;
      }
      ...
      {
         if(param1.type == WindowEvent.const_257)
         {
            this.showScrollBar();
         }
