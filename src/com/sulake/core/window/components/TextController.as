package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1283:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_878:Number;
      
      protected var var_573:Number;
      
      protected var var_572:Boolean;
      
      protected var var_40:TextMargins;
      
      protected var _autoSize:String = "none";
      
      protected var var_129:Boolean = false;
      
      protected var var_1081:Boolean = false;
      
      private var var_464:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_464,this._explicitStyle);
      ...
      private static function setHtmlText(param1:TextController, param2:String) : void
      {
         ...
         if(param1.var_129)
         {
            param1.context.removeLocalizationListener(param1.var_19.slice(2,param1.var_19.indexOf("}")),param1);
            param1.var_129 = false;
         }
         param1.var_19 = param2;
         if(param1.var_19.charAt(0) == "$" && param1.var_19.charAt(1) == "{")
         {
            param1.context.registerLocalizationListener(param1.var_19.slice(2,param1.var_19.indexOf("}")),param1);
            param1.var_129 = true;
         }
         else if(param1._field != null)
         {
            param1._field.htmlText = param1.var_19;
            param1.refreshTextImage();
         }
      }
      ...
      private static function setTextMarginMap(param1:TextController, param2:Map) : void
      {
         if(param1.var_40)
         {
            param1.var_40.assign(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         }
         else
         {
            param1.var_40 = new TextMargins(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         }
         param1.refreshTextImage();
      }
      ...
      {
         if(param1.var_40 && param1.var_40.left != param2)
         {
      ...
      {
         if(param1.var_40 && param1.var_40.top != param2)
         {
      ...
      {
         if(param1.var_40 && param1.var_40.right != param2)
         {
      ...
      {
         if(param1.var_40 && param1.var_40.bottom != param2)
         {
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_464 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_464,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_201);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_730 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_464);
      }
      ...
      {
         this.var_878 = param1;
         this._field.scrollH = this.var_878 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_878 * this.maxScrollH,this.var_573 * this.maxScrollV,width,height);
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_878 = this.var_878;
         _loc1_.var_573 = this.var_573;
         _loc1_.var_40 = this.var_40.clone(_loc1_.setTextMargins);
         _loc1_._autoSize = this._autoSize;
         _loc1_.var_129 = this.var_129;
         return _loc1_;
      }
      ...
      protected function immediateClickHandler(param1:Event) : void
      {
         ...
         var _loc4_:WindowEvent = WindowMouseEvent.allocate(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this,null,_loc3_.x,_loc3_.y,_loc2_.stageX,_loc2_.stageY,_loc2_.altKey,_loc2_.ctrlKey,_loc2_.shiftKey,_loc2_.buttonDown,_loc2_.delta);
      ...
      protected function refreshTextImage(param1:Boolean = false) : void
      {
         ...
         this.var_572 = true;
         var _loc2_:int = this.var_40.left + this.var_40.right;
         var _loc3_:int = this.var_40.top + this.var_40.bottom;
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_464);
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1101) ? new PropertyStruct(PropertyDefaults.const_913,this._field.antiAliasType,PropertyStruct.const_56,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1198) : PropertyDefaults.const_1734);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1107 ? new PropertyStruct(PropertyDefaults.const_956,this._autoSize,PropertyStruct.const_56,true,PropertyDefaults.const_1091) : PropertyDefaults.const_1481);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_39,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_153,this._field.borderColor != 0));
         ...
         _loc1_.push(new PropertyStruct("font_face",this.defaultTextFormat.font,PropertyStruct.const_56,this.defaultTextFormat.font != _loc2_.fontFamily));
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1270 ? new PropertyStruct(PropertyDefaults.const_1134,this._field.gridFitType,PropertyStruct.const_56,true,PropertyDefaults.const_1185) : PropertyDefaults.const_1507);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_831) ? new PropertyStruct(PropertyDefaults.const_411,this._field.textColor,PropertyStruct.const_153,true) : PropertyDefaults.const_1094);
         _loc1_.push(this.var_464 != TextStyleManager.const_201 ? new PropertyStruct(PropertyDefaults.const_393,this.var_464,PropertyStruct.const_56,true,PropertyDefaults.const_677) : PropertyDefaults.const_1260);
         _loc1_.push(this.var_40.left != PropertyDefaults.const_775 ? new PropertyStruct(PropertyDefaults.const_280,this.var_40.left,PropertyStruct.const_43,true) : PropertyDefaults.const_608);
         _loc1_.push(this.var_40.top != PropertyDefaults.const_689 ? new PropertyStruct(PropertyDefaults.const_262,this.var_40.top,PropertyStruct.const_43,true) : PropertyDefaults.const_542);
         _loc1_.push(this.var_40.right != PropertyDefaults.const_935 ? new PropertyStruct(PropertyDefaults.const_240,this.var_40.right,PropertyStruct.const_43,true) : PropertyDefaults.const_586);
         _loc1_.push(this.var_40.bottom != PropertyDefaults.const_684 ? new PropertyStruct(PropertyDefaults.const_241,this.var_40.bottom,PropertyStruct.const_43,true) : PropertyDefaults.const_518);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1240 ? new PropertyStruct(PropertyDefaults.const_823,this._field.mouseWheelEnabled,PropertyStruct.const_39,true) : PropertyDefaults.const_1677);
         _loc1_.push(new PropertyStruct("max_chars",this._field.maxChars,PropertyStruct.const_43,this._field.maxChars != 0));
         _loc1_.push(new PropertyStruct("multiline",this._field.multiline,PropertyStruct.const_39,this._field.multiline != false));
         _loc1_.push(new PropertyStruct("restrict",this._field.restrict,PropertyStruct.const_56,this._field.restrict != null));
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_125,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_125,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_125,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
