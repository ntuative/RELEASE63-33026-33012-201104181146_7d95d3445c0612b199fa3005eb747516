package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1343:String = "_SELECTOR";
      
      private static const const_1344:String = "_CONTENT";
       
      
      protected var var_1075:ITabSelectorWindow;
      
      protected var var_2123:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1075 = findChildByTag(const_1343) as ITabSelectorWindow;
            if(this.var_1075 != null)
            {
               this.var_1075.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2123 = findChildByTag(const_1344) as IWindowContainer;
         }
      ...
      {
         return !!this.var_749 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1075.numSelectables;
      }
