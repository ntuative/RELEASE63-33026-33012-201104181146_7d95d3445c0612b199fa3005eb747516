package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      {
         return this.var_343 != null;
      }
      
      protected function get textField() : TextField
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_464);
         if(_loc1_)
         {
            _loc1_.text = this._text;
            if(this.var_343 != null)
            {
               _loc1_.textColor = uint(this.var_343);
            }
         }
         return _loc1_;
      }
      ...
      {
         if(this.var_464 != param1.name)
         {
            this.var_464 = param1.name;
            this.refresh();
         }
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2265 = _loc2_.textWidth;
         this.var_2264 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_343 != _loc2_.color : this.var_343 != null && this.var_343 != PropertyDefaults.const_831) ? new PropertyStruct(PropertyDefaults.const_411,this.var_343,PropertyStruct.const_153,true) : PropertyDefaults.const_1094);
         if(this.var_40)
         {
            if(this.var_40.left != PropertyDefaults.const_775)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_280,this.var_40.left,PropertyStruct.const_43,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_608);
            }
            if(this.var_40.top != PropertyDefaults.const_689)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_262,this.var_40.top,PropertyStruct.const_43,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_542);
            }
            if(this.var_40.right != PropertyDefaults.const_935)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_240,this.var_40.right,PropertyStruct.const_43,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_586);
            }
            if(this.var_40.bottom != PropertyDefaults.const_684)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_241,this.var_40.bottom,PropertyStruct.const_43,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_518);
            }
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_411:
                  this.var_343 = _loc2_.value as uint;
                  break;
               case PropertyDefaults.const_280:
