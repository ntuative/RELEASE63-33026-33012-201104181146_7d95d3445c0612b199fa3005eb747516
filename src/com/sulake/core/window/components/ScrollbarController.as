package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1359:String = "increment";
      
      private static const const_1360:String = "decrement";
      
      private static const const_1004:String = "slider_track";
      
      private static const const_644:String = "slider_bar";
       
      
      protected var _offset:Number = 0;
      
      protected var var_700:Number = 0.1;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_17 != null && !this.var_17.disposed)
         {
            ...
            this.var_17.removeEventListener(WindowEvent.const_565,this.onScrollableScrolled);
         }
         this.var_17 = param1;
         if(this.var_17 != null && !this.var_17.disposed)
         {
            this.var_17.addEventListener(WindowEvent.const_41,this.onScrollableResized);
            this.var_17.addEventListener(WindowEvent.const_565,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_939 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_1004) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_644) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_644:
               if(param2.type == WindowEvent.const_214)
               {
                  if(!this.var_1160)
                  {
                     if(this._horizontal)
         ...
         if(param2.type == WindowEvent.const_466)
         {
            if(this.var_17 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_302)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_700;
                  }
                  else
                  {
                     this.scrollV -= this.var_700;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_42 || param1.type == WindowTouchEvent.const_954)
         {
            ...
            else if(param2.name == const_1360)
            {
               if(this.var_17)
               {
                  this.var_1160 = true;
            ...
            else if(param2.name == const_1004)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_644).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
         ...
         if(param1.type == WindowMouseEvent.const_302)
         {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_939) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_939) as IScrollableWindow;
               if(_loc1_)
               {
