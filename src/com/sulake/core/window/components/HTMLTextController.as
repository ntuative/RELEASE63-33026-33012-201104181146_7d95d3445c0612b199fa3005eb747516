package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_1021:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_831:String;
      
      private var var_1254:String = null;
      
      private var var_1974:StyleSheet = null;
      ...
      {
         this.var_831 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1254 == param2)
         {
            return;
         }
         param1.var_1254 = param2;
         param1.var_1974 = null;
         if(param1.var_1254 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1254);
            param1.var_1974 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_772.indexOf(param1) > -1)
         {
            this.var_831 = param1;
         }
      }
      ...
      {
         return this.var_831 == LinkTarget.const_30 ? defaultLinkTarget : this.var_831;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_19);
            _field.styleSheet = this.var_1974;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1098)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_831 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_916,this.var_831,PropertyStruct.const_56,true,PropertyDefaults.const_772));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_916)
            {
               this.var_831 = _loc2_.value as String;
               break;
            }
