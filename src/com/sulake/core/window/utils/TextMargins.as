package com.sulake.core.window.utils
{
   ...
   public class TextMargins implements IMargins, IDisposable
   {
      ...
      {
         return this.var_1049 == 0 && this._right == 0 && this._top == 0 && this.var_1050 == 0;
      }
      ...
      {
         return new TextMargins(this.var_1049,this._top,this._right,this.var_1050,param1);
      }
