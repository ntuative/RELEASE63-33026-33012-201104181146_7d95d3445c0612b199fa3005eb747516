package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_170:IWindowRenderer;
      
      protected var var_82:IDesktopWindow;
      
      protected var var_871:IWindowContextStateListener;
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_332 = new Array();
            var_332[0] = MouseCursorType.const_326;
            var_332[1] = MouseCursorType.const_30;
            var_332[2] = MouseCursorType.const_326;
            var_332[3] = MouseCursorType.const_326;
            var_332[4] = MouseCursorType.const_326;
            var_332[5] = MouseCursorType.const_30;
            var_332[6] = MouseCursorType.const_326;
         }
         if(var_288 == null)
         {
            var_288 = new Array();
            var_288[0] = WindowState.const_107;
            var_288[1] = WindowState.const_83;
            var_288[2] = WindowState.const_95;
            var_288[3] = WindowState.const_71;
            var_288[4] = WindowState.const_55;
            var_288[5] = WindowState.const_92;
            var_288[6] = WindowState.const_85;
         }
      }
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_186;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_64 = state.var_1324 as WindowController;
         this.var_173 = state.var_1323 as WindowController;
         this.var_170 = state.renderer;
         this.var_871 = state.var_1319;
         eventQueue.begin();
         this.var_698.x = -1;
         this.var_698.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_698.x || event.stageY != this.var_698.y)
            {
               ...
               array = new Array();
               this.var_82.groupParameterFilteredChildrenUnderPoint(this.var_698,array,WindowParam.const_31);
            }
            ...
            if(index == 0)
            {
               ...
               {
                  if(this.var_64 != this.var_82 && !this.var_64.disposed)
                  {
                     this.var_64.getGlobalPosition(var_406);
                     tempWindowEvent = WindowMouseEvent.allocate(WindowMouseEvent.const_25,this.var_64,null,event.stageX - 0,event.stageY - 0,event.stageX,event.stageY,event.altKey,event.ctrlKey,event.shiftKey,event.buttonDown,event.delta);
                     this.var_64.update(this.var_64,tempWindowEvent);
                     this.var_64 = WindowController(this.var_82);
               ...
               if(child != null && child.visible)
               {
                  if(event.type == MouseEvent.MOUSE_MOVE)
                  {
                     if(child != this.var_64)
                     {
                        ...
                        {
                           this.var_64.getGlobalPosition(var_406);
                           tempWindowEvent = WindowMouseEvent.allocate(WindowMouseEvent.const_25,this.var_64,child,event.stageX - 0,event.stageY - 0,event.stageX,event.stageY,event.altKey,event.ctrlKey,event.shiftKey,event.buttonDown,event.delta);
                           this.var_64.update(this.var_64,tempWindowEvent);
                           tempWindowEvent.recycle();
                        }
                        if(!child.disposed)
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK)
                  {
                     if(this.var_64 && !this.var_64.disposed)
                     {
                        ...
                        {
                           this.var_871.mouseEventReceived(event.type,this.var_64);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.var_1324 = this.var_64;
         state.var_1323 = this.var_173;
         state.renderer = this.var_170;
         state.var_1319 = this.var_871;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         var _loc5_:BitmapData = this.var_170.getDrawBufferForRenderable(param1);
         if(!param1.validateLocalPointIntersection(_loc4_,_loc5_))
         {
            return null;
         }
         if(param1.testParamFlag(WindowParam.const_591))
         {
