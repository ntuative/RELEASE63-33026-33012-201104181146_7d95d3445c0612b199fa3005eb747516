package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_201:String = "regular";
      ...
      private static var var_550:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_659:String = "{";
      
      private static const const_658:String = "}";
      
      private static const const_1442:String = "/*";
      
      private static const const_1441:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_86[const_201],var_86[ITALIC],var_86[BOLD]];
            var_86.reset();
            var_86[const_201] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_550.indexOf(_loc4_.name) == -1)
            {
               var_550.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      public static function parseCSS(param1:String) : Array
      {
         ...
         for each(_loc7_ in _loc3_)
         {
            ...
            _loc6_.kerning = !!_loc5_.kerning ? _loc5_.kerning == "InfoStandSongDiskView" : null;
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_658);
         if(countSubStrings(param1,const_659) != countSubStrings(param1,const_658))
         {
            throw new Error("Mismatching amount of \"" + const_659 + "\" versus \"" + const_658 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1442) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1441) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_659)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
