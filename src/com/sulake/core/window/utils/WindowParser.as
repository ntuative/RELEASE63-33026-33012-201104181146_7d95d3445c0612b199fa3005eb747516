package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1125:String = "_EXCLUDE";
      
      public static const const_1918:String = "_INCLUDE";
      
      public static const const_2010:String = "_TEMP";
      
      private static const const_1326:String = "layout";
      
      private static const const_987:String = "window";
      
      private static const const_988:String = "variables";
      
      private static const const_989:String = "filters";
      
      private static const const_441:String = "name";
      
      private static const const_1329:String = "style";
      
      private static const const_640:String = "params";
      
      private static const const_1337:String = "tags";
      ...
      private static const const_1323:String = "visible";
      
      private static const const_1324:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1151:String = "blend";
      
      private static const const_1335:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1332:String = "treshold";
      
      private static const const_1325:String = "children";
      
      private static const const_1330:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1333:String = "height_min";
      
      private static const const_1327:String = "height_max";
      
      private static const const_639:String = "InfoStandSongDiskView";
      
      private static const const_181:String = "0";
      ...
      private static const const_1331:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1328:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1330:Dictionary;
      
      protected var var_1329:Dictionary;
      
      protected var var_1071:Dictionary;
      
      protected var var_1605:Dictionary;
      
      protected var var_2120:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         this.var_1329 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1330,this.var_1329);
         this.var_1071 = new Dictionary();
         this.var_1605 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1071,this.var_1605);
         this.var_2120 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1328,const_49);
         return param1.replace(const_1331,const_49);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1330)
            {
               delete this.var_1330[_loc1_];
            }
            for(_loc1_ in this.var_1329)
            {
               delete this.var_1329[_loc1_];
            }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1326)
         {
            _loc8_ = param1.child(const_988);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_989).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1330[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_441,variables,"")));
         style = uint(this.parseAttribute(xml,const_1329,variables,style));
         params = uint(this.parseAttribute(xml,const_640,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1337,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_181));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_181));
         rect.width = Number(this.parseAttribute(xml,name_5,variables,const_181));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_181));
         visible = this.parseAttribute(xml,const_1323,variables,visible.toString()) == const_639;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_640).length() > 0)
         {
            list = xml.child(const_640).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_441,variables,"") as String;
               if(this.var_1071[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_441)) + "\"!");
               }
               params |= this.var_1071[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_49) : const_49;
         caption = unescape(String(this.parseAttribute(xml,const_1324,variables,caption)));
         if(tag != const_49)
         {
            tags = tag.split(const_1334);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_988)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1330,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1333,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1327,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_639;
         blend = Number(this.parseAttribute(xml,const_1151,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1335,variables,window.clipping.toString()) == const_639;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1332,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_989).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_200)
                     {
                        window.x = rect.x;
                     }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_49;
         var _loc3_:String = this.var_1329[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1125) == -1)
                  {
