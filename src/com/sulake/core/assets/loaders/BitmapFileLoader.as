package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_1072 = param2 == null ? "" : param2.url;
         this._type = param1;
         this.var_43 = new Loader();
         this.var_1073 = new LoaderContext();
         this.var_1073.checkPolicyFile = true;
         ...
         {
            this.var_43.load(param2,this.var_1073);
         }
      }
      ...
      {
         this.var_1072 = param1.url;
         var_331 = 0;
         this.var_43.load(param1,this.var_1073);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_331 < var_2905)
            {
               ...
               this.var_43.load(new URLRequest(this.var_1072 + (this.var_1072.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_331),this.var_1073);
               return true;
            }
         }
         return false;
