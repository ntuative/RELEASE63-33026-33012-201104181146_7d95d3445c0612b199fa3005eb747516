package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_577:uint = 0;
      
      protected static var var_494:uint = 0;
      ...
      private var var_1648:AssetTypeDeclaration;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_494 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_107 is BitmapDataAsset)
         {
            ...
            this.var_1487 = BitmapDataAsset(this.var_107).var_1487;
            this.var_1486 = BitmapDataAsset(this.var_107).var_1486;
            if(this._bitmap != null)
            {
               this.var_107 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1487 = _loc4_ == "1" || _loc4_ == "InfoStandSongDiskView";
                  break;
               case "flipV":
                  this.var_1486 = _loc4_ == "1" || _loc4_ == "InfoStandSongDiskView";
                  break;
            }
            _loc2_++;
         }
