package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1138:String = "AssetLibraryReady";
      
      public static const const_768:String = "AssetLibraryLoaded";
      
      public static const const_1607:String = "AssetLibraryUnloaded";
      
      public static const const_1727:String = "AssetLibraryLoadError";
      
      private static const const_441:String = "name";
      
      private static const const_1037:String = "asset";
      
      private static const const_1036:String = "param";
      ...
      private static var var_1952:LazyAssetProcessor = new LazyAssetProcessor();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_546;
         this.var_452 = new Dictionary(false);
         this.var_545 = new Dictionary(false);
         this.var_1011 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_667 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_1035);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1037);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_441);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1036);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_667 + "!");
               }
               _loc15_++;
            }
         }
      ...
      {
         if(this.var_667 == param1.url && this.var_1014)
         {
            if(!this.var_1013 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_666);
            }
            this.var_1013 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1138));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in this.var_1011)
         {
            delete this.var_1011[_loc1_];
         }
         if(this.var_43 != null)
         {
            this.var_43.dispose();
         ...
         this.var_1014 = false;
         this.var_667 = null;
         dispatchEvent(new Event(AssetLibrary.const_1607));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_1011[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1169,this.assetLoadEventHandler);
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1196,this.assetLoadEventHandler);
      ...
      {
         return this.var_168[param1] != null || (this.var_666 != null ? this.var_666[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1952.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_452.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_452[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         return AssetTypeDeclaration(this.var_452[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_452)
         {
            _loc3_ = AssetTypeDeclaration(this.var_452[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_452)
         {
            _loc4_ = AssetTypeDeclaration(this.var_452[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_666 = _loc2_.resource;
         this.var_667 = _loc2_.url;
         if(this.var_1013)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_666);
         }
         this.var_1014 = true;
         dispatchEvent(new Event(AssetLibrary.const_768));
         dispatchEvent(new Event(AssetLibrary.const_1138));
         if(this.var_1013)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1727));
         this.var_43 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1035);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1037);
            _loc5_ = null;
            ...
            while(_loc8_ < _loc7_)
            {
               ...
               if(_loc3_.attribute(const_441).toString() == param1)
               {
                  _loc4_ = this.getAssetTypeDeclarationByMimeType(_loc3_.attribute(TYPE));
                  if(_loc4_ == null)
                  {
                     throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_667 + "!");
                  }
                  _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                  _loc5_.setUnknownContent(this.var_666[param1]);
                  _loc6_ = _loc3_.child(const_1036);
                  if(_loc6_.length())
                  {
