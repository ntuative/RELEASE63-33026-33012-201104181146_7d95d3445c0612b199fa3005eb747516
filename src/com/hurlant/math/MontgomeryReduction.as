package com.hurlant.math
{
   ...
   class MontgomeryReduction implements IReduction
   {
      ...
      function MontgomeryReduction(param1:BigInteger)
      {
         super();
         this.m = param1;
         this.var_1726 = param1.invDigit();
         this.var_1725 = this.var_1726 & 32767;
         this.var_2341 = this.var_1726 >> 15;
         this.var_2342 = 131071;
         this.var_2343 = 2 * param1.t;
      }
      ...
      public function convert(param1:BigInteger) : BigInteger
      {
         ...
         if(param1.s < 0 && _loc2_.compareTo(BigInteger.const_181) > 0)
         {
